...
.method public final getBonuses(Z)Lg90/v;
    ...
    invoke-virtual {v0, p1}, Lorg/xbet/games_section/feature/bonuses/data/BonusRepository;->getBonuses(Z)Lg90/v;

    move-result-object p1

    sget-object v0, Lrf0/b;->a:Lrf0/b;
...
.method public final getFilteredBonuses(IZ)Lg90/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IZ)",
    ...
    .line 1
    invoke-virtual {p0, p2}, Lorg/xbet/games_section/feature/bonuses/domain/BonusInteractor;->getBonuses(Z)Lg90/v;
    ...
    invoke-direct {v0, p1}, Lrf0/a;-><init>(I)V

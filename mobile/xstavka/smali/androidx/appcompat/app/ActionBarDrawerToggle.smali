...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/app/ActionBarDrawerToggle$d;,
...
.field private mSlider:Landroidx/appcompat/graphics/drawable/d;
...
.method constructor <init>(Landroid/app/Activity;Landroidx/appcompat/widget/Toolbar;Landroidx/drawerlayout/widget/DrawerLayout;Landroidx/appcompat/graphics/drawable/d;II)V
    ...
    .line 7
    new-instance p1, Landroidx/appcompat/app/ActionBarDrawerToggle$d;

    invoke-direct {p1, p2}, Landroidx/appcompat/app/ActionBarDrawerToggle$d;-><init>(Landroidx/appcompat/widget/Toolbar;)V
    ...
    .line 9
    :cond_0
    instance-of p2, p1, Landroidx/appcompat/app/ActionBarDrawerToggle$b;

    if-eqz p2, :cond_1

    .line 10
    check-cast p1, Landroidx/appcompat/app/ActionBarDrawerToggle$b;

    invoke-interface {p1}, Landroidx/appcompat/app/ActionBarDrawerToggle$b;->getDrawerToggleDelegate()Landroidx/appcompat/app/ActionBarDrawerToggle$Delegate;
    ...
    .line 11
    :cond_1
    new-instance p2, Landroidx/appcompat/app/ActionBarDrawerToggle$c;

    invoke-direct {p2, p1}, Landroidx/appcompat/app/ActionBarDrawerToggle$c;-><init>(Landroid/app/Activity;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/app/ActionBarDrawerToggle;->mSlider:Landroidx/appcompat/graphics/drawable/d;

    goto :goto_1

    .line 16
    :cond_2
    iput-object p4, p0, Landroidx/appcompat/app/ActionBarDrawerToggle;->mSlider:Landroidx/appcompat/graphics/drawable/d;
...
.method public constructor <init>(Landroid/app/Activity;Landroidx/drawerlayout/widget/DrawerLayout;II)V
    ...
    .line 1
    invoke-direct/range {v0 .. v6}, Landroidx/appcompat/app/ActionBarDrawerToggle;-><init>(Landroid/app/Activity;Landroidx/appcompat/widget/Toolbar;Landroidx/drawerlayout/widget/DrawerLayout;Landroidx/appcompat/graphics/drawable/d;II)V
...
.method private setPosition(F)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/app/ActionBarDrawerToggle;->mSlider:Landroidx/appcompat/graphics/drawable/d;
...
# virtual methods
.method public getDrawerArrowDrawable()Landroidx/appcompat/graphics/drawable/d;
    .locals 1
...
.method public setDrawerArrowDrawable(Landroidx/appcompat/graphics/drawable/d;)V
    .locals 0

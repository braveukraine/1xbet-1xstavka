...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v0, v1, v1}, Lz/i;->k(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
...
.method private getVisibilityChangeInfo(Landroidx/transition/z;Landroidx/transition/z;)Landroidx/transition/Visibility$c;
    .locals 7
    ...
    .line 4
    iget-object v6, p1, Landroidx/transition/z;->a:Ljava/util/Map;
    ...
    .line 9
    iget-object v6, p2, Landroidx/transition/z;->a:Ljava/util/Map;
    ...
    .line 10
    iget-object v3, p2, Landroidx/transition/z;->a:Ljava/util/Map;
...
.method public captureEndValues(Landroidx/transition/z;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/transition/Visibility;->captureValues(Landroidx/transition/z;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/z;Landroidx/transition/z;)Landroid/animation/Animator;
    ...
    .line 1
    invoke-direct {p0, p2, p3}, Landroidx/transition/Visibility;->getVisibilityChangeInfo(Landroidx/transition/z;Landroidx/transition/z;)Landroidx/transition/Visibility$c;
    ...
    invoke-virtual/range {v2 .. v7}, Landroidx/transition/Visibility;->onAppear(Landroid/view/ViewGroup;Landroidx/transition/z;ILandroidx/transition/z;I)Landroid/animation/Animator;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/transition/Visibility;->onDisappear(Landroid/view/ViewGroup;Landroidx/transition/z;ILandroidx/transition/z;I)Landroid/animation/Animator;
...
.method public isTransitionRequired(Landroidx/transition/z;Landroidx/transition/z;)Z
    ...
    .line 4
    :cond_1
    invoke-direct {p0, p1, p2}, Landroidx/transition/Visibility;->getVisibilityChangeInfo(Landroidx/transition/z;Landroidx/transition/z;)Landroidx/transition/Visibility$c;
...
.method public isVisible(Landroidx/transition/z;)Z
    .locals 3
...
.method public onAppear(Landroid/view/ViewGroup;Landroidx/transition/z;ILandroidx/transition/z;I)Landroid/animation/Animator;
    .locals 2
    ...
    .line 2
    iget-object p3, p4, Landroidx/transition/z;->b:Landroid/view/View;
    ...
    .line 3
    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/z;

    move-result-object v1

    .line 4
    invoke-virtual {p0, p3, p5}, Landroidx/transition/Transition;->getTransitionValues(Landroid/view/View;Z)Landroidx/transition/z;

    move-result-object p3

    .line 5
    invoke-direct {p0, v1, p3}, Landroidx/transition/Visibility;->getVisibilityChangeInfo(Landroidx/transition/z;Landroidx/transition/z;)Landroidx/transition/Visibility$c;
    ...
    invoke-virtual {p0, p1, p3, p2, p4}, Landroidx/transition/Visibility;->onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/z;Landroidx/transition/z;)Landroid/animation/Animator;
...
.method public onDisappear(Landroid/view/ViewGroup;Landroidx/transition/z;ILandroidx/transition/z;I)Landroid/animation/Animator;
    .locals 17
    ...
    .line 2
    :cond_1
    iget-object v5, v2, Landroidx/transition/z;->b:Landroid/view/View;

    if-eqz v3, :cond_2

    .line 3
    iget-object v8, v3, Landroidx/transition/z;->b:Landroid/view/View;
    ...
    .line 9
    invoke-virtual {v0, v13, v12}, Landroidx/transition/Transition;->getTransitionValues(Landroid/view/View;Z)Landroidx/transition/z;

    move-result-object v14

    .line 10
    invoke-virtual {v0, v13, v12}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/z;

    move-result-object v15

    .line 11
    invoke-direct {v0, v14, v15}, Landroidx/transition/Visibility;->getVisibilityChangeInfo(Landroidx/transition/z;Landroidx/transition/z;)Landroidx/transition/Visibility$c;
    ...
    .line 13
    invoke-static {v1, v5, v13}, Landroidx/transition/y;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    .line 17
    iget-object v4, v2, Landroidx/transition/z;->a:Ljava/util/Map;
    ...
    .line 23
    invoke-static/range {p1 .. p1}, Landroidx/transition/f0;->b(Landroid/view/ViewGroup;)Landroidx/transition/e0;

    move-result-object v4

    invoke-interface {v4, v10}, Landroidx/transition/e0;->add(Landroid/view/View;)V

    .line 24
    :cond_b
    invoke-virtual {v0, v1, v10, v2, v3}, Landroidx/transition/Visibility;->onDisappear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/z;Landroidx/transition/z;)Landroid/animation/Animator;
    ...
    invoke-interface {v1, v10}, Landroidx/transition/e0;->remove(Landroid/view/View;)V
    ...
    .line 29
    invoke-static {v8, v11}, Landroidx/transition/k0;->i(Landroid/view/View;I)V

    .line 30
    invoke-virtual {v0, v1, v8, v2, v3}, Landroidx/transition/Visibility;->onDisappear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/z;Landroidx/transition/z;)Landroid/animation/Animator;
    ...
    .line 35
    :cond_f
    invoke-static {v8, v5}, Landroidx/transition/k0;->i(Landroid/view/View;I)V

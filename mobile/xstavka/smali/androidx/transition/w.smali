...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/w;->c:Landroidx/transition/Transition;
    ...
    sput-object v0, Landroidx/transition/w;->d:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Landroidx/transition/w;->e:Ljava/util/ArrayList;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/transition/w;->b:Landroidx/collection/a;
...
.method public static a(Landroid/view/ViewGroup;)V
    ...
    .line 1
    invoke-static {p0, v0}, Landroidx/transition/w;->b(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
...
.method public static b(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    .line 1
    sget-object v0, Landroidx/transition/w;->e:Ljava/util/ArrayList;
    ...
    .line 3
    sget-object p1, Landroidx/transition/w;->c:Landroidx/transition/Transition;
    ...
    .line 5
    invoke-static {p0, p1}, Landroidx/transition/w;->g(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V

    const/4 v0, 0x0

    .line 6
    invoke-static {p0, v0}, Landroidx/transition/r;->f(Landroid/view/ViewGroup;Landroidx/transition/r;)V

    .line 7
    invoke-static {p0, p1}, Landroidx/transition/w;->f(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
...
.method private static c(Landroidx/transition/r;Landroidx/transition/Transition;)V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/transition/r;->d()Landroid/view/ViewGroup;

    move-result-object v0

    .line 2
    sget-object v1, Landroidx/transition/w;->e:Ljava/util/ArrayList;
    ...
    .line 6
    :cond_1
    sget-object v2, Landroidx/transition/w;->e:Ljava/util/ArrayList;
    ...
    .line 8
    invoke-virtual {v1}, Landroidx/transition/r;->e()Z
    ...
    .line 10
    :cond_2
    invoke-static {v0, p1}, Landroidx/transition/w;->g(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V

    .line 11
    invoke-virtual {p0}, Landroidx/transition/r;->a()V

    .line 12
    invoke-static {v0, p1}, Landroidx/transition/w;->f(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
...
.method static d()Landroidx/collection/a;
    ...
    .line 1
    sget-object v0, Landroidx/transition/w;->d:Ljava/lang/ThreadLocal;
    ...
    .line 6
    sget-object v2, Landroidx/transition/w;->d:Ljava/lang/ThreadLocal;
...
.method public static e(Landroidx/transition/r;Landroidx/transition/Transition;)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Landroidx/transition/w;->c(Landroidx/transition/r;Landroidx/transition/Transition;)V
...
.method private static g(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    .line 1
    invoke-static {}, Landroidx/transition/w;->d()Landroidx/collection/a;

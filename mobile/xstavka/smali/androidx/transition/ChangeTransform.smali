...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v1, v0, v0}, Lz/i;->e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
    ...
    .line 11
    invoke-static {p1, p2, v1, v2, v0}, Lz/i;->e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
...
.method private b(Landroid/view/ViewGroup;Landroidx/transition/z;Landroidx/transition/z;)V
    .locals 3
    ...
    .line 2
    iget-object v1, p3, Landroidx/transition/z;->a:Ljava/util/Map;
    ...
    .line 4
    invoke-static {p1, v2}, Landroidx/transition/k0;->k(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    iget-object v2, p2, Landroidx/transition/z;->b:Landroid/view/View;
    ...
    .line 11
    iget-object p1, p2, Landroidx/transition/z;->b:Landroid/view/View;

    iget-object p2, p3, Landroidx/transition/z;->b:Landroid/view/View;
    ...
    .line 12
    invoke-static {p1, p2}, Landroidx/transition/k0;->h(Landroid/view/View;F)V

    :cond_2
    const/high16 p1, 0x3f800000    # 1.0f

    .line 13
    invoke-static {v0, p1}, Landroidx/transition/k0;->h(Landroid/view/View;F)V

    :cond_3
    return-void
.end method

.method private c(Landroidx/transition/z;Landroidx/transition/z;Z)Landroid/animation/ObjectAnimator;
    .locals 12
    ...
    .line 6
    :cond_2
    iget-object v0, p2, Landroidx/transition/z;->a:Ljava/util/Map;
    ...
    .line 7
    iget-object v5, p2, Landroidx/transition/z;->b:Landroid/view/View;
...
.method private captureValues(Landroidx/transition/z;)V
    ...
    .line 13
    invoke-static {v2, v1}, Landroidx/transition/k0;->j(Landroid/view/View;Landroid/graphics/Matrix;)V
...
.method private d(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p1, v1}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/z;
...
.method private h(Landroidx/transition/z;Landroidx/transition/z;)V
    .locals 4
    ...
    .line 2
    iget-object p2, p2, Landroidx/transition/z;->b:Landroid/view/View;
...
.method static i(Landroid/view/View;FFFFFFFF)V
    ...
    .line 3
    invoke-static {p0, p3}, Landroidx/core/view/c0;->S0(Landroid/view/View;F)V
...
.method public captureEndValues(Landroidx/transition/z;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/transition/ChangeTransform;->captureValues(Landroidx/transition/z;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/z;Landroidx/transition/z;)Landroid/animation/Animator;
    ...
    iget-object v0, p3, Landroidx/transition/z;->a:Ljava/util/Map;
    ...
    .line 5
    iget-object v2, p3, Landroidx/transition/z;->a:Ljava/util/Map;
    ...
    invoke-direct {p0, v0, v1}, Landroidx/transition/ChangeTransform;->d(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    .line 7
    :goto_0
    iget-object v2, p2, Landroidx/transition/z;->a:Ljava/util/Map;
    ...
    .line 12
    invoke-direct {p0, p2, p3}, Landroidx/transition/ChangeTransform;->h(Landroidx/transition/z;Landroidx/transition/z;)V

    .line 13
    :cond_4
    invoke-direct {p0, p2, p3, v1}, Landroidx/transition/ChangeTransform;->c(Landroidx/transition/z;Landroidx/transition/z;Z)Landroid/animation/ObjectAnimator;
    ...
    .line 15
    invoke-direct {p0, p1, p2, p3}, Landroidx/transition/ChangeTransform;->b(Landroid/view/ViewGroup;Landroidx/transition/z;Landroidx/transition/z;)V

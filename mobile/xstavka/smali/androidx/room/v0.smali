...
# direct methods
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;ILb1/h;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    iput-object p6, p0, Landroidx/room/v0;->f:Lb1/h;
...
.method private a(Ljava/io/File;Z)V
    ...
    .line 13
    invoke-static {v0, v2}, Lz0/d;->a(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/channels/FileChannel;)V
...
.method private b(Ljava/io/File;)Lb1/h;
    .locals 4

    .line 1
    :try_start_0
    invoke-static {p1}, Lz0/c;->c(Ljava/io/File;)I
    ...
    invoke-static {v2}, Lb1/h$b;->a(Landroid/content/Context;)Lb1/h$b$a;
    ...
    invoke-virtual {v2, p1}, Lb1/h$b$a;->c(Ljava/lang/String;)Lb1/h$b$a;
    ...
    invoke-virtual {p1, v2}, Lb1/h$b$a;->b(Lb1/h$a;)Lb1/h$b$a;

    move-result-object p1

    .line 6
    invoke-virtual {p1}, Lb1/h$b$a;->a()Lb1/h$b;

    move-result-object p1

    .line 7
    invoke-virtual {v1, p1}, Lc1/c;->a(Lb1/h$b;)Lb1/h;
...
.method private d(Ljava/io/File;Z)V
    ...
    .line 2
    :cond_0
    invoke-direct {p0, p1}, Landroidx/room/v0;->b(Ljava/io/File;)Lb1/h;
    ...
    .line 3
    :try_start_0
    invoke-interface {p1}, Lb1/h;->getWritableDatabase()Lb1/g;
    ...
    .line 4
    :cond_1
    invoke-interface {p1}, Lb1/h;->getReadableDatabase()Lb1/g;
    ...
    invoke-virtual {v0, p2}, Landroidx/room/q0$e;->a(Lb1/g;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 6
    invoke-interface {p1}, Lb1/h;->close()V
...
.method private f(Z)V
    ...
    :cond_3
    :try_start_3
    invoke-static {v2}, Lz0/c;->c(Ljava/io/File;)I
...
.method public declared-synchronized close()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Landroidx/room/v0;->f:Lb1/h;
...
.method public declared-synchronized getReadableDatabase()Lb1/g;
    .locals 1
    ...
    invoke-interface {v0}, Lb1/h;->getReadableDatabase()Lb1/g;
...
.method public declared-synchronized getWritableDatabase()Lb1/g;
    .locals 1

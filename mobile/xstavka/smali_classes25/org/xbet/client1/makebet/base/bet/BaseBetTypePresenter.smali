...
# direct methods
.method public constructor <init>(Lj80/d;Lorg/xbet/domain/betting/interactors/BetInteractor;Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;Lj80/c;Lorg/xbet/domain/betting/mappers/BetEventModelMapper;Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;Ll50/d;Lr50/h;Lorg/xbet/domain/betting/models/BetMode;Lorg/xbet/analytics/domain/TargetStatsInteractor;Lorg/xbet/domain/settings/OfficeInteractor;Lorg/xbet/ui_common/utils/internet/ConnectionObserver;Lorg/xbet/ui_common/router/BaseOneXRouter;)V
    .locals 0
    .param p1    # Lj80/d;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 1
    invoke-direct {p0, p12, p13}, Lorg/xbet/ui_common/moxy/presenters/BaseConnectionObserverPresenter;-><init>(Lorg/xbet/ui_common/utils/internet/ConnectionObserver;Lorg/xbet/ui_common/router/BaseOneXRouter;)V

    .line 2
    iput-object p1, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->singleBetGame:Lj80/d;
    ...
    .line 5
    iput-object p4, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->betInfo:Lj80/c;
    ...
    .line 8
    iput-object p7, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->userSettingsInteractor:Ll50/d;

    .line 9
    iput-object p8, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->subscriptionManager:Lr50/h;
...
.method public static synthetic c(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lj80/c;)Lca0/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->updateGameState$lambda-1(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lj80/c;)Lca0/m;
...
.method public static synthetic d(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lca0/m;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->updateGameState$lambda-2(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lca0/m;)V

    return-void
.end method

.method public static synthetic e(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;JLorg/xbet/domain/betting/models/BetResult;)Lg90/d;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->onMakeBetSuccess$lambda-6(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;JLorg/xbet/domain/betting/models/BetResult;)Lg90/d;
...
.method private final getChangesType(Lj80/c;Lj80/c;)Lorg/xbet/client1/makebet/presentation/BetChangeType;
    .locals 5
    ...
    .line 4
    :cond_4
    invoke-virtual {p2}, Lj80/c;->c()D

    move-result-wide v0

    invoke-virtual {p1}, Lj80/c;->c()D
...
.method static synthetic getChangesType$default(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lj80/c;Lj80/c;ILjava/lang/Object;)Lorg/xbet/client1/makebet/presentation/BetChangeType;
    .locals 0
    ...
    .line 1
    :cond_0
    invoke-direct {p0, p1, p2}, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->getChangesType(Lj80/c;Lj80/c;)Lorg/xbet/client1/makebet/presentation/BetChangeType;
...
.method private final handleBetState(Lorg/xbet/client1/makebet/presentation/BetChangeType;)V
    ...
    invoke-direct {v1, p0}, Lorg/xbet/client1/makebet/base/bet/b;-><init>(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;)V
...
.method public static synthetic i(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lorg/xbet/domain/betting/models/UpdateCouponResult;)Lj80/c;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->updateGameState$lambda-0(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lorg/xbet/domain/betting/models/UpdateCouponResult;)Lj80/c;
...
.method public static synthetic j(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;)Lg90/d;
    .locals 0

    invoke-static {p0}, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->onMakeBetSuccess$lambda-5(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;)Lg90/d;
...
.method private static final onMakeBetSuccess$lambda-5(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;)Lg90/d;
    .locals 3
    ...
    sget-object v0, Lti/a;->ACTION_DO_BET:Lti/a;

    const/4 v1, 0x0

    const/4 v2, 0x1

    invoke-static {p0, v1, v0, v2, v1}, Lorg/xbet/analytics/domain/TargetStatsInteractor;->sendTargetReaction$default(Lorg/xbet/analytics/domain/TargetStatsInteractor;Ljava/lang/String;Lti/a;ILjava/lang/Object;)Lg90/b;
...
.method private static final onMakeBetSuccess$lambda-6(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;JLorg/xbet/domain/betting/models/BetResult;)Lg90/d;
    .locals 4

    .line 1
    iget-object v0, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->userSettingsInteractor:Ll50/d;
    ...
    .line 2
    iget-object p0, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->subscriptionManager:Lr50/h;
    ...
    invoke-interface {p0, p1, p2, v0}, Lr50/h;->subscribeOnResultBet(J[J)Lg90/b;
...
.method private final updateGameState()V
    ...
    iget-object v2, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->betInfo:Lj80/c;

    invoke-virtual {v1, v2}, Lorg/xbet/domain/betting/mappers/BetEventModelMapper;->invoke(Lj80/c;)La50/a;
    ...
    invoke-static/range {v0 .. v9}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent$default(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;Ljava/util/List;JLl80/a;ILjava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Lg90/v;

    move-result-object v0

    .line 2
    new-instance v1, Lorg/xbet/client1/makebet/base/bet/h;

    invoke-direct {v1, p0}, Lorg/xbet/client1/makebet/base/bet/h;-><init>(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;)V
    ...
    .line 3
    new-instance v1, Lorg/xbet/client1/makebet/base/bet/g;

    invoke-direct {v1, p0}, Lorg/xbet/client1/makebet/base/bet/g;-><init>(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;)V
    ...
    new-instance v2, Lorg/xbet/client1/makebet/base/bet/c;

    invoke-direct {v2, p0}, Lorg/xbet/client1/makebet/base/bet/c;-><init>(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;)V
...
.method private static final updateGameState$lambda-0(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lorg/xbet/domain/betting/models/UpdateCouponResult;)Lj80/c;
    .locals 29
    ...
    .line 2
    iget-object v1, v0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->betInfo:Lj80/c;

    invoke-virtual {v1}, Lj80/c;->f()Ljava/lang/String;

    move-result-object v22

    .line 3
    iget-object v0, v0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->betInfo:Lj80/c;

    invoke-virtual {v0}, Lj80/c;->n()Ljava/lang/String;
    ...
    .line 4
    invoke-static/range {v2 .. v28}, Lj80/c;->b(Lj80/c;JIIZZJLjava/lang/String;JJLjava/lang/String;FDLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZZILjava/lang/Object;)Lj80/c;
...
.method private static final updateGameState$lambda-1(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lj80/c;)Lca0/m;
    .locals 1

    .line 1
    iget-object v0, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->betInfo:Lj80/c;

    invoke-direct {p0, v0, p1}, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->getChangesType(Lj80/c;Lj80/c;)Lorg/xbet/client1/makebet/presentation/BetChangeType;

    move-result-object v0

    .line 2
    iput-object p1, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->betInfo:Lj80/c;
...
.method private static final updateGameState$lambda-2(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lca0/m;)V
    .locals 5
    ...
    iget-object v3, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->singleBetGame:Lj80/d;

    iget-object v4, p0, Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;->betInfo:Lj80/c;

    invoke-interface {p1, v3, v4, v0}, Lorg/xbet/client1/makebet/base/bet/BaseBetTypeView;->showGameInfo(Lj80/d;Lj80/c;Lorg/xbet/client1/makebet/presentation/BetChangeType;)V
...
.method protected final getBetInfo()Lj80/c;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method protected final getUserSettingsInteractor()Ll50/d;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method protected final onMakeBetSuccess(Lorg/xbet/domain/betting/models/BetResult;DJ)V
    ...
    .line 1
    new-instance v0, Lorg/xbet/client1/makebet/base/bet/i;

    invoke-direct {v0, p0}, Lorg/xbet/client1/makebet/base/bet/i;-><init>(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;)V
    ...
    invoke-direct {v1, p0, p4, p5, p1}, Lorg/xbet/client1/makebet/base/bet/j;-><init>(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;JLorg/xbet/domain/betting/models/BetResult;)V

    invoke-static {v1}, Lg90/b;->i(Ljava/util/concurrent/Callable;)Lg90/b;

    move-result-object p4

    .line 3
    invoke-virtual {v0, p4}, Lg90/b;->d(Lg90/d;)Lg90/b;
    ...
    invoke-virtual {p5, v0}, Lorg/xbet/domain/settings/OfficeInteractor;->getNonCalcBetSum(Z)Lg90/v;

    move-result-object p5

    invoke-virtual {p4, p5}, Lg90/b;->f(Lg90/z;)Lg90/v;
    ...
    .line 6
    new-instance p5, Lorg/xbet/client1/makebet/base/bet/e;

    invoke-direct {p5, p0, p1, p2, p3}, Lorg/xbet/client1/makebet/base/bet/e;-><init>(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lorg/xbet/domain/betting/models/BetResult;D)V

    new-instance v0, Lorg/xbet/client1/makebet/base/bet/f;

    invoke-direct {v0, p0, p1, p2, p3}, Lorg/xbet/client1/makebet/base/bet/f;-><init>(Lorg/xbet/client1/makebet/base/bet/BaseBetTypePresenter;Lorg/xbet/domain/betting/models/BetResult;D)V

    invoke-virtual {p4, p5, v0}, Lg90/v;->Q(Lj90/g;Lj90/g;)Li90/c;
...
.method protected final setBetInfo(Lj80/c;)V
    .locals 0
    .param p1    # Lj80/c;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation

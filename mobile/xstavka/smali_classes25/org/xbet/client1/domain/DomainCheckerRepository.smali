...
# instance fields
.field private final domainService:Lka0/a;
...
.method public constructor <init>(Lzi/j;Lzi/m;)V
    .locals 1
    .param p1    # Lzi/j;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v0, p1}, Lorg/xbet/client1/domain/DomainCheckerRepository$service$1;-><init>(Lzi/j;)V

    iput-object v0, p0, Lorg/xbet/client1/domain/DomainCheckerRepository;->service:Lka0/a;

    .line 3
    new-instance p1, Lorg/xbet/client1/domain/DomainCheckerRepository$domainService$1;

    invoke-direct {p1, p2}, Lorg/xbet/client1/domain/DomainCheckerRepository$domainService$1;-><init>(Lzi/m;)V

    iput-object p1, p0, Lorg/xbet/client1/domain/DomainCheckerRepository;->domainService:Lka0/a;

    return-void
.end method

.method public static synthetic a(Lorg/xbet/client1/domain/DomainCheckerRepository;Ljava/lang/String;Ljava/lang/String;)Lg90/d;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/client1/domain/DomainCheckerRepository;->start$lambda-3(Lorg/xbet/client1/domain/DomainCheckerRepository;Ljava/lang/String;Ljava/lang/String;)Lg90/d;
...
.method public static synthetic c(Lorg/xbet/client1/domain/DomainCheckerRepository;Lorg/xbet/client1/apidata/requests/result/availableMirrors/MirrorsHostResponse;)Lg90/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/domain/DomainCheckerRepository;->start$lambda-2(Lorg/xbet/client1/domain/DomainCheckerRepository;Lorg/xbet/client1/apidata/requests/result/availableMirrors/MirrorsHostResponse;)Lg90/r;
...
.method private final checkDomain(Lorg/xbet/client1/apidata/requests/result/availableMirrors/MirrorsHostResponse;)Lg90/v;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/client1/domain/DomainCheckerRepository;->domainService:Lka0/a;
    ...
    invoke-interface {v0, v1}, Lorg/xbet/client1/new_arch/data/network/starter/DomainMirrorService;->check(Ljava/lang/String;)Lg90/v;
...
.method private static final checkDomain$lambda-6(Lorg/xbet/client1/apidata/requests/result/availableMirrors/MirrorsHostResponse;Ljava/lang/Throwable;)Lg90/z;
    .locals 2
...
.method public static synthetic f(Lorg/xbet/client1/apidata/requests/result/availableMirrors/MirrorsHostResponse;Ljava/lang/Throwable;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/domain/DomainCheckerRepository;->checkDomain$lambda-6(Lorg/xbet/client1/apidata/requests/result/availableMirrors/MirrorsHostResponse;Ljava/lang/Throwable;)Lg90/z;
...
.method private static final start$lambda-2(Lorg/xbet/client1/domain/DomainCheckerRepository;Lorg/xbet/client1/apidata/requests/result/availableMirrors/MirrorsHostResponse;)Lg90/r;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lorg/xbet/client1/domain/DomainCheckerRepository;->checkDomain(Lorg/xbet/client1/apidata/requests/result/availableMirrors/MirrorsHostResponse;)Lg90/v;
...
.method private static final start$lambda-3(Lorg/xbet/client1/domain/DomainCheckerRepository;Ljava/lang/String;Ljava/lang/String;)Lg90/d;
    .locals 6

    .line 1
    iget-object p0, p0, Lorg/xbet/client1/domain/DomainCheckerRepository;->service:Lka0/a;
    ...
    .line 4
    invoke-static/range {v0 .. v5}, Lorg/xbet/client1/new_arch/data/network/starter/DomainMirrorService$DefaultImpls;->sendHostsStatus$default(Lorg/xbet/client1/new_arch/data/network/starter/DomainMirrorService;Ljava/lang/String;Lokhttp3/c0;Ljava/lang/String;ILjava/lang/Object;)Lg90/b;
...
.method public final start(Ljava/lang/String;)V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/client1/domain/DomainCheckerRepository;->service:Lka0/a;
    ...
    invoke-interface {v0}, Lorg/xbet/client1/new_arch/data/network/starter/DomainMirrorService;->getAvailableMirrors()Lg90/v;

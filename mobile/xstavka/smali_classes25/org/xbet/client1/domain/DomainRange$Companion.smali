...
.method private final getSimpleProfit(Lcj/b;)Lorg/xbet/client1/domain/DomainRange;
    .locals 6
    ...
    .line 1
    invoke-direct/range {v0 .. v5}, Lorg/xbet/client1/domain/DomainRange$Companion;->parseByProfit(DLcj/b;ZZ)Lorg/xbet/client1/domain/DomainRange;
...
.method private final parseByProfit(DLcj/b;ZZ)Lorg/xbet/client1/domain/DomainRange;
    .locals 3
    ...
    .line 2
    :cond_0
    sget-object p5, Lcj/b;->URAL_PLUS:Lcj/b;
    ...
    .line 3
    :cond_1
    sget-object p5, Lcj/b;->URAL_MINUS:Lcj/b;
    ...
    .line 4
    :cond_2
    sget-object p5, Lcj/b;->OTHER:Lcj/b;
...
.method private final saveCat(I)V
    ...
    invoke-virtual {p0}, Lorg/xbet/client1/domain/DomainRange$Companion;->decryptData()Loh/b;

    move-result-object v3

    invoke-virtual {v2, v1, v3}, Lcom/xbet/domainresolver/utils/a;->a(Ljava/lang/String;Loh/b;)Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v1}, Loh/b;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2, p1, v3}, Lcom/xbet/domainresolver/utils/a;->b(Ljava/lang/String;Loh/b;)Ljava/lang/String;
...
# virtual methods
.method public final decryptData()Loh/b;
    .locals 3
    ...
    invoke-direct {v1, v2, v0}, Loh/b;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    return-object v1
.end method

.method public final load(Lcj/b;)Lorg/xbet/client1/domain/DomainRange;
    .locals 10
    .param p1    # Lcj/b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {p0, p1}, Lorg/xbet/client1/domain/DomainRange$Companion;->getSimpleProfit(Lcj/b;)Lorg/xbet/client1/domain/DomainRange;
...
.method public final save(DLcj/b;ZZ)V
    .locals 0
    .param p3    # Lcj/b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 1
    invoke-direct/range {p0 .. p5}, Lorg/xbet/client1/domain/DomainRange$Companion;->parseByProfit(DLcj/b;ZZ)Lorg/xbet/client1/domain/DomainRange;
...
.method public final saveSomeInfo(DLcj/b;ZZ)V
    .locals 6
    .param p3    # Lcj/b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 1
    invoke-virtual/range {v0 .. v5}, Lorg/xbet/client1/domain/DomainRange$Companion;->save(DLcj/b;ZZ)V

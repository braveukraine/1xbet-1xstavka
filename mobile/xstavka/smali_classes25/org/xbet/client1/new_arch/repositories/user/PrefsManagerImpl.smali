...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lorg/xbet/preferences/PrivateDataSource;Ls40/a;Lcom/google/gson/Gson;)V",
        "Companion",
        "app_xstavkaRelease"
    }
    k = 0x1
...
.method public constructor <init>(Lorg/xbet/preferences/PrivateDataSource;Ls40/a;Lcom/google/gson/Gson;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lorg/xbet/client1/new_arch/repositories/user/PrefsManagerImpl;->userPreferencesDataSource:Ls40/a;

    .line 4
    iput-object p3, p0, Lorg/xbet/client1/new_arch/repositories/user/PrefsManagerImpl;->gson:Lcom/google/gson/Gson;
...
.method private final getUserV2ByOld(Ljava/lang/String;)Ln40/b;
    ...
    .line 2
    new-instance v7, Ln40/b;

    invoke-virtual {p1}, Ln40/c;->c()J

    move-result-wide v1

    invoke-virtual {p1}, Ln40/c;->a()Z

    move-result v3

    invoke-virtual {p1}, Ln40/c;->b()Z

    move-result v4

    invoke-virtual {p1}, Ln40/c;->d()D

    move-result-wide v5

    move-object v0, v7

    invoke-direct/range {v0 .. v6}, Ln40/b;-><init>(JZZD)V

    .line 3
    invoke-virtual {p0, v7}, Lorg/xbet/client1/new_arch/repositories/user/PrefsManagerImpl;->saveUser(Ln40/b;)V
...
.method public authorized()Z
    ...
    .line 1
    invoke-virtual {p0}, Lorg/xbet/client1/new_arch/repositories/user/PrefsManagerImpl;->getUser()Ln40/b;
...
.method public final catchEmptyUser(Ln40/b;)Ln40/b;
    .locals 5
    .param p1    # Ln40/b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public getUser()Ln40/b;
    ...
    invoke-virtual {p0, v1}, Lorg/xbet/client1/new_arch/repositories/user/PrefsManagerImpl;->catchEmptyUser(Ln40/b;)Ln40/b;
    ...
    .line 4
    :cond_1
    invoke-direct {p0, v1}, Lorg/xbet/client1/new_arch/repositories/user/PrefsManagerImpl;->getUserV2ByOld(Ljava/lang/String;)Ln40/b;
...
.method public isNeedToRestrictEmail()Z
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/client1/new_arch/repositories/user/PrefsManagerImpl;->userPreferencesDataSource:Ls40/a;

    invoke-interface {v0}, Ls40/a;->hasRestrictEmail()Z
...
.method public saveUser(Ln40/b;)V
    .locals 2
    .param p1    # Ln40/b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation

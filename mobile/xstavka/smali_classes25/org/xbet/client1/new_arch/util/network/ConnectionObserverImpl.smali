...
.method public static synthetic a(Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;Ljava/lang/Boolean;)Lg90/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;->doubleCheckSuccessConnection$lambda-2(Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;Ljava/lang/Boolean;)Lg90/r;
...
.method public static synthetic b(Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;Lg90/p;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;->connectionStateObservable$lambda-1(Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;Lg90/p;)V
...
.method private static final connectionStateObservable$lambda-1(Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;Lg90/p;)V
    .locals 2
    ...
    invoke-direct {v0, p1}, Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl$connectionStateObservable$1$networkCallback$1;-><init>(Lg90/p;)V
    ...
    invoke-interface {p1, p0}, Lg90/e;->onNext(Ljava/lang/Object;)V
...
.method private final doubleCheckSuccessConnection(Lg90/o;)Lg90/o;
    .locals 1
...
.method private static final doubleCheckSuccessConnection$lambda-2(Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;Ljava/lang/Boolean;)Lg90/r;
    .locals 1
    ...
    invoke-direct {p0}, Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;->sendTrueAndCheckAgain()Lg90/o;
...
.method private final sendTrueAndCheckAgain()Lg90/o;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-static {v2, v3, v1}, Lg90/o;->C1(JLjava/util/concurrent/TimeUnit;)Lg90/o;
...
# virtual methods
.method public connectionStateObservable()Lg90/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 2
    invoke-direct {p0, v0}, Lorg/xbet/client1/new_arch/util/network/ConnectionObserverImpl;->doubleCheckSuccessConnection(Lg90/o;)Lg90/o;

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lorg/xbet/client1/new_arch/repositories/bonuses/BonusesRepository;Lej/b;Lcom/xbet/onexuser/domain/managers/k0;Ly40/t;Ln50/g;Lng/a;Lorg/xbet/client1/providers/MenuConfigProviderImpl;)V",
        "app_xstavkaRelease"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Lorg/xbet/client1/new_arch/repositories/bonuses/BonusesRepository;Lej/b;Lcom/xbet/onexuser/domain/managers/k0;Ly40/t;Ln50/g;Lng/a;Lorg/xbet/client1/providers/MenuConfigProviderImpl;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->appSettingsManager:Lej/b;
    ...
    .line 5
    iput-object p4, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->balanceInteractor:Ly40/t;

    .line 6
    iput-object p5, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->profileInteractor:Ln50/g;

    .line 7
    invoke-virtual {p6}, Lng/a;->b()Log/b;

    move-result-object p1

    iput-object p1, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->common:Log/b;
...
.method public static synthetic a(Lcom/xbet/onexuser/domain/entity/j;Lz40/a;)Lca0/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->getBonusPromotion$lambda-0(Lcom/xbet/onexuser/domain/entity/j;Lz40/a;)Lca0/m;
...
.method private final bonusPromotion()Lg90/k;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public static synthetic c(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;ILjava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->setBonusChoice$lambda-13(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;ILjava/util/List;)Lg90/z;
...
.method public static synthetic d(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;ILcom/xbet/onexuser/domain/entity/j;)Lg90/z;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->setBonusChoice$lambda-10(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;ILcom/xbet/onexuser/domain/entity/j;)Lg90/z;
...
.method public static synthetic e(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Lca0/s;)Ljava/util/List;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->getBonusPromotion$lambda-6(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Lca0/s;)Ljava/util/List;
...
.method public static synthetic g(Lcom/xbet/onexuser/domain/entity/j;Ljava/util/List;)Lca0/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->getBonusPromotion$lambda-3$lambda-2(Lcom/xbet/onexuser/domain/entity/j;Ljava/util/List;)Lca0/m;
...
.method public static synthetic getBonusPromotion$default(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;ZILjava/lang/Object;)Lg90/v;
    .locals 0
    ...
    .line 1
    :cond_0
    invoke-virtual {p0, p1}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->getBonusPromotion(Z)Lg90/v;
...
.method private static final getBonusPromotion$lambda-0(Lcom/xbet/onexuser/domain/entity/j;Lz40/a;)Lca0/m;
    .locals 2
...
.method private static final getBonusPromotion$lambda-3(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Lca0/m;)Lg90/z;
    .locals 7
    ...
    .line 2
    invoke-direct {p0}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->bonusPromotion()Lg90/k;
    ...
    .line 4
    iget-object v2, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->appSettingsManager:Lej/b;
    ...
    .line 6
    iget-object v6, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->appSettingsManager:Lej/b;

    invoke-interface {v6}, Lej/b;->getLang()Ljava/lang/String;

    move-result-object v6

    .line 7
    invoke-virtual/range {v1 .. v6}, Lorg/xbet/client1/new_arch/repositories/bonuses/BonusesRepository;->getBonusesList(IIJLjava/lang/String;)Lg90/v;
...
.method private static final getBonusPromotion$lambda-3$lambda-2(Lcom/xbet/onexuser/domain/entity/j;Ljava/util/List;)Lca0/m;
    .locals 0
...
.method private static final getBonusPromotion$lambda-4(Lca0/m;La40/e;)Lca0/s;
    .locals 2
    ...
    invoke-direct {v0, v1, p1, p0}, Lca0/s;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    return-object v0
.end method

.method private static final getBonusPromotion$lambda-6(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Lca0/s;)Ljava/util/List;
    .locals 13
    ...
    check-cast v5, La40/c;

    .line 5
    new-instance v3, Lorg/xbet/client1/new_arch/repositories/bonuses/models/BonusPromotionInfo;

    .line 6
    iget-object v4, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->common:Log/b;

    invoke-virtual {v4}, Log/b;->l()Z
    ...
    .line 10
    invoke-direct/range {v4 .. v10}, Lorg/xbet/client1/new_arch/repositories/bonuses/models/BonusPromotionInfo;-><init>(La40/c;ZZZZZ)V
...
.method private static final getBonusPromotion$lambda-7(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Ljava/util/List;)V
    ...
    const-string v0, "null cannot be cast to non-null type kotlin.collections.MutableList<org.xbet.client1.new_arch.repositories.bonuses.models.BonusPromotionInfo>"
...
.method private static final getBonusPromotion$lambda-9(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    iget-object v3, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->common:Log/b;

    invoke-virtual {v3}, Log/b;->I0()Z
...
.method public static synthetic i(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Lca0/m;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->getBonusPromotion$lambda-3(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Lca0/m;)Lg90/z;
...
.method public static synthetic j(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Ljava/lang/Boolean;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->setBonusChoice$lambda-11(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Ljava/lang/Boolean;)Lg90/z;
...
.method public static synthetic k(Lca0/m;La40/e;)Lca0/s;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->getBonusPromotion$lambda-4(Lca0/m;La40/e;)Lca0/s;
...
.method private static final setBonusChoice$lambda-10(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;ILcom/xbet/onexuser/domain/entity/j;)Lg90/z;
    .locals 1
...
.method private static final setBonusChoice$lambda-11(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;Ljava/lang/Boolean;)Lg90/z;
    .locals 0
...
.method private static final setBonusChoice$lambda-13(Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;ILjava/util/List;)Lg90/z;
    .locals 2

    .line 1
    iget-object p0, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->profileInteractor:Ln50/g;
...
# virtual methods
.method public final getBonusPromotion(Z)Lg90/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->profileInteractor:Ln50/g;

    invoke-virtual {v0, p1}, Ln50/g;->q(Z)Lg90/v;

    move-result-object p1

    iget-object v0, p0, Lorg/xbet/client1/new_arch/domain/bonuses/BonusesInteractor;->balanceInteractor:Ly40/t;
    ...
    invoke-virtual {v0}, Lorg/xbet/client1/new_arch/repositories/bonuses/BonusesRepository;->getUserBonusInfo()Lg90/v;
...
.method public final setBonusChoice(I)Lg90/v;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "serviceGenerator",
        "<init>",
        "(Lorg/xbet/domain/betting/repositories/SportRepository;Lorg/xbet/client1/new_arch/xbet/base/models/mappers/BaseBetMapper;Lej/b;Lzi/j;Lorg/xbet/client1/new_arch/xbet/base/models/entity/LineLiveType;)V",
        "app_xstavkaRelease"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Lorg/xbet/domain/betting/repositories/SportRepository;Lorg/xbet/client1/new_arch/xbet/base/models/mappers/BaseBetMapper;Lej/b;Lzi/j;Lorg/xbet/client1/new_arch/xbet/base/models/entity/LineLiveType;)V
    .locals 0
    ...
    .line 4
    iput-object p3, p0, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->appSettingsManager:Lej/b;
    ...
    invoke-direct {p1, p4}, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository$service$1;-><init>(Lzi/j;)V

    iput-object p1, p0, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->service:Lka0/a;
...
.method public static synthetic a(Ljava/util/List;Ljava/util/List;)Lca0/m;
    ...
    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->sports$lambda-9$lambda-8(Ljava/util/List;Ljava/util/List;)Lca0/m;
...
.method public static synthetic b(Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;Lca0/m;)Ljava/util/List;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->sports$lambda-10(Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;Lca0/m;)Ljava/util/List;
...
.method private final configureParameters()Ljava/util/Map;
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->appSettingsManager:Lej/b;
    ...
    .line 2
    iget-object v3, p0, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->appSettingsManager:Lej/b;
...
.method public static synthetic e(Li10/e;)Ljava/util/List;
    .locals 0

    invoke-static {p0}, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->sports$lambda-5(Li10/e;)Ljava/util/List;
...
.method public static synthetic f(Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;Ljava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->sports$lambda-9(Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;Ljava/util/List;)Lg90/z;
...
.method public static synthetic h(Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;Ljava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->sports$lambda-4(Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;Ljava/util/List;)Lg90/z;
...
.method private static final sports$lambda-10(Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;Lca0/m;)Ljava/util/List;
    .locals 1
...
.method private static final sports$lambda-4(Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;Ljava/util/List;)Lg90/z;
    .locals 0
    ...
    invoke-interface {p0, p1}, Lorg/xbet/domain/betting/repositories/SportRepository;->byIds(Ljava/util/List;)Lg90/v;
...
.method private static final sports$lambda-5(Li10/e;)Ljava/util/List;
    .locals 0
...
.method private static final sports$lambda-9(Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;Ljava/util/List;)Lg90/z;
    .locals 1
...
.method private static final sports$lambda-9$lambda-8(Ljava/util/List;Ljava/util/List;)Lca0/m;
    .locals 0
...
.method public sports(Lorg/xbet/client1/new_arch/xbet/base/models/entity/LineLiveData;)Lg90/o;
    ...
    .line 2
    iget-object v0, p0, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->service:Lka0/a;
    ...
    .line 4
    iget-object v2, p0, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->appSettingsManager:Lej/b;
    ...
    .line 8
    invoke-interface {v0, v1}, Lorg/xbet/client1/new_arch/xbet/features/results/services/ResultsService;->getResults(Lorg/xbet/client1/apidata/requests/request/ViewGameRequest;)Lg90/v;
    ...
    .line 12
    :cond_0
    iget-object p1, p0, Lorg/xbet/client1/new_arch/xbet/features/results/repositories/ResultsRepository;->service:Lka0/a;
    ...
    invoke-interface {p1, v0}, Lorg/xbet/client1/new_arch/xbet/features/results/services/ResultsService;->getLiveResults(Ljava/util/Map;)Lg90/v;

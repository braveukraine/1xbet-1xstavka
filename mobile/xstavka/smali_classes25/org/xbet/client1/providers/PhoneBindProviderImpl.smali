...
# virtual methods
.method public bindPhone(Ljava/lang/String;Ljava/lang/String;I)Lg90/v;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p3}, Lorg/xbet/domain/security/interactors/ManipulateEntryInteractor;->bindPhone(Ljava/lang/String;Ljava/lang/String;I)Lg90/v;
...
.method public getCountryInfo()Lg90/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lorg/xbet/domain/security/interactors/ManipulateEntryInteractor;->getCountryInfo()Lg90/v;
...
.method public invokeDualPhoneCountry(Ld50/b;Z)Lorg/xbet/ui_common/viewcomponents/layouts/frame/DualPhoneCountry;
    .locals 1
    .param p1    # Ld50/b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p1, p2}, Lorg/xbet/client1/new_arch/domain/mappers/DualPhoneCountryMapper;->invoke(Ld50/b;Z)Lorg/xbet/ui_common/viewcomponents/layouts/frame/DualPhoneCountry;
...
.method public showCountryPhonePrefixPickerDialogForPhoneBinding(Ljava/util/List;Lo50/c;Ljava/lang/String;Landroidx/fragment/app/FragmentManager;)V
    .locals 0
    ...
    .line 1
    sget-object p1, Lo50/c;->PHONE:Lo50/c;

    return-void
.end method

.method public startChangePhoneAction(Ljava/lang/String;Ljava/lang/String;I)Lg90/v;
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p1, p2, p3}, Lorg/xbet/domain/security/interactors/ManipulateEntryInteractor;->startChangePhoneAction(Ljava/lang/String;Ljava/lang/String;I)Lg90/v;

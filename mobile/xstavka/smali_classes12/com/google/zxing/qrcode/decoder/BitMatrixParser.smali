...
.method b()V
    ...
    invoke-virtual {v3, v0, v2}, Lcom/google/zxing/common/BitMatrix;->h(II)Z

    move-result v3

    iget-object v4, p0, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a:Lcom/google/zxing/common/BitMatrix;

    invoke-virtual {v4, v2, v0}, Lcom/google/zxing/common/BitMatrix;->h(II)Z
    ...
    invoke-virtual {v3, v2, v0}, Lcom/google/zxing/common/BitMatrix;->e(II)V

    .line 5
    iget-object v3, p0, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a:Lcom/google/zxing/common/BitMatrix;

    invoke-virtual {v3, v0, v2}, Lcom/google/zxing/common/BitMatrix;->e(II)V
...
.method c()[B
    ...
    .line 1
    invoke-virtual/range {p0 .. p0}, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->d()Lcom/google/zxing/qrcode/decoder/FormatInformation;

    move-result-object v1

    .line 2
    invoke-virtual/range {p0 .. p0}, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->e()Lcom/google/zxing/qrcode/decoder/Version;
    ...
    invoke-virtual {v1}, Lcom/google/zxing/qrcode/decoder/FormatInformation;->c()B
    ...
    .line 5
    iget-object v4, v0, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a:Lcom/google/zxing/common/BitMatrix;

    invoke-virtual {v1, v4, v3}, Lcom/google/zxing/qrcode/decoder/DataMask;->d(Lcom/google/zxing/common/BitMatrix;I)V
    ...
    .line 7
    invoke-virtual {v2}, Lcom/google/zxing/qrcode/decoder/Version;->h()I
    ...
    .line 8
    invoke-virtual {v1, v15, v13}, Lcom/google/zxing/common/BitMatrix;->h(II)Z
    ...
    .line 9
    iget-object v6, v0, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a:Lcom/google/zxing/common/BitMatrix;

    invoke-virtual {v6, v15, v13}, Lcom/google/zxing/common/BitMatrix;->h(II)Z
...
.method d()Lcom/google/zxing/qrcode/decoder/FormatInformation;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/FormatException;
    ...
    .line 2
    invoke-direct {p0, v1, v4, v2}, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a(III)I
    ...
    .line 4
    invoke-direct {p0, v4, v4, v2}, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a(III)I

    move-result v2

    .line 5
    invoke-direct {p0, v4, v1, v2}, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a(III)I
    ...
    .line 6
    invoke-direct {p0, v4, v2, v1}, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a(III)I
    ...
    invoke-virtual {v2}, Lcom/google/zxing/common/BitMatrix;->l()I
    ...
    .line 8
    invoke-direct {p0, v4, v5, v0}, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a(III)I
    ...
    .line 9
    invoke-direct {p0, v3, v4, v0}, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a(III)I
...
.method e()Lcom/google/zxing/qrcode/decoder/Version;
    ...
    .line 4
    invoke-static {v1}, Lcom/google/zxing/qrcode/decoder/Version;->i(I)Lcom/google/zxing/qrcode/decoder/Version;
    ...
    .line 5
    invoke-direct {p0, v6, v4, v5}, Lcom/google/zxing/qrcode/decoder/BitMatrixParser;->a(III)I
    ...
    .line 7
    invoke-virtual {v4}, Lcom/google/zxing/qrcode/decoder/Version;->e()I
    ...
    .line 11
    invoke-virtual {v1}, Lcom/google/zxing/qrcode/decoder/Version;->e()I
...
.method f()V
    ...
    invoke-virtual {v0, v2, v1}, Lcom/google/zxing/qrcode/decoder/DataMask;->d(Lcom/google/zxing/common/BitMatrix;I)V

...
# static fields
.field private static final g:Lcom/google/firebase/inject/Provider;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/components/ComponentRuntime;->g:Lcom/google/firebase/inject/Provider;
...
.method private constructor <init>(Ljava/util/concurrent/Executor;Ljava/lang/Iterable;Ljava/util/Collection;)V
    ...
    invoke-static {v0, v1, v2}, Lcom/google/firebase/components/Component;->p(Ljava/lang/Object;Ljava/lang/Class;[Ljava/lang/Class;)Lcom/google/firebase/components/Component;
    ...
    invoke-static {p0, v0, v1}, Lcom/google/firebase/components/Component;->p(Ljava/lang/Object;Ljava/lang/Class;[Ljava/lang/Class;)Lcom/google/firebase/components/Component;
    ...
    .line 13
    :cond_1
    invoke-static {p2}, Lcom/google/firebase/components/ComponentRuntime;->m(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    .line 14
    invoke-direct {p0, p1}, Lcom/google/firebase/components/ComponentRuntime;->j(Ljava/util/List;)V
...
.method public static synthetic f(Lcom/google/firebase/components/ComponentRuntime;Lcom/google/firebase/components/Component;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/components/ComponentRuntime;->n(Lcom/google/firebase/components/Component;)Ljava/lang/Object;
...
.method public static synthetic g(Lcom/google/firebase/components/LazySet;Lcom/google/firebase/inject/Provider;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/components/ComponentRuntime;->p(Lcom/google/firebase/components/LazySet;Lcom/google/firebase/inject/Provider;)V

    return-void
.end method

.method public static synthetic h(Lcom/google/firebase/components/OptionalProvider;Lcom/google/firebase/inject/Provider;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/components/ComponentRuntime;->o(Lcom/google/firebase/components/OptionalProvider;Lcom/google/firebase/inject/Provider;)V

    return-void
.end method

.method public static i(Ljava/util/concurrent/Executor;)Lcom/google/firebase/components/ComponentRuntime$Builder;
    .locals 1
...
.method private j(Ljava/util/List;)V
    ...
    .line 19
    :cond_3
    invoke-direct {p0, p1}, Lcom/google/firebase/components/ComponentRuntime;->s(Ljava/util/List;)Ljava/util/List;
    ...
    .line 20
    invoke-direct {p0}, Lcom/google/firebase/components/ComponentRuntime;->t()Ljava/util/List;
    ...
    .line 21
    invoke-direct {p0}, Lcom/google/firebase/components/ComponentRuntime;->r()V
    ...
    .line 25
    :cond_4
    invoke-direct {p0}, Lcom/google/firebase/components/ComponentRuntime;->q()V
...
.method private k(Ljava/util/Map;Z)V
    ...
    .line 4
    invoke-virtual {v1}, Lcom/google/firebase/components/Component;->k()Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v1}, Lcom/google/firebase/components/Component;->l()Z
...
.method private synthetic n(Lcom/google/firebase/components/Component;)Ljava/lang/Object;
    .locals 2

    .line 1
    invoke-virtual {p1}, Lcom/google/firebase/components/Component;->f()Lcom/google/firebase/components/ComponentFactory;
...
.method private static synthetic o(Lcom/google/firebase/components/OptionalProvider;Lcom/google/firebase/inject/Provider;)V
    .locals 0
...
.method private static synthetic p(Lcom/google/firebase/components/LazySet;Lcom/google/firebase/inject/Provider;)V
    .locals 0
...
.method private q()V
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/firebase/components/ComponentRuntime;->k(Ljava/util/Map;Z)V
...
.method private r()V
    ...
    .line 2
    invoke-virtual {v1}, Lcom/google/firebase/components/Component;->e()Ljava/util/Set;
    ...
    invoke-virtual {v3}, Lcom/google/firebase/components/Dependency;->c()Ljava/lang/Class;
...
.method private s(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    invoke-virtual {v1}, Lcom/google/firebase/components/Component;->m()Z
...
.method private t()Ljava/util/List;
    ...
    .line 5
    invoke-virtual {v4}, Lcom/google/firebase/components/Component;->m()Z
    ...
    .line 7
    invoke-virtual {v4}, Lcom/google/firebase/components/Component;->g()Ljava/util/Set;
...
.method public bridge synthetic a(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 1
    invoke-super {p0, p1}, Lcom/google/firebase/components/AbstractComponentContainer;->a(Ljava/lang/Class;)Ljava/lang/Object;
...
.method public declared-synchronized b(Ljava/lang/Class;)Lcom/google/firebase/inject/Provider;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :cond_0
    :try_start_1
    sget-object p1, Lcom/google/firebase/components/ComponentRuntime;->g:Lcom/google/firebase/inject/Provider;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public bridge synthetic c(Ljava/lang/Class;)Ljava/util/Set;
    ...
    .line 1
    invoke-super {p0, p1}, Lcom/google/firebase/components/AbstractComponentContainer;->c(Ljava/lang/Class;)Ljava/util/Set;
...
.method public declared-synchronized d(Ljava/lang/Class;)Lcom/google/firebase/inject/Provider;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public e(Ljava/lang/Class;)Lcom/google/firebase/inject/Deferred;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/google/firebase/components/ComponentRuntime;->d(Ljava/lang/Class;)Lcom/google/firebase/inject/Provider;
...
.method public l(Z)V
    ...
    .line 5
    invoke-direct {p0, v0, p1}, Lcom/google/firebase/components/ComponentRuntime;->k(Ljava/util/Map;Z)V

...
.method public static synthetic b(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->insert$lambda-9(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lg90/z;
...
.method public static synthetic c(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->getInsertedGames$lambda-17(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lg90/z;
...
.method public static synthetic d(Ljava/lang/Long;Ljava/util/List;)Lca0/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->insert$lambda-4(Ljava/lang/Long;Ljava/util/List;)Lca0/m;
...
.method private static final deleteAllFromList$lambda-10(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lg90/d;
    .locals 1
    ...
    invoke-virtual {p0, v0, p1}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->deleteAllIfExist(Ljava/util/Set;Ljava/util/Set;)Lg90/b;
...
.method public static synthetic e(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteGame;Lca0/m;)Lg90/z;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->insert$lambda-5(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteGame;Lca0/m;)Lg90/z;
...
.method public static synthetic f(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteGame;Ljava/lang/Boolean;)Lg90/z;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->updateFavorite$lambda-13(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteGame;Ljava/lang/Boolean;)Lg90/z;
...
.method public static synthetic g(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lg90/d;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->deleteAllFromList$lambda-10(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lg90/d;
...
.method private final getInsertedGames(Ljava/util/List;)Lg90/v;
    .locals 2
    ...
    .line 1
    invoke-direct {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->splittedGamesIdIsLive(Ljava/util/List;)Lg90/v;
    ...
    invoke-direct {v1, p0}, Lkd0/s;-><init>(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;)V
    ...
    invoke-direct {v1, p1, p0}, Lkd0/o;-><init>(Ljava/util/List;Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;)V
...
.method private static final getInsertedGames$lambda-17(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lg90/z;
    .locals 1
    ...
    invoke-virtual {p0, v0, p1}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->allIfExists(Ljava/util/Set;Ljava/util/Set;)Lg90/v;
...
.method public static synthetic h(Ljava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->splittedGamesIdIsLive$lambda-16(Ljava/util/List;)Lg90/z;
...
.method public static synthetic i(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lca0/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->insert$lambda-7(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lca0/m;
...
.method private static final insert$lambda-4(Ljava/lang/Long;Ljava/util/List;)Lca0/m;
    .locals 5
...
.method private static final insert$lambda-5(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteGame;Lca0/m;)Lg90/z;
    .locals 1
...
.method private static final insert$lambda-6(Ljava/lang/Long;Ljava/util/List;)Lca0/m;
    .locals 0
...
.method private static final insert$lambda-7(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lca0/m;
    .locals 2
...
.method private static final insert$lambda-9(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lca0/m;)Lg90/z;
    .locals 5
    ...
    :cond_0
    invoke-interface {v1, v3}, Lorg/xbet/onexdatabase/dao/BaseDao;->insertOrReplace(Ljava/util/Collection;)Lg90/b;
    ...
    invoke-virtual {v1, p0}, Lg90/b;->f(Lg90/z;)Lg90/v;
...
.method public static synthetic m(Ljava/lang/Boolean;Ljava/lang/Boolean;)Lca0/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->updateFavorite$lambda-13$lambda-12(Ljava/lang/Boolean;Ljava/lang/Boolean;)Lca0/m;
...
.method public static synthetic n(Ljava/lang/Long;Ljava/util/List;)Lca0/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->insert$lambda-6(Ljava/lang/Long;Ljava/util/List;)Lca0/m;
...
.method private final splittedGamesIdIsLive(Ljava/util/List;)Lg90/v;
    ...
    invoke-direct {v0, p1}, Lkd0/l;-><init>(Ljava/util/List;)V
...
.method private static final splittedGamesIdIsLive$lambda-16(Ljava/util/List;)Lg90/z;
    .locals 5
...
.method private static final updateFavorite$lambda-13(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteGame;Ljava/lang/Boolean;)Lg90/z;
    .locals 1
    ...
    .line 2
    invoke-virtual {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->delete(Lorg/xbet/domain/betting/favorites/models/FavoriteGame;)Lg90/b;
    ...
    .line 4
    :cond_0
    invoke-virtual {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->insert(Lorg/xbet/domain/betting/favorites/models/FavoriteGame;)Lg90/v;

    move-result-object p0

    .line 5
    :goto_0
    new-instance p1, Lkd0/n;

    invoke-direct {p1, p2}, Lkd0/n;-><init>(Ljava/lang/Boolean;)V
...
.method private static final updateFavorite$lambda-13$lambda-12(Ljava/lang/Boolean;Ljava/lang/Boolean;)Lca0/m;
    .locals 0
...
.method public all()Lg90/v;
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->all()Lg90/v;

    move-result-object v0

    new-instance v1, Lkd0/p;

    invoke-direct {v1, p0}, Lkd0/p;-><init>(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;)V
...
.method public allIfExists(Ljava/util/Set;Ljava/util/Set;)Lg90/v;
    ...
    invoke-virtual {v0, p1, p2}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->allIfExists(Ljava/util/Set;Ljava/util/Set;)Lg90/v;

    move-result-object p1

    new-instance p2, Lkd0/q;

    invoke-direct {p2, p0}, Lkd0/q;-><init>(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;)V
...
.method public delete(Lorg/xbet/domain/betting/favorites/models/FavoriteGame;)Lg90/b;
    .locals 1
...
.method public deleteAll()Lg90/b;
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->deleteAll()Lg90/b;
...
.method public deleteAllFromList(Ljava/util/List;)Lg90/b;
    ...
    invoke-direct {v0, p0}, Lkd0/t;-><init>(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;)V
...
.method public insert(Ljava/util/List;)Lg90/v;
    .locals 2
    .param p1    # Ljava/util/List;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->count()Lg90/v;

    move-result-object v0

    .line 6
    invoke-direct {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;->getInsertedGames(Ljava/util/List;)Lg90/v;

    move-result-object p1

    sget-object v1, Lkd0/m;->a:Lkd0/m;
    ...
    invoke-direct {v0, p0}, Lkd0/u;-><init>(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;)V
    ...
    invoke-direct {v0, p0}, Lkd0/r;-><init>(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;)V
...
.method public insert(Lorg/xbet/domain/betting/favorites/models/FavoriteGame;)Lg90/v;
    .locals 5
    .param p1    # Lorg/xbet/domain/betting/favorites/models/FavoriteGame;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v1, v2, v3, v4}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->firstIfExists(JZ)Lg90/v;

    move-result-object v1

    sget-object v2, Lkd0/h;->a:Lkd0/h;
    ...
    invoke-direct {v1, p0, p1}, Lkd0/j;-><init>(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteGame;)V
...
.method public observeFavoriteCount()Lg90/o;
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->observeFavoriteCount()Lg90/o;
...
.method public subGamesCount(J)Lg90/v;
    ...
    invoke-virtual {v0, p1, p2}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->subGamesCount(J)Lg90/v;
...
.method public updateFavorite(Lorg/xbet/domain/betting/favorites/models/FavoriteGame;)Lg90/v;
    .locals 4
    .param p1    # Lorg/xbet/domain/betting/favorites/models/FavoriteGame;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, v1, v2, v3}, Lorg/xbet/onexdatabase/dao/FavoriteGameDao;->firstIfExists(JZ)Lg90/v;

    move-result-object v0

    sget-object v1, Lkd0/k;->a:Lkd0/k;
    ...
    invoke-direct {v1, p0, p1}, Lkd0/i;-><init>(Lorg/xbet/data/betting/favorites/FavoriteGameRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteGame;)V

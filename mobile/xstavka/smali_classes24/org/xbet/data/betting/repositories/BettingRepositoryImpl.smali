...
# direct methods
.method public constructor <init>(Ly40/t;Lcom/xbet/onexuser/domain/user/c;Lorg/xbet/data/betting/mappers/BetDataRequestMapper;Lorg/xbet/data/betting/mappers/MakeBetResultMapper;Lorg/xbet/data/betting/mappers/MultiSingleRequestMapper;Lorg/xbet/domain/betting/repositories/BetEventRepository;Lorg/xbet/domain/betting/coupon/repositories/CouponRepository;Lorg/xbet/domain/betting/interactors/BalanceInteractorProvider;Lorg/xbet/domain/betting/utils/BetLogger;Lorg/xbet/data/betting/loggers/BetSysLogger;Lg10/c;Lorg/xbet/data/betting/datasources/BetInputsDataSource;Lzi/j;)V
    .locals 0
    .param p1    # Ly40/t;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->balanceInteractor:Ly40/t;
    ...
    .line 12
    iput-object p11, p0, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->maxBetCacheRepository:Lg10/c;
    ...
    invoke-direct {p1, p13}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl$service$1;-><init>(Lzi/j;)V

    iput-object p1, p0, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->service:Lka0/a;
...
.method public static synthetic a(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lca0/y;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet$lambda-14$lambda-13(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lca0/y;
...
.method public static synthetic b(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lej/h;)Lej/h;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeBet$lambda-6(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lej/h;)Lej/h;
...
.method public static synthetic c(Lorg/xbet/domain/betting/models/BetDataModel;Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/lang/String;Lca0/m;)Lg90/d;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet$lambda-30(Lorg/xbet/domain/betting/models/BetDataModel;Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/lang/String;Lca0/m;)Lg90/d;
...
.method private final createSign(Lorg/xbet/domain/betting/models/BetDataModel;J)Ljava/lang/String;
    ...
    invoke-static {p2}, Lkotlin/text/n;->i1(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method public static synthetic d(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;Lorg/xbet/data/betting/models/responses/BetResultResponse$Value;)Lg90/z;
    .locals 0

    invoke-static/range {p0 .. p5}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeOnceBet$lambda-12(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;Lorg/xbet/data/betting/models/responses/BetResultResponse$Value;)Lg90/z;
...
.method public static synthetic g(Lorg/xbet/data/betting/models/responses/BetResultResponse$Value;)Lej/h;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeBet$lambda-4$lambda-2(Lorg/xbet/data/betting/models/responses/BetResultResponse$Value;)Lej/h;
...
.method public static synthetic h(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet$lambda-19(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/util/List;)Lg90/z;
...
.method public static synthetic j(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lg90/d;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet$lambda-14(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lg90/d;
...
.method public static synthetic l(Ljava/util/List;Ljava/util/List;)Lca0/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet$lambda-19$lambda-18(Ljava/util/List;Ljava/util/List;)Lca0/m;
...
.method private final logSuccessResponse(Lorg/xbet/domain/betting/models/BetDataModel;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v5}, Ll80/a$a;->b(I)Ll80/a;
    ...
    invoke-virtual {v4, p1}, Ll80/a$a;->b(I)Ll80/a;
...
.method public static synthetic m(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lca0/y;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeBet$lambda-1$lambda-0(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lca0/y;
...
.method private static final makeBet$lambda-1(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lg90/z;
    .locals 1

    .line 1
    new-instance v0, Lorg/xbet/data/betting/repositories/x;

    invoke-direct {v0, p0}, Lorg/xbet/data/betting/repositories/x;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V
...
.method private static final makeBet$lambda-1$lambda-0(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lca0/y;
    .locals 3
...
.method private static final makeBet$lambda-4(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;Lca0/y;)Lg90/z;
    .locals 9
    ...
    .line 1
    invoke-static/range {v0 .. v8}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeOnceBet$default(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;JILjava/lang/Object;)Lg90/v;

    move-result-object p0

    sget-object p1, Lorg/xbet/data/betting/repositories/s;->a:Lorg/xbet/data/betting/repositories/s;
    ...
    sget-object p1, Lorg/xbet/data/betting/repositories/r;->a:Lorg/xbet/data/betting/repositories/r;
...
.method private static final makeBet$lambda-4$lambda-2(Lorg/xbet/data/betting/models/responses/BetResultResponse$Value;)Lej/h;
    .locals 1

    .line 1
    new-instance v0, Lej/h$b;

    invoke-direct {v0, p0}, Lej/h$b;-><init>(Ljava/lang/Object;)V

    return-object v0
.end method

.method private static final makeBet$lambda-4$lambda-3(Ljava/lang/Throwable;)Lej/h;
    .locals 1

    .line 1
    new-instance v0, Lej/h$a;

    invoke-direct {v0, p0}, Lej/h$a;-><init>(Ljava/lang/Object;)V

    return-object v0
.end method

.method private static final makeBet$lambda-5(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lej/h;)V
    .locals 0
...
.method private static final makeBet$lambda-6(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lej/h;)Lej/h;
    .locals 1

    .line 1
    invoke-virtual {p1}, Lej/h;->d()Ljava/lang/Object;
    ...
    new-instance p0, Lej/h$a;

    invoke-virtual {p1}, Lej/h;->a()Ljava/lang/Object;

    move-result-object p1

    invoke-direct {p0, p1}, Lej/h$a;-><init>(Ljava/lang/Object;)V

    return-object p0

    .line 2
    :cond_0
    new-instance p1, Lej/h$b;
    ...
    invoke-direct {p1, p0}, Lej/h$b;-><init>(Ljava/lang/Object;)V

    return-object p1
.end method

.method private final makeMultiBet(Lorg/xbet/domain/betting/models/BetDataModel;Ljava/lang/String;JLjava/util/Map;)Lg90/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-direct {p0, p1, p3, p4, v0}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->prepareRequest(Lorg/xbet/domain/betting/models/BetDataModel;JZ)Lg90/v;

    move-result-object p3

    .line 7
    new-instance p4, Lorg/xbet/data/betting/repositories/l;

    invoke-direct {p4, p0, p5, p2}, Lorg/xbet/data/betting/repositories/l;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/util/Map;Ljava/lang/String;)V

    invoke-virtual {p3, p4}, Lg90/v;->x(Lj90/l;)Lg90/v;

    move-result-object p3

    .line 8
    new-instance p4, Lorg/xbet/data/betting/repositories/a0;

    invoke-direct {p4, p0, p1}, Lorg/xbet/data/betting/repositories/a0;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;)V

    invoke-virtual {p3, p4}, Lg90/v;->p(Lj90/g;)Lg90/v;

    move-result-object p3

    .line 9
    new-instance p4, Lorg/xbet/data/betting/repositories/j;

    invoke-direct {p4, p0}, Lorg/xbet/data/betting/repositories/j;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V
    ...
    .line 10
    new-instance p4, Lorg/xbet/data/betting/repositories/b0;

    invoke-direct {p4, p0, p1}, Lorg/xbet/data/betting/repositories/b0;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;)V

    invoke-virtual {p3, p4}, Lg90/v;->s(Lj90/g;)Lg90/v;

    move-result-object p3

    .line 11
    new-instance p4, Lorg/xbet/data/betting/repositories/k;

    invoke-direct {p4, p0}, Lorg/xbet/data/betting/repositories/k;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V

    invoke-virtual {p3, p4}, Lg90/v;->G(Lj90/l;)Lg90/v;
    ...
    invoke-direct {p4, p1, p0, p2}, Lorg/xbet/data/betting/repositories/p;-><init>(Lorg/xbet/domain/betting/models/BetDataModel;Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/lang/String;)V

    invoke-virtual {p3, p4}, Lg90/v;->y(Lj90/l;)Lg90/b;
...
.method static synthetic makeMultiBet$default(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;Ljava/lang/String;JLjava/util/Map;ILjava/lang/Object;)Lg90/b;
    .locals 6
    ...
    .line 2
    invoke-direct/range {v0 .. v5}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet(Lorg/xbet/domain/betting/models/BetDataModel;Ljava/lang/String;JLjava/util/Map;)Lg90/b;
...
.method private static final makeMultiBet$lambda-14(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lg90/d;
    .locals 1

    .line 1
    new-instance v0, Lorg/xbet/data/betting/repositories/v;

    invoke-direct {v0, p0}, Lorg/xbet/data/betting/repositories/v;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V
...
.method private static final makeMultiBet$lambda-14$lambda-13(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lca0/y;
    .locals 3
...
.method private static final makeMultiBet$lambda-16(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/util/Map;Ljava/lang/String;Lorg/xbet/domain/betting/models/BetDataModel;)Lg90/z;
    .locals 2
    ...
    .line 2
    iget-object p0, p0, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->service:Lka0/a;
    ...
    invoke-interface {p0, p2, p1}, Lorg/xbet/data/betting/services/BetService;->makeMultiSingleBet(Ljava/lang/String;Lorg/xbet/data/betting/models/requests/MultiSingleRequestWrapper;)Lg90/v;
...
.method private static final makeMultiBet$lambda-19(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/util/List;)Lg90/z;
    .locals 1
    ...
    invoke-interface {p0}, Lorg/xbet/domain/betting/repositories/BetEventRepository;->getAllEvents()Lg90/v;

    move-result-object p0

    new-instance v0, Lorg/xbet/data/betting/repositories/f0;

    invoke-direct {v0, p1}, Lorg/xbet/data/betting/repositories/f0;-><init>(Ljava/util/List;)V
...
.method private static final makeMultiBet$lambda-19$lambda-18(Ljava/util/List;Ljava/util/List;)Lca0/m;
    .locals 0
...
.method private static final makeMultiBet$lambda-26(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;Lca0/m;)V
    .locals 8
    ...
    .line 3
    invoke-virtual {v3}, Li10/e;->getSuccess()Z
    ...
    invoke-virtual {v1}, Li10/e;->getValue()Ljava/lang/Object;
    ...
    .line 7
    invoke-virtual {v5}, Li10/e;->getSuccess()Z

    move-result v6

    if-eqz v6, :cond_7

    invoke-virtual {v5}, Li10/e;->getValue()Ljava/lang/Object;
    ...
    .line 11
    invoke-virtual {v1}, Li10/e;->extractValue()Ljava/lang/Object;
...
.method private static final makeMultiBet$lambda-28(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lca0/m;)Lca0/m;
    .locals 17
    ...
    .line 6
    invoke-virtual {v12}, Li10/e;->getSuccess()Z
    ...
    invoke-virtual {v12}, Li10/e;->getValue()Ljava/lang/Object;
    ...
    .line 19
    invoke-virtual {v12}, Li10/e;->getErrorCode()Lcom/xbet/onexcore/data/errors/b;
    ...
    .line 20
    :cond_d
    invoke-virtual {v12}, Li10/e;->getError()Ljava/lang/String;
    ...
    invoke-static {v11}, Lej/c;->d(Lkotlin/jvm/internal/l0;)Ljava/lang/String;
    ...
    invoke-static {v5, v0}, Lca0/t;->a(Ljava/lang/Object;Ljava/lang/Object;)Lca0/m;
...
.method private static final makeMultiBet$lambda-30(Lorg/xbet/domain/betting/models/BetDataModel;Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/lang/String;Lca0/m;)Lg90/d;
    .locals 44
    ...
    .line 8
    invoke-direct/range {v1 .. v6}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet(Lorg/xbet/domain/betting/models/BetDataModel;Ljava/lang/String;JLjava/util/Map;)Lg90/b;
...
.method private final makeOnceBet(Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;J)Lg90/v;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p1, p5, p6, p2}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->prepareRequest(Lorg/xbet/domain/betting/models/BetDataModel;JZ)Lg90/v;

    move-result-object p5

    .line 2
    new-instance p6, Lorg/xbet/data/betting/repositories/q;

    invoke-direct {p6, p3, p0, p4}, Lorg/xbet/data/betting/repositories/q;-><init>(ZLorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/lang/String;)V

    invoke-virtual {p5, p6}, Lg90/v;->x(Lj90/l;)Lg90/v;

    move-result-object p5

    .line 3
    new-instance p6, Lorg/xbet/data/betting/repositories/z;

    invoke-direct {p6, p0}, Lorg/xbet/data/betting/repositories/z;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V

    invoke-virtual {p5, p6}, Lg90/v;->s(Lj90/g;)Lg90/v;

    move-result-object p5

    sget-object p6, Lorg/xbet/data/betting/repositories/u;->a:Lorg/xbet/data/betting/repositories/u;

    .line 4
    invoke-virtual {p5, p6}, Lg90/v;->G(Lj90/l;)Lg90/v;

    move-result-object p5

    .line 5
    new-instance p6, Lorg/xbet/data/betting/repositories/c0;

    invoke-direct {p6, p0, p1, p2}, Lorg/xbet/data/betting/repositories/c0;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;Z)V

    invoke-virtual {p5, p6}, Lg90/v;->p(Lj90/g;)Lg90/v;

    move-result-object p5

    .line 6
    new-instance p6, Lorg/xbet/data/betting/repositories/n;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/xbet/data/betting/repositories/n;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;)V
...
.method static synthetic makeOnceBet$default(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;JILjava/lang/Object;)Lg90/v;
    .locals 7
    ...
    .line 1
    invoke-direct/range {v0 .. v6}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeOnceBet(Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;J)Lg90/v;
...
.method private static final makeOnceBet$lambda-10(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZLjava/lang/Throwable;)V
    ...
    .line 5
    sget-object p0, Ll80/a;->Companion:Ll80/a$a;

    invoke-virtual {p1}, Lorg/xbet/domain/betting/models/BetDataModel;->getVid()I

    move-result p1

    invoke-virtual {p0, p1}, Ll80/a$a;->b(I)Ll80/a;
...
.method private static final makeOnceBet$lambda-12(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;Lorg/xbet/data/betting/models/responses/BetResultResponse$Value;)Lg90/z;
    .locals 37
    ...
    .line 3
    invoke-static/range {p5 .. p5}, Lg90/v;->F(Ljava/lang/Object;)Lg90/v;

    move-result-object v0

    .line 4
    new-instance v1, Lorg/xbet/data/betting/repositories/e0;
    ...
    invoke-direct {v1, v11, v15, v13, v12}, Lorg/xbet/data/betting/repositories/e0;-><init>(ZLorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;Z)V
    ...
    .line 7
    invoke-direct/range {v2 .. v8}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeOnceBet(Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;J)Lg90/v;
...
.method private static final makeOnceBet$lambda-12$lambda-11(ZLorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZLorg/xbet/data/betting/models/responses/BetResultResponse$Value;)V
    ...
    .line 3
    :cond_0
    iget-object v0, p1, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->balanceInteractor:Ly40/t;
    ...
    .line 10
    :goto_2
    sget-object v3, Ll80/a;->Companion:Ll80/a$a;

    invoke-virtual {p2}, Lorg/xbet/domain/betting/models/BetDataModel;->getVid()I

    move-result v4

    invoke-virtual {v3, v4}, Ll80/a$a;->b(I)Ll80/a;
    ...
    invoke-virtual {v3, p0}, Ll80/a$a;->b(I)Ll80/a;
...
.method private static final makeOnceBet$lambda-7(ZLorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/lang/String;Lorg/xbet/domain/betting/models/BetDataModel;)Lg90/z;
    .locals 0

    if-eqz p0, :cond_0

    .line 1
    iget-object p0, p1, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->service:Lka0/a;
    ...
    invoke-interface {p0, p2, p1}, Lorg/xbet/data/betting/services/BetService;->makeAutoBet(Ljava/lang/String;Lorg/xbet/data/betting/models/requests/BetDataRequest;)Lg90/v;
    ...
    invoke-interface {p0, p2, p1}, Lorg/xbet/data/betting/services/BetService;->makeNewBet(Ljava/lang/String;Lorg/xbet/data/betting/models/requests/BetDataRequest;)Lg90/v;
...
.method public static synthetic n(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;Lca0/m;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet$lambda-26(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;Lca0/m;)V

    return-void
.end method

.method public static synthetic o(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lej/h;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeBet$lambda-5(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lej/h;)V

    return-void
.end method

.method public static synthetic p(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lg90/z;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeBet$lambda-1(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)Lg90/z;
...
.method private final prepareRequest(Lorg/xbet/domain/betting/models/BetDataModel;JZ)Lg90/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p2, p3, v0}, Lg90/v;->V(JLjava/util/concurrent/TimeUnit;)Lg90/v;

    move-result-object p2

    .line 2
    new-instance p3, Lorg/xbet/data/betting/repositories/o;

    invoke-direct {p3, p1, p0}, Lorg/xbet/data/betting/repositories/o;-><init>(Lorg/xbet/domain/betting/models/BetDataModel;Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V
    ...
    .line 3
    new-instance p3, Lorg/xbet/data/betting/repositories/d0;

    invoke-direct {p3, p0, p1, p4}, Lorg/xbet/data/betting/repositories/d0;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;Z)V

    invoke-virtual {p2, p3}, Lg90/v;->s(Lj90/g;)Lg90/v;
...
.method private static final prepareRequest$lambda-32(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZLorg/xbet/domain/betting/models/BetDataModel;)V
    ...
    invoke-virtual {v1, p1}, Ll80/a$a;->b(I)Ll80/a;
...
.method public static synthetic q(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/util/Map;Ljava/lang/String;Lorg/xbet/domain/betting/models/BetDataModel;)Lg90/z;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet$lambda-16(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/util/Map;Ljava/lang/String;Lorg/xbet/domain/betting/models/BetDataModel;)Lg90/z;
...
.method public static synthetic t(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;Lca0/y;)Lg90/z;
    .locals 0

    invoke-static/range {p0 .. p5}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeBet$lambda-4(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;Lca0/y;)Lg90/z;
...
.method public static synthetic u(Ljava/lang/Throwable;)Lej/h;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeBet$lambda-4$lambda-3(Ljava/lang/Throwable;)Lej/h;
...
.method public static synthetic w(ZLorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/lang/String;Lorg/xbet/domain/betting/models/BetDataModel;)Lg90/z;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeOnceBet$lambda-7(ZLorg/xbet/data/betting/repositories/BettingRepositoryImpl;Ljava/lang/String;Lorg/xbet/domain/betting/models/BetDataModel;)Lg90/z;
...
.method public static synthetic x(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lca0/m;)Lca0/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet$lambda-28(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lca0/m;)Lca0/m;
...
.method public clear()V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->maxBetCacheRepository:Lg10/c;
...
.method public makeBet(Ljava/lang/String;Lorg/xbet/domain/betting/models/BetDataModel;ZZ)Lg90/v;
    .locals 11
    ...
    invoke-direct {v0, p0}, Lorg/xbet/data/betting/repositories/y;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V
    ...
    .line 3
    new-instance v10, Lorg/xbet/data/betting/repositories/m;
    ...
    invoke-direct/range {v4 .. v9}, Lorg/xbet/data/betting/repositories/m;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;ZZLjava/lang/String;)V
    ...
    .line 4
    invoke-virtual {p1, v2, v3, v1}, Lg90/v;->j(JLjava/util/concurrent/TimeUnit;)Lg90/v;

    move-result-object p1

    .line 5
    new-instance p2, Lorg/xbet/data/betting/repositories/t;

    invoke-direct {p2, p0}, Lorg/xbet/data/betting/repositories/t;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V
    ...
    .line 6
    new-instance p2, Lorg/xbet/data/betting/repositories/g0;

    invoke-direct {p2, p0}, Lorg/xbet/data/betting/repositories/g0;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V
...
.method public makeMultiBet(Ljava/lang/String;Lorg/xbet/domain/betting/models/BetDataModel;)Lg90/b;
    .locals 12
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v0, p0}, Lorg/xbet/data/betting/repositories/w;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V

    invoke-static {v0}, Lg90/b;->i(Ljava/util/concurrent/Callable;)Lg90/b;
    ...
    invoke-virtual {v0, v2, v3, v1}, Lg90/b;->j(JLjava/util/concurrent/TimeUnit;)Lg90/b;
    ...
    .line 3
    invoke-static/range {v4 .. v11}, Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;->makeMultiBet$default(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;Lorg/xbet/domain/betting/models/BetDataModel;Ljava/lang/String;JLjava/util/Map;ILjava/lang/Object;)Lg90/b;

    move-result-object p1

    invoke-virtual {v0, p1}, Lg90/b;->d(Lg90/d;)Lg90/b;

    move-result-object p1

    .line 4
    invoke-virtual {p1, v2, v3, v1}, Lg90/b;->j(JLjava/util/concurrent/TimeUnit;)Lg90/b;

    move-result-object p1

    .line 5
    new-instance p2, Lorg/xbet/data/betting/repositories/i;

    invoke-direct {p2, p0}, Lorg/xbet/data/betting/repositories/i;-><init>(Lorg/xbet/data/betting/repositories/BettingRepositoryImpl;)V

    invoke-virtual {p1, p2}, Lg90/b;->m(Lj90/a;)Lg90/b;

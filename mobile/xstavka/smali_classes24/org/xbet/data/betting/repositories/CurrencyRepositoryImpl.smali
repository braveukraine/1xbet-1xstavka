...
.method private static final allVisible$lambda-1(Lorg/xbet/data/betting/repositories/CurrencyRepositoryImpl;Ljava/util/List;)Ljava/util/List;
    ...
    .line 4
    invoke-direct {p0, v1}, Lorg/xbet/data/betting/repositories/CurrencyRepositoryImpl;->convert(Lorg/xbet/onexdatabase/entity/CurrencyEntity;)Lx40/f;
...
.method private static final byId$lambda-2(Lorg/xbet/data/betting/repositories/CurrencyRepositoryImpl;Lorg/xbet/onexdatabase/entity/CurrencyEntity;)Lx40/f;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lorg/xbet/data/betting/repositories/CurrencyRepositoryImpl;->convert(Lorg/xbet/onexdatabase/entity/CurrencyEntity;)Lx40/f;
...
.method public static synthetic c(Lorg/xbet/data/betting/repositories/CurrencyRepositoryImpl;Lorg/xbet/onexdatabase/entity/CurrencyEntity;)Lx40/f;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/repositories/CurrencyRepositoryImpl;->byId$lambda-2(Lorg/xbet/data/betting/repositories/CurrencyRepositoryImpl;Lorg/xbet/onexdatabase/entity/CurrencyEntity;)Lx40/f;
...
.method private final convert(Lx40/f;)Lorg/xbet/onexdatabase/entity/CurrencyEntity;
    .locals 19
...
.method private final convert(Lorg/xbet/onexdatabase/entity/CurrencyEntity;)Lx40/f;
    .locals 19
...
# virtual methods
.method public allVisible()Lg90/v;
    .locals 2
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/CurrencyDao;->allVisible()Lg90/v;
...
.method public byId(J)Lg90/v;
    ...
    invoke-virtual {v0, p1, p2}, Lorg/xbet/onexdatabase/dao/CurrencyDao;->byId(J)Lg90/v;
...
.method public byIds(Ljava/util/Set;)Lg90/v;
    ...
    invoke-virtual {v0, p1}, Lorg/xbet/onexdatabase/dao/CurrencyDao;->byIds(Ljava/util/Set;)Lg90/v;
...
.method public insert(Ljava/util/Collection;)Lg90/b;
    ...
    .line 5
    invoke-direct {p0, v2}, Lorg/xbet/data/betting/repositories/CurrencyRepositoryImpl;->convert(Lx40/f;)Lorg/xbet/onexdatabase/entity/CurrencyEntity;

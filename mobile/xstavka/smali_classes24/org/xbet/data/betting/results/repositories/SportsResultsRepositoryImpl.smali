...
.method public getSportsHistoryResults(JJLjava/lang/String;II)Lg90/v;
    .locals 10
    ...
    .line 3
    invoke-virtual {v1, v2}, Lorg/xbet/data/betting/results/datasources/SportsResultsRemoteDataSource;->getSportsHistoryResults(Ljava/util/Map;)Lg90/v;
    ...
    new-instance v3, Lqd0/h;

    invoke-direct {v3, v2}, Lqd0/h;-><init>(Lorg/xbet/data/betting/results/mappers/ListSportsResultsItemsMapper;)V
...
.method public getSportsLiveResults(Ljava/util/List;ZII)Lg90/v;
    .locals 2
    ...
    .line 3
    invoke-virtual {v0, p2}, Lorg/xbet/data/betting/results/datasources/SportsResultsRemoteDataSource;->getSportsLiveResults(Ljava/util/Map;)Lg90/v;

    move-result-object p2

    .line 4
    invoke-virtual {p0, p2}, Lorg/xbet/data/betting/results/repositories/SportsResultsRepositoryImpl;->extractJsonValue(Lg90/v;)Lg90/v;
    ...
    invoke-virtual {p0, p2, p4, p3}, Lorg/xbet/data/betting/results/repositories/SportsResultsRepositoryImpl;->toSportZipList(Lg90/v;ZLorg/xbet/data/betting/feed/linelive/mappers/SportsZipMapper;)Lg90/v;

    move-result-object p2

    .line 6
    new-instance p3, Lqd0/j;

    invoke-direct {p3, p0, p1}, Lqd0/j;-><init>(Lorg/xbet/data/betting/results/repositories/SportsResultsRepositoryImpl;Ljava/util/List;)V
    ...
    new-instance p3, Lqd0/i;

    invoke-direct {p3, p2}, Lqd0/i;-><init>(Lorg/xbet/data/betting/results/mappers/ListSportsResultsItemsMapper;)V

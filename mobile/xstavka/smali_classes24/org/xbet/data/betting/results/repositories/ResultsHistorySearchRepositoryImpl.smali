...
.method public getFoundGamesObservable()Lg90/o;
    .locals 1
    ...
    invoke-virtual {v0}, Lorg/xbet/data/betting/results/datasources/ResultsHistorySearchLocalDataSource;->getGamesObservable()Lg90/o;
...
.method public getQueryObservable()Lg90/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lorg/xbet/data/betting/results/datasources/ResultsHistorySearchLocalDataSource;->getQueryObservable()Lg90/o;
...
.method public getQueryResults(Ljava/lang/String;ILjava/lang/String;II)Lg90/v;
    .locals 7
    ...
    .line 3
    invoke-virtual {v0, p1}, Lorg/xbet/data/betting/results/datasources/ResultsHistorySearchRemoteDataSource;->getQueryResults(Ljava/util/Map;)Lg90/v;

    move-result-object p1

    sget-object p2, Lqd0/g;->a:Lqd0/g;
    ...
    new-instance p3, Lqd0/f;

    invoke-direct {p3, p2}, Lqd0/f;-><init>(Lorg/xbet/data/betting/results/mappers/ListGamesResultsItemsMapper;)V

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "serviceGenerator",
        "<init>",
        "(Lorg/xbet/domain/betting/repositories/BetEventRepository;Lej/b;Lorg/xbet/data/betting/coupon/mappers/LoadCouponModelMapper;Lej/b;Lzi/j;)V",
        "betting_release"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Lorg/xbet/domain/betting/repositories/BetEventRepository;Lej/b;Lorg/xbet/data/betting/coupon/mappers/LoadCouponModelMapper;Lej/b;Lzi/j;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;->settingsManager:Lej/b;
    ...
    .line 5
    iput-object p4, p0, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;->appSettingsManager:Lej/b;

    .line 6
    new-instance p1, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl$service$1;

    invoke-direct {p1, p5}, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl$service$1;-><init>(Lzi/j;)V

    iput-object p1, p0, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;->service:Lka0/a;

    return-void
.end method

.method public static synthetic a(Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;Ll80/a;JLjava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;->saveCoupon$lambda-0(Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;Ll80/a;JLjava/util/List;)Lg90/z;
...
.method private static final saveCoupon$lambda-0(Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;Ll80/a;JLjava/util/List;)Lg90/z;
    .locals 11

    .line 1
    iget-object v0, p0, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;->service:Lka0/a;
    ...
    .line 2
    iget-object v1, p0, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;->settingsManager:Lej/b;
    ...
    .line 5
    iget-object p0, p0, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;->settingsManager:Lej/b;
    ...
    .line 10
    :cond_0
    sget-object p0, Lr80/a;->Companion:Lr80/a$a;

    invoke-virtual {p1}, Ll80/a;->e()I

    move-result p1

    invoke-virtual {p0, p1}, Lr80/a$a;->a(I)Lr80/a;
    ...
    invoke-direct/range {v2 .. v10}, Lorg/xbet/data/betting/coupon/models/CouponExportRequest;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;IIJLr80/a;)V

    .line 12
    invoke-interface {v0, p0}, Lorg/xbet/data/betting/coupon/services/CouponService;->saveCoupon(Lorg/xbet/data/betting/coupon/models/CouponExportRequest;)Lg90/v;
...
# virtual methods
.method public loadCoupon(Ljava/lang/String;)Lg90/v;
    .locals 4
    ...
    iget-object v2, p0, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;->appSettingsManager:Lej/b;

    invoke-interface {v2}, Lej/b;->getLang()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;->appSettingsManager:Lej/b;
    ...
    invoke-interface {v0, v1}, Lorg/xbet/data/betting/coupon/services/CouponService;->loadCoupon(Lorg/xbet/data/betting/coupon/models/CouponLoadRequest;)Lg90/v;
...
.method public saveCoupon(JLl80/a;)Lg90/v;
    .locals 2
    .param p3    # Ll80/a;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Lorg/xbet/data/betting/coupon/repositories/e;-><init>(Lorg/xbet/data/betting/coupon/repositories/ExportCouponRepositoryImpl;Ll80/a;J)V

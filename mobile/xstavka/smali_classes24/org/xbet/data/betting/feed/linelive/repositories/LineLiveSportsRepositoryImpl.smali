...
.method private final addExhibitionItem(Lg90/v;)Lg90/v;
    .locals 1
...
.method private static final addExhibitionItem$lambda-0(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct/range {v0 .. v9}, Lq80/a;-><init>(JJLjava/util/List;ZZILkotlin/jvm/internal/h;)V
...
.method public static synthetic b(Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveSportsRepositoryImpl;Ljava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveSportsRepositoryImpl;->toSportList$lambda-2(Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveSportsRepositoryImpl;Ljava/util/List;)Lg90/z;
...
.method private final toSportList(Lg90/v;)Lg90/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final toSportList$lambda-2(Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveSportsRepositoryImpl;Ljava/util/List;)Lg90/z;
    .locals 2
...
.method public getCachedData()Lg90/o;
    ...
    invoke-virtual {v0}, Lorg/xbet/data/betting/feed/linelive/datasouces/SportsLocalDataSource;->getCachedData()Lg90/o;
...
.method public getExhibitionStreamedSports(ZLorg/xbet/domain/betting/feed/linelive/models/LineLiveScreenType;Ljava/lang/String;IIZILjava/util/Set;Z)Lg90/v;
    .locals 12
    ...
    .line 3
    invoke-virtual {v1, v2}, Lorg/xbet/data/betting/feed/linelive/datasouces/SportsLiveRemoteDataSource;->getSports(Ljava/util/Map;)Lg90/v;

    move-result-object v1

    .line 4
    invoke-virtual {p0, v1}, Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveSportsRepositoryImpl;->extractJsonValue(Lg90/v;)Lg90/v;
    ...
    invoke-virtual {p0, v1, v3, v2}, Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveSportsRepositoryImpl;->toSportZipList(Lg90/v;ZLorg/xbet/data/betting/feed/linelive/mappers/SportsZipMapper;)Lg90/v;

    move-result-object v1

    .line 6
    invoke-direct {p0, v1}, Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveSportsRepositoryImpl;->addExhibitionItem(Lg90/v;)Lg90/v;

    move-result-object v1

    .line 7
    invoke-direct {p0, v1}, Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveSportsRepositoryImpl;->toSportList(Lg90/v;)Lg90/v;
...
.method public getLineSports(Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;Ljava/lang/String;IIZILjava/util/Set;)Lg90/v;
    .locals 10
    ...
    invoke-virtual/range {v2 .. v9}, Lorg/xbet/data/betting/feed/linelive/mappers/SportsApiParamsMapper;->getLineParams(Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;Ljava/lang/String;IIZILjava/util/Set;)Ljava/util/Map;

    move-result-object v2

    .line 3
    invoke-virtual {v1, v2}, Lorg/xbet/data/betting/feed/linelive/datasouces/SportsLineRemoteDataSource;->getSports(Ljava/util/Map;)Lg90/v;
...
.method public getLiveSports(ZLorg/xbet/domain/betting/feed/linelive/models/LineLiveScreenType;Ljava/lang/String;IIZILjava/util/Set;Z)Lg90/v;
    .locals 12
    .param p2    # Lorg/xbet/domain/betting/feed/linelive/models/LineLiveScreenType;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation

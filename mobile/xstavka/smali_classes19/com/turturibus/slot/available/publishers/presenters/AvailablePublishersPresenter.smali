...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "router",
        "<init>",
        "(Ld20/h;JZLud/a;Lorg/xbet/ui_common/router/BaseOneXRouter;)V",
        "ui_slots_release"
    }
    k = 0x1
    mv = {
...
.method public constructor <init>(Ld20/h;JZLud/a;Lorg/xbet/ui_common/router/BaseOneXRouter;)V
    .locals 7
    .param p1    # Ld20/h;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;->e:Ld20/h;

    .line 3
    invoke-virtual {p5}, Lud/a;->b()I
...
.method public static synthetic d(Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;Ljava/lang/String;)Lg90/o;
    .locals 0

    invoke-direct {p0, p1}, Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;->g(Ljava/lang/String;)Lg90/o;
...
.method private static final e(Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;Ljava/util/List;)V
    ...
    invoke-interface {v0, v1}, Lcom/turturibus/slot/available/publishers/views/AvailablePublishersView;->Hd(Z)V
...
.method private final g(Ljava/lang/String;)Lg90/o;
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iget-object v1, v0, Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;->e:Ld20/h;

    iget v2, v0, Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;->f:I

    move-object/from16 v3, p1

    invoke-virtual {v1, v2, v3}, Ld20/h;->B(ILjava/lang/String;)Lg90/o;
...
.method private final h()V
    ...
    .line 1
    iget-object v0, p0, Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;->e:Ld20/h;

    iget v1, p0, Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;->f:I

    const-string v2, ""

    invoke-virtual {v0, v1, v2}, Ld20/h;->B(ILjava/lang/String;)Lg90/o;
    ...
    invoke-direct {v2, v1}, Lwc/c;-><init>(Lcom/turturibus/slot/available/publishers/views/AvailablePublishersView;)V

    new-instance v1, Lwc/a;

    invoke-direct {v1, p0}, Lwc/a;-><init>(Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;)V
...
.method public a()V
    ...
    invoke-direct {v1, p0}, Lwc/d;-><init>(Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;)V
    ...
    invoke-direct {v1, p0}, Lwc/b;-><init>(Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;)V

    .line 7
    new-instance v2, Lwc/a;

    invoke-direct {v2, p0}, Lwc/a;-><init>(Lcom/turturibus/slot/available/publishers/presenters/AvailablePublishersPresenter;)V

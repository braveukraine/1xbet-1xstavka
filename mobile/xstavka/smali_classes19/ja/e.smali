...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "required",
        "b",
        "(Lja/d;Landroid/content/Context;Ljava/lang/String;Ljava/lang/Boolean;)Ljava/lang/String;",
        "sns-core_release"
    }
    k = 0x2
    mv = {
...
# direct methods
.method public static final a(Lja/d;Ljava/lang/String;)Z
    .locals 3
    .param p0    # Lja/d;
    ...
    .line 2
    :cond_3
    instance-of v2, p0, Lja/d$a;

    if-eqz v2, :cond_4

    invoke-static {p1}, Lja/e;->c(Ljava/lang/String;)Z
    ...
    .line 3
    :cond_4
    instance-of v2, p0, Lja/d$b;

    if-eqz v2, :cond_6

    check-cast p0, Lja/d$b;

    invoke-virtual {p0}, Lja/d$b;->a()Loa0/f;
    ...
    invoke-virtual {p0, p1}, Loa0/f;->p(I)Z
    ...
    :goto_2
    check-cast p0, Lja/d$d;

    invoke-virtual {p0}, Lja/d$d;->a()I
    ...
    :goto_3
    check-cast p0, Lja/d$e;

    invoke-virtual {p0}, Lja/d$e;->a()I
    ...
    .line 9
    :cond_c
    instance-of v0, p0, Lja/d$g;

    if-eqz v0, :cond_d

    check-cast p0, Lja/d$g;

    invoke-virtual {p0}, Lja/d$g;->a()Ljava/lang/String;
...
.method public static final b(Lja/d;Landroid/content/Context;Ljava/lang/String;Ljava/lang/Boolean;)Ljava/lang/String;
    .locals 2
    .param p0    # Lja/d;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    ...
    .line 4
    :cond_3
    invoke-static {p0, p2}, Lja/e;->a(Lja/d;Ljava/lang/String;)Z

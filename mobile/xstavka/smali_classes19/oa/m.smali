...
# static fields
.field public static final b:Loa/m$a;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Loa/m$a;-><init>(Lkotlin/jvm/internal/h;)V

    sput-object v0, Loa/m;->b:Loa/m$a;
...
.method private final b(Landroid/graphics/RectF;Landroid/media/FaceDetector$Face;Loa/n$c;Loa/n$d;)Loa/n$a;
    .locals 7
    ...
    new-instance p1, Loa/n$a$c;

    invoke-direct {p1, p3}, Loa/n$a$c;-><init>(Loa/n$c;)V
    ...
    invoke-direct {p1, p3, p2}, Loa/n$a$d;-><init>(Loa/n$c;Landroid/graphics/RectF;)V
    ...
    invoke-direct {p1, p3, p4, p2}, Loa/n$a$b;-><init>(Loa/n$c;Loa/n$d;Landroid/graphics/RectF;)V
...
.method public a(Landroid/graphics/RectF;IIII[BLka0/l;)V
    ...
    invoke-virtual {p2, v6, p3}, Lcom/sumsub/sns/core/common/n;->a(Loa/n$c;I)Loa/n$b;
    ...
    .line 4
    invoke-virtual {p2}, Loa/n$b;->c()I

    move-result p4

    div-int/lit16 p4, p4, 0x200

    invoke-virtual {p2}, Loa/n$b;->a()I

    move-result p5

    div-int/lit16 p5, p5, 0x200

    invoke-static {p4, p5}, Loa0/g;->c(II)I
    ...
    .line 7
    iget-object p4, p0, Loa/m;->a:Landroid/media/FaceDetector;
    ...
    iput-object p4, p0, Loa/m;->a:Landroid/media/FaceDetector;
    ...
    .line 10
    new-instance p1, Loa/n$a$e;

    invoke-direct {p1, v6}, Loa/n$a$e;-><init>(Loa/n$c;)V
    ...
    invoke-direct {p3, p5, p2}, Loa/n$d;-><init>(II)V

    invoke-direct {p0, p1, p4, v6, p3}, Loa/m;->b(Landroid/graphics/RectF;Landroid/media/FaceDetector$Face;Loa/n$c;Loa/n$d;)Loa/n$a;
    ...
    invoke-direct {p1, v6}, Loa/n$a$c;-><init>(Loa/n$c;)V
    :try_end_0
    ...
    .line 17
    :goto_2
    invoke-interface {p7, p1}, Lka0/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public stop()V
    ...
    .line 1
    iput-object v0, p0, Loa/m;->a:Landroid/media/FaceDetector;

...
# direct methods
.method public static final a(Lpt/d;)Lpt/b;
    .locals 18
    .param p0    # Lpt/d;
    ...
    .line 1
    invoke-virtual/range {p0 .. p0}, Lpt/d;->a()I

    move-result v1

    .line 2
    invoke-virtual/range {p0 .. p0}, Lpt/d;->d()Lpt/e;
    ...
    .line 3
    invoke-virtual/range {p0 .. p0}, Lpt/d;->b()F

    move-result v4

    .line 4
    invoke-virtual/range {p0 .. p0}, Lpt/d;->e()F
    ...
    .line 7
    invoke-virtual/range {p0 .. p0}, Lpt/d;->c()Ljava/util/List;
    ...
    check-cast v0, Lpt/d$a;

    if-eqz v0, :cond_d

    invoke-virtual {v0}, Lpt/d$a;->a()Lpt/d$a$a;
    ...
    .line 8
    invoke-virtual {v0}, Lpt/d$a$a;->b()Ljava/util/List;
    ...
    .line 9
    invoke-virtual {v0}, Lpt/d$a$a;->c()Ljava/util/List;
    ...
    invoke-static {v12, v13}, Loa0/g;->c(II)I
    ...
    .line 13
    check-cast v12, Lpt/d$a$a$b;

    .line 14
    invoke-virtual {v12}, Lpt/d$a$a$b;->a()I
    ...
    .line 15
    invoke-virtual {v12}, Lpt/d$a$a$b;->b()Ljava/util/List;
    ...
    .line 20
    :cond_2
    invoke-virtual {v0}, Lpt/d$a$a;->d()Ljava/util/List;
    ...
    .line 23
    check-cast v13, Lpt/d$a$a$c;

    .line 24
    invoke-virtual {v13}, Lpt/d$a$a$c;->a()Ljava/util/List;
    ...
    invoke-direct {v11, v10, v13}, Lca0/m;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 29
    :cond_5
    invoke-virtual {v0}, Lpt/d$a$a;->a()Ljava/util/List;
    ...
    .line 33
    check-cast v10, Lpt/d$a$a$a;

    .line 34
    invoke-virtual {v10}, Lpt/d$a$a$a;->b()Lpt/a;
    ...
    .line 35
    invoke-virtual {v10}, Lpt/d$a$a$a;->a()Ljava/util/List;
    ...
    .line 37
    :cond_8
    new-instance v10, Lpt/b$a;

    invoke-direct {v10, v11, v2, v14, v12}, Lpt/b$a;-><init>(Ljava/util/Map;Ljava/util/List;Ljava/util/Map;Ljava/util/List;)V

    .line 38
    new-instance v11, Lpt/b;

    move-object v0, v11

    move-object v2, v10

    invoke-direct/range {v0 .. v9}, Lpt/b;-><init>(ILpt/b$a;Lpt/e;FFJD)V

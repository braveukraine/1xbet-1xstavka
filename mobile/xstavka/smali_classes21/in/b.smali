...
.method public constructor <init>(Lxm/b;Lej/b;)V
    ...
    .line 2
    iput-object p2, p0, Lin/b;->a:Lej/b;

    .line 3
    new-instance p2, Lin/b$a;

    invoke-direct {p2, p1}, Lin/b$a;-><init>(Lxm/b;)V

    iput-object p2, p0, Lin/b;->b:Lka0/a;
...
.method public final a(Ljava/lang/String;Ljava/util/List;JLorg/xbet/core/data/GameBonus;)Lg90/v;
    ...
    .line 1
    iget-object v1, v0, Lin/b;->b:Lka0/a;
    ...
    .line 2
    iget-object v2, v0, Lin/b;->a:Lej/b;
    ...
    invoke-direct/range {v3 .. v11}, Lgn/g;-><init>(Ljava/util/List;JLorg/xbet/core/data/LuckyWheelBonusType;JLjava/lang/String;I)V

    move-object v3, p1

    invoke-interface {v1, p1, v2}, Lcom/xbet/onexgames/features/baccarat/services/BaccaratApiService;->startPlay(Ljava/lang/String;Lgn/g;)Lg90/v;

    move-result-object v1

    sget-object v2, Lin/a;->a:Lin/a;

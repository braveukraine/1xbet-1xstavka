...
.method public constructor <init>(Lxm/b;Lej/b;Lf50/b;)V
    ...
    .line 2
    iput-object p2, p0, Lty/b;->a:Lej/b;

    .line 3
    iput-object p3, p0, Lty/b;->b:Lf50/b;

    .line 4
    new-instance p2, Lty/b$a;

    invoke-direct {p2, p1}, Lty/b$a;-><init>(Lxm/b;)V

    iput-object p2, p0, Lty/b;->c:Lka0/a;
...
# virtual methods
.method public final a(Ljava/lang/String;FJLorg/xbet/core/data/GameBonus;Ljava/util/List;)Lg90/v;
    .locals 14
    ...
    .line 1
    iget-object v1, v0, Lty/b;->c:Lka0/a;
    ...
    .line 4
    iget-object v2, v0, Lty/b;->a:Lej/b;
    ...
    invoke-direct/range {v4 .. v13}, Lry/c;-><init>(Ljava/util/List;FJLorg/xbet/core/data/LuckyWheelBonusType;JLjava/lang/String;I)V

    move-object v3, p1

    .line 7
    invoke-interface {v1, p1, v2}, Lcom/xbet/onexgames/features/spinandwin/services/SpinAndWinApiService;->createGame(Ljava/lang/String;Lry/c;)Lg90/v;

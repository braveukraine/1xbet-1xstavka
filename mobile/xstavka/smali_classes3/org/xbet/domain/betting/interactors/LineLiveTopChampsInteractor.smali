...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "appSettingsManager",
        "<init>",
        "(Lorg/xbet/domain/betting/repositories/TopLineLiveChampsRepository;Lcom/xbet/onexuser/domain/user/c;Ln50/g;Lr50/c;Lej/b;)V",
        "Companion",
        "betting_release"
    }
    k = 0x1
...
.method public constructor <init>(Lorg/xbet/domain/betting/repositories/TopLineLiveChampsRepository;Lcom/xbet/onexuser/domain/user/c;Ln50/g;Lr50/c;Lej/b;)V
    .locals 0
    ...
    .line 4
    iput-object p3, p0, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->profileInteractor:Ln50/g;

    .line 5
    iput-object p4, p0, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->geoInteractor:Lr50/c;

    .line 6
    iput-object p5, p0, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->appSettingsManager:Lej/b;
...
.method public static synthetic b(Lt30/a;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0}, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->getTopChamps$lambda-1$lambda-0(Lt30/a;)Ljava/lang/Integer;
...
.method public static synthetic c(ZLorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;Ljava/lang/Integer;)Lg90/r;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->getTopChamps$lambda-3(ZLorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;Ljava/lang/Integer;)Lg90/r;
...
.method public static synthetic d(Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;Ljava/lang/Boolean;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->getTopChamps$lambda-1(Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;Ljava/lang/Boolean;)Lg90/z;
...
.method public static synthetic e(ZLorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;Ljava/lang/Integer;Ljava/lang/Long;)Lg90/r;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->getTopChamps$lambda-3$lambda-2(ZLorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;Ljava/lang/Integer;Ljava/lang/Long;)Lg90/r;
...
.method private static final getTopChamps$lambda-1(Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;Ljava/lang/Boolean;)Lg90/z;
    .locals 2
    ...
    invoke-direct {p0}, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->getUserCountryId()Lg90/v;
    ...
    .line 2
    :cond_0
    iget-object p0, p0, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->geoInteractor:Lr50/c;
    ...
    invoke-static {p0, p1, v0, v1}, Lr50/c$a;->b(Lr50/c;ZILjava/lang/Object;)Lg90/v;
...
.method private static final getTopChamps$lambda-1$lambda-0(Lt30/a;)Ljava/lang/Integer;
    .locals 0
...
.method private static final getTopChamps$lambda-3(ZLorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;Ljava/lang/Integer;)Lg90/r;
    .locals 5
...
.method private static final getTopChamps$lambda-3$lambda-2(ZLorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;Ljava/lang/Integer;Ljava/lang/Long;)Lg90/r;
    .locals 0
    ...
    iget-object p1, p1, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->appSettingsManager:Lej/b;

    invoke-interface {p1}, Lej/b;->getLang()Ljava/lang/String;

    move-result-object p1

    invoke-interface {p0, p2, p1}, Lorg/xbet/domain/betting/repositories/TopLineLiveChampsRepository;->getLiveTopChamps(ILjava/lang/String;)Lg90/o;
    ...
    invoke-interface {p0, p2, p1}, Lorg/xbet/domain/betting/repositories/TopLineLiveChampsRepository;->getLineTopChamps(ILjava/lang/String;)Lg90/o;
...
.method private final getUserCountryId()Lg90/v;
    .locals 2
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/domain/betting/interactors/LineLiveTopChampsInteractor;->profileInteractor:Ln50/g;
...
# virtual methods
.method public final getCachedTopChamps(Z)Lg90/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
    ...
    invoke-interface {v0, p1}, Lorg/xbet/domain/betting/repositories/TopLineLiveChampsRepository;->getCachedTopChamps(Z)Lg90/v;
...
.method public final getTopChamps(Z)Lg90/o;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
...
.method public final updateFavorite(JZ)Lg90/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JZ)",
    ...
    invoke-interface {v0, p1, p2, p3}, Lorg/xbet/domain/betting/repositories/TopLineLiveChampsRepository;->updateFavorite(JZ)Lg90/v;

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "appSettingsManager",
        "<init>",
        "(Lorg/xbet/domain/betting/result/repositories/SportsResultsRepository;Lorg/xbet/domain/betting/result/repositories/ResultsFilterRepository;Lorg/xbet/domain/betting/repositories/SportRepository;Lej/b;)V",
        "betting_release"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Lorg/xbet/domain/betting/result/repositories/SportsResultsRepository;Lorg/xbet/domain/betting/result/repositories/ResultsFilterRepository;Lorg/xbet/domain/betting/repositories/SportRepository;Lej/b;)V
    .locals 0
    ...
    .line 5
    iput-object p4, p0, Lorg/xbet/domain/betting/result/interactors/SportsResultsInteractor;->appSettingsManager:Lej/b;

    return-void
.end method

.method public static synthetic a(Lorg/xbet/domain/betting/result/interactors/SportsResultsInteractor;Ljava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/domain/betting/result/interactors/SportsResultsInteractor;->getSportsLiveResults$lambda-0(Lorg/xbet/domain/betting/result/interactors/SportsResultsInteractor;Ljava/util/List;)Lg90/z;
...
.method private static final getSportsLiveResults$lambda-0(Lorg/xbet/domain/betting/result/interactors/SportsResultsInteractor;Ljava/util/List;)Lg90/z;
    .locals 7

    .line 1
    iget-object v0, p0, Lorg/xbet/domain/betting/result/interactors/SportsResultsInteractor;->appSettingsManager:Lej/b;
    ...
    .line 3
    iget-object v2, p0, Lorg/xbet/domain/betting/result/interactors/SportsResultsInteractor;->appSettingsManager:Lej/b;
    ...
    .line 4
    iget-object p0, p0, Lorg/xbet/domain/betting/result/interactors/SportsResultsInteractor;->appSettingsManager:Lej/b;

    invoke-interface {p0}, Lej/b;->getGroupId()I

    move-result p0

    .line 5
    invoke-interface {v0, p1, v1, v2, p0}, Lorg/xbet/domain/betting/result/repositories/SportsResultsRepository;->getSportsLiveResults(Ljava/util/List;ZII)Lg90/v;
    ...
    invoke-static/range {v0 .. v6}, Lorg/xbet/domain/betting/result/repositories/SportsResultsRepository$DefaultImpls;->getSportsLiveResults$default(Lorg/xbet/domain/betting/result/repositories/SportsResultsRepository;Ljava/util/List;ZIIILjava/lang/Object;)Lg90/v;
...
.method public final getSportsHistoryResults(Ljava/util/Date;)Lg90/v;
    .locals 8
    .param p1    # Ljava/util/Date;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 4
    iget-object p1, p0, Lorg/xbet/domain/betting/result/interactors/SportsResultsInteractor;->appSettingsManager:Lej/b;
    ...
    invoke-interface {p1}, Lej/b;->getRefId()I
    ...
    .line 7
    invoke-interface/range {v0 .. v7}, Lorg/xbet/domain/betting/result/repositories/SportsResultsRepository;->getSportsHistoryResults(JJLjava/lang/String;II)Lg90/v;
...
.method public final getSportsLiveResults()Lg90/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "appSettingsManager",
        "<init>",
        "(Lorg/xbet/domain/betting/result/repositories/GamesResultsRepository;Lorg/xbet/domain/betting/result/repositories/ResultsFilterRepository;Lej/b;)V",
        "betting_release"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Lorg/xbet/domain/betting/result/repositories/GamesResultsRepository;Lorg/xbet/domain/betting/result/repositories/ResultsFilterRepository;Lej/b;)V
    .locals 0
    ...
    .line 4
    iput-object p3, p0, Lorg/xbet/domain/betting/result/interactors/GamesResultsInteractor;->appSettingsManager:Lej/b;
...
.method public static synthetic b(Lorg/xbet/domain/betting/result/interactors/GamesResultsInteractor;Ljava/util/List;)Lg90/o;
    .locals 0

    invoke-direct {p0, p1}, Lorg/xbet/domain/betting/result/interactors/GamesResultsInteractor;->mapToExpandedList(Ljava/util/List;)Lg90/o;
...
.method public static synthetic c(JLjava/util/List;)Lg90/m;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/domain/betting/result/interactors/GamesResultsInteractor;->findGameWithId$lambda-4(JLjava/util/List;)Lg90/m;
...
.method private static final findGameWithId$lambda-4(JLjava/util/List;)Lg90/m;
    .locals 4
...
.method private final getCachedGamesHistoryResults()Lg90/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/result/repositories/GamesResultsRepository;->getCachedGamesHistoryResults()Lg90/o;

    move-result-object v0

    .line 2
    invoke-direct {p0, v0}, Lorg/xbet/domain/betting/result/interactors/GamesResultsInteractor;->withExpandableState(Lg90/o;)Lg90/o;
...
.method private final mapToExpandedList(Ljava/util/List;)Lg90/o;
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/result/repositories/GamesResultsRepository;->getExpandedGroupIds()Lg90/o;
...
.method private final withExpandableState(Lg90/o;)Lg90/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final getGamesHistoryResults(Ljava/util/Set;Ljava/util/Date;)Lg90/o;
    .locals 9
    ...
    .line 4
    iget-object p2, p0, Lorg/xbet/domain/betting/result/interactors/GamesResultsInteractor;->appSettingsManager:Lej/b;
    ...
    .line 7
    invoke-interface/range {v0 .. v8}, Lorg/xbet/domain/betting/result/repositories/GamesResultsRepository;->getGamesHistoryResults(Ljava/util/Set;JJLjava/lang/String;II)Lg90/v;
    ...
    .line 9
    invoke-direct {p0}, Lorg/xbet/domain/betting/result/interactors/GamesResultsInteractor;->getCachedGamesHistoryResults()Lg90/o;

    move-result-object p2

    invoke-virtual {p1, p2}, Lg90/b;->e(Lg90/r;)Lg90/o;

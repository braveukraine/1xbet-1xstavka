...
.method public static synthetic gamesIsFavorite$default(Lorg/xbet/domain/betting/feed/favorites/interactor/FavoriteGamesInteractor;Ljava/util/List;La50/b;ILjava/lang/Object;)Lg90/v;
    .locals 0
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p1, p2}, Lorg/xbet/domain/betting/feed/favorites/interactor/FavoriteGamesInteractor;->gamesIsFavorite(Ljava/util/List;La50/b;)Lg90/v;
...
.method public static synthetic getListFavoritesGames$default(Lorg/xbet/domain/betting/feed/favorites/interactor/FavoriteGamesInteractor;JZILjava/lang/Object;)Lg90/o;
    .locals 0
    ...
    .line 1
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lorg/xbet/domain/betting/feed/favorites/interactor/FavoriteGamesInteractor;->getListFavoritesGames(JZ)Lg90/o;
...
.method public final clearGames()Lg90/b;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/feed/favorites/FavoritesRepository;->clearGames()Lg90/b;
...
.method public final gamesIsFavorite(Ljava/util/List;La50/b;)Lg90/v;
    .locals 1
    ...
    invoke-interface {v0, p1, p2}, Lorg/xbet/domain/betting/feed/favorites/FavoritesRepository;->gamesIsFavorite(Ljava/util/List;La50/b;)Lg90/v;
...
.method public final getListFavoritesGames(JZ)Lg90/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JZ)",
    ...
    invoke-interface {v0, p1, p2, p3}, Lorg/xbet/domain/betting/feed/favorites/FavoritesRepository;->getFavoritesGames(JZ)Lg90/o;

    move-result-object p1

    sget-object p2, Lle0/m;->a:Lle0/m;
...
.method public final getListTopGames(I)Lg90/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    sget-object v1, La50/b;->Companion:La50/b$a;

    invoke-virtual {v1, p1}, La50/b$a;->a(I)La50/b;

    move-result-object p1

    const/4 v1, 0x1

    invoke-interface {v0, v1, p1}, Lorg/xbet/domain/betting/feed/favorites/providers/TopMatchesRepositoryProvider;->getTopCache(ZLa50/b;)Lg90/v;
    ...
    invoke-direct {v0, p0}, Lle0/k;-><init>(Lorg/xbet/domain/betting/feed/favorites/interactor/FavoriteGamesInteractor;)V

    invoke-virtual {p1, v0}, Lg90/v;->G(Lj90/l;)Lg90/v;

    move-result-object p1

    sget-object v0, Lle0/l;->a:Lle0/l;
...
.method public final getTopGames()Lg90/o;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lorg/xbet/domain/betting/feed/favorites/providers/TopMatchesRepositoryProvider$DefaultImpls;->getTopPeriodically$default(Lorg/xbet/domain/betting/feed/favorites/providers/TopMatchesRepositoryProvider;ZZILjava/lang/Object;)Lg90/o;

    move-result-object v0

    sget-object v1, Lle0/n;->a:Lle0/n;

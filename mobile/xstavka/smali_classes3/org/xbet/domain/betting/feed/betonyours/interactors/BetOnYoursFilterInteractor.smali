...
.method public static synthetic b(Lorg/xbet/domain/betting/feed/betonyours/interactors/BetOnYoursFilterInteractor;Ljava/util/List;)Lg90/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/domain/betting/feed/betonyours/interactors/BetOnYoursFilterInteractor;->getAccessibleCountries$lambda-2(Lorg/xbet/domain/betting/feed/betonyours/interactors/BetOnYoursFilterInteractor;Ljava/util/List;)Lg90/r;
...
.method private final filterByName(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v2, p2, v3}, Lkotlin/text/n;->N(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
...
.method private static final getAccessibleCountries$lambda-2(Lorg/xbet/domain/betting/feed/betonyours/interactors/BetOnYoursFilterInteractor;Ljava/util/List;)Lg90/r;
    .locals 4
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/feed/betonyours/repositories/BetOnYoursFilterRepository;->getCountryNameFilter()Lg90/o;
...
# virtual methods
.method public final getAccessibleCountries()Lg90/o;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/feed/betonyours/repositories/BetOnYoursFilterRepository;->getAllCountries()Lg90/v;
...
.method public final getFollowedCountries()Lg90/o;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/feed/betonyours/repositories/BetOnYoursFilterRepository;->getFollowedCountries()Lg90/o;
...
.method public getFollowedCountryIds()Lg90/o;
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/feed/betonyours/repositories/BetOnYoursFilterRepository;->getFollowedCountryIds()Lg90/o;

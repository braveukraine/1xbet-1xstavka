...
.method public static synthetic b(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;JLjava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;->getRelatedGames$lambda-1(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;JLjava/util/List;)Lg90/z;
...
.method public static synthetic c(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;Ljava/util/List;)Lg90/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;->subscribeBetEvents$lambda-4(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;Ljava/util/List;)Lg90/r;
...
.method public static synthetic d(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;Ljava/util/List;)Lg90/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;->getLineRelatedGames$lambda-2(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;Ljava/util/List;)Lg90/z;
...
.method public static synthetic e(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;JLjava/lang/Long;)Lg90/r;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;->getRelatedGames$lambda-0(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;JLjava/lang/Long;)Lg90/r;
...
.method private final getLineRelatedGames(J)Lg90/v;
    .locals 1
    ...
    invoke-interface {v0, p1, p2}, Lorg/xbet/domain/betting/sport_game/providers/BaseLineLiveRepositoryProvider;->games(J)Lg90/v;

    move-result-object p1

    .line 2
    new-instance p2, Lve0/g0;

    invoke-direct {p2, p0}, Lve0/g0;-><init>(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;)V
...
.method private static final getLineRelatedGames$lambda-2(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;Ljava/util/List;)Lg90/z;
    .locals 1
    ...
    .line 2
    invoke-direct {p0}, Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;->getLiveTopGames()Lg90/v;
...
.method private final getLiveTopGames()Lg90/v;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-static/range {v0 .. v5}, Lorg/xbet/domain/betting/sport_game/providers/TopMatchesRepositorySportGameProvider$DefaultImpls;->getGamesModel$default(Lorg/xbet/domain/betting/sport_game/providers/TopMatchesRepositorySportGameProvider;ZZLa50/b;ILjava/lang/Object;)Lg90/v;
...
.method private static final getRelatedGames$lambda-0(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;JLjava/lang/Long;)Lg90/r;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;->loadRelatedGames(J)Lg90/o;
...
.method private static final getRelatedGames$lambda-1(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;JLjava/util/List;)Lg90/z;
    .locals 1
    ...
    invoke-direct {p0, p1, p2}, Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;->getLineRelatedGames(J)Lg90/v;
...
.method private final loadRelatedGames(J)Lg90/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    invoke-interface {v0, p1, p2}, Lorg/xbet/domain/betting/sport_game/repositories/RelatedGamesRepository;->relatedGames(J)Lg90/v;

    move-result-object p1

    invoke-direct {p0, p1}, Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;->subscribeBetEvents(Lg90/v;)Lg90/o;
...
.method private final subscribeBetEvents(Lg90/v;)Lg90/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    new-instance v0, Lve0/f0;

    invoke-direct {v0, p0}, Lve0/f0;-><init>(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;)V
...
.method private static final subscribeBetEvents$lambda-4(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;Ljava/util/List;)Lg90/r;
    .locals 2
    ...
    .line 2
    new-instance v1, Lve0/j0;

    invoke-direct {v1, p0, p1}, Lve0/j0;-><init>(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;Ljava/util/List;)V
...
# virtual methods
.method public final getRelatedGames(J)Lg90/o;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    .line 2
    new-instance v1, Lve0/h0;

    invoke-direct {v1, p0, p1, p2}, Lve0/h0;-><init>(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;J)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lve0/i0;-><init>(Lorg/xbet/domain/betting/sport_game/interactors/SportGameRelatedInteractor;J)V

...
.method public final getExpandAllState(JJ)Lg90/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JJ)",
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lorg/xbet/domain/betting/sport_game/repositories/SportGameExpandedItemsRepository;->getExpandedItems(JJ)Lg90/o;

    move-result-object p1

    .line 2
    new-instance p2, Lve0/w;

    invoke-direct {p2, p0}, Lve0/w;-><init>(Lorg/xbet/domain/betting/sport_game/interactors/SportGameExpandedItemsInteractor;)V

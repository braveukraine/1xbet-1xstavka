...
.method public create(Lorg/xbet/registration/login/di/LoginDependencies;Lorg/xbet/registration/login/di/LoginModule;)Lorg/xbet/registration/login/di/LoginComponent;
    ...
    .line 3
    new-instance v0, Lorg/xbet/registration/login/di/DaggerLoginComponent;

    const/4 v1, 0x0

    invoke-direct {v0, p2, p1, v1}, Lorg/xbet/registration/login/di/DaggerLoginComponent;-><init>(Lorg/xbet/registration/login/di/LoginModule;Lorg/xbet/registration/login/di/LoginDependencies;Lorg/xbet/registration/login/di/b;)V

...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;->makeRegistration(ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;ZZZZZZZ)V
.end annotation
...
# direct methods
.method constructor <init>(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;ZZZZZZZ)V
    .locals 2
...
.method public static synthetic a(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;Ljava/lang/Throwable;)V
    .locals 0
...
.method public static synthetic b(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lx00/b;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter$makeRegistration$1;->invoke$lambda-0(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lx00/b;)V

    return-void
.end method

.method private static final invoke$lambda-0(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lx00/b;)V
    .locals 9
    ...
    .line 2
    invoke-static {p0}, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;->access$getRegistrationType$p(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;)Lt00/f;
    ...
    .line 3
    check-cast p4, Ly00/h;

    invoke-virtual {p4}, Ly00/h;->b()J

    move-result-wide v4

    .line 4
    invoke-virtual {p4}, Ly00/h;->a()Ljava/lang/String;
    ...
    .line 6
    :cond_0
    instance-of p1, p4, Ly00/a;

    if-eqz p1, :cond_2

    check-cast p4, Ly00/a;

    invoke-virtual {p4}, Ly00/a;->a()Ly00/b;

    move-result-object p1

    sget-object v0, Ly00/b;->EMAIL:Ly00/b;

    if-ne p1, v0, :cond_1

    .line 7
    invoke-static {p0}, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;->access$getRouter(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;)Lorg/xbet/ui_common/router/BaseOneXRouter;
    ...
    .line 10
    invoke-virtual {p4}, Ly00/a;->b()Ljava/lang/String;

    move-result-object v2

    .line 11
    invoke-virtual {p4}, Ly00/a;->c()Ljava/lang/String;
    ...
    .line 15
    invoke-static/range {v0 .. v8}, Lorg/xbet/ui_common/router/AppScreensProvider$DefaultImpls;->activationByEmailFragmentScreen$default(Lorg/xbet/ui_common/router/AppScreensProvider;Lk40/a;Ljava/lang/String;Ljava/lang/String;IJILjava/lang/Object;)Lcom/github/terrakok/cicerone/q;
    ...
    .line 25
    invoke-static/range {v0 .. v8}, Lorg/xbet/ui_common/router/AppScreensProvider$DefaultImpls;->registrationActivationFragmentScreen$default(Lorg/xbet/ui_common/router/AppScreensProvider;Lk40/a;Ljava/lang/String;Ljava/lang/String;IJILjava/lang/Object;)Lcom/github/terrakok/cicerone/q;
...
.method public final invoke(I)V
    ...
    .line 26
    invoke-static/range {v1 .. v27}, Lorg/xbet/registration/presenter/starter/registration/BaseRegistrationPresenter;->fillValuesList$default(Lorg/xbet/registration/presenter/starter/registration/BaseRegistrationPresenter;ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;ZZZZZZZLb10/a;ILjava/lang/Object;)Ljava/util/HashMap;
    ...
    invoke-static {v2}, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;->access$getRegistrationType$p(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;)Lt00/f;

    move-result-object v2

    sget-object v3, Lt00/f;->QUICK:Lt00/f;

    if-ne v2, v3, :cond_0

    .line 28
    sget-object v2, Lt00/b;->COUNTRY:Lt00/b;

    .line 29
    new-instance v3, Lu00/b;

    new-instance v11, Lt00/a;
    ...
    invoke-direct/range {v4 .. v10}, Lt00/a;-><init>(Lt00/b;ZZLt00/h;ILkotlin/jvm/internal/h;)V
    ...
    invoke-direct {v3, v11, v4}, Lu00/b;-><init>(Lt00/a;Ljava/lang/Object;)V
    ...
    .line 31
    invoke-static {v2}, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;->access$getUniversalRegistrationInteractor$p(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;)Lq00/x0;
    ...
    invoke-static {v4}, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;->access$getRegistrationType$p(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;)Lt00/f;
    ...
    .line 33
    invoke-virtual {v3, v4, v1, v5}, Lq00/y;->x(Lt00/f;Ljava/util/HashMap;I)Lg90/v;
    ...
    invoke-static {v1, v3}, Lorg/xbet/ui_common/utils/rx/RxExtension2Kt;->setStartTerminateWatcher(Lg90/v;Lka0/l;)Lg90/v;
    ...
    iget-object v4, v0, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter$makeRegistration$1;->$promoCode:Ljava/lang/String;

    iget-object v5, v0, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter$makeRegistration$1;->$phoneNumber:Ljava/lang/String;

    iget-object v6, v0, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter$makeRegistration$1;->$email:Ljava/lang/String;

    new-instance v7, Lorg/xbet/registration/presenter/starter/registration/h2;

    invoke-direct {v7, v3, v4, v5, v6}, Lorg/xbet/registration/presenter/starter/registration/h2;-><init>(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v3, v0, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter$makeRegistration$1;->this$0:Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;

    new-instance v4, Lorg/xbet/registration/presenter/starter/registration/g2;

    invoke-direct {v4, v3}, Lorg/xbet/registration/presenter/starter/registration/g2;-><init>(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;)V

    invoke-virtual {v1, v7, v4}, Lg90/v;->Q(Lj90/g;Lj90/g;)Li90/c;

    move-result-object v1

    .line 37
    invoke-static {v2, v1}, Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;->access$disposeOnDestroy(Lorg/xbet/registration/presenter/starter/registration/UniversalRegistrationPresenter;Li90/c;)V

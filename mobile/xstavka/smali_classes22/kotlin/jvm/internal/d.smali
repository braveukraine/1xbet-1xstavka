...
.field private transient reflected:Lpa0/b;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lkotlin/jvm/internal/d;->getReflected()Lpa0/b;

    move-result-object v0

    invoke-interface {v0, p1}, Lpa0/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Lpa0/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Lpa0/b;
    .locals 1

    .line 1
    iget-object v0, p0, Lkotlin/jvm/internal/d;->reflected:Lpa0/b;

    if-nez v0, :cond_0

    .line 2
    invoke-virtual {p0}, Lkotlin/jvm/internal/d;->computeReflected()Lpa0/b;

    move-result-object v0

    .line 3
    iput-object v0, p0, Lkotlin/jvm/internal/d;->reflected:Lpa0/b;

    :cond_0
    return-object v0
.end method

.method protected abstract computeReflected()Lpa0/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {v0}, Lpa0/a;->getAnnotations()Ljava/util/List;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Lpa0/b;->getParameters()Ljava/util/List;
...
.method protected getReflected()Lpa0/b;
    .locals 1

    .line 1
    invoke-virtual {p0}, Lkotlin/jvm/internal/d;->compute()Lpa0/b;
...
.method public getReturnType()Lpa0/l;
    .locals 1
    ...
    invoke-interface {v0}, Lpa0/b;->getReturnType()Lpa0/l;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Lpa0/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Lpa0/m;
    .locals 1
    ...
    invoke-interface {v0}, Lpa0/b;->getVisibility()Lpa0/m;
...
.method public isAbstract()Z
    ...
    invoke-interface {v0}, Lpa0/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {v0}, Lpa0/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {v0}, Lpa0/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {v0}, Lpa0/b;->isSuspend()Z

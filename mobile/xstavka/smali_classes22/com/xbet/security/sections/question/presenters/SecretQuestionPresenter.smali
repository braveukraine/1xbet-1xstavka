...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "router",
        "<init>",
        "(Lp50/h1;Lcom/xbet/onexuser/domain/managers/k0;Lorg/xbet/domain/security/interactors/SecretQuestionInteractor;Lorg/xbet/ui_common/router/BaseOneXRouter;)V",
        "security_release"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Lp50/h1;Lcom/xbet/onexuser/domain/managers/k0;Lorg/xbet/domain/security/interactors/SecretQuestionInteractor;Lorg/xbet/ui_common/router/BaseOneXRouter;)V
    .locals 7
    .param p1    # Lp50/h1;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;->a:Lp50/h1;
...
.method public static synthetic c(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;Li10/e;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;->n(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;Li10/e;)V
...
.method public static final synthetic e(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;)Lp50/h1;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;->a:Lp50/h1;
...
.method private static final g(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    check-cast v1, Lc40/e$a;

    .line 4
    new-instance v2, Lorg/xbet/domain/security/models/SecretQuestionItem;

    invoke-direct {v2, v1}, Lorg/xbet/domain/security/models/SecretQuestionItem;-><init>(Lc40/e$a;)V
...
.method private static final h(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;Ljava/util/List;)V
    ...
    const-string v1, "null cannot be cast to non-null type kotlin.collections.MutableList<org.xbet.domain.security.models.SecretQuestionItem>"
    ...
    invoke-interface {v0, p1}, Lcom/xbet/security/sections/question/views/SecretQuestionView;->E9(Ljava/util/List;)V
...
.method private static final l(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;ILjava/lang/String;Ljava/lang/String;Lorg/xbet/domain/security/models/TextCheckResult;)V
    ...
    invoke-interface {p0, p4}, Lcom/xbet/security/sections/question/views/SecretQuestionView;->Tg(Lorg/xbet/domain/security/models/TextCheckResult;)V
...
.method private final m(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 3
    new-instance p2, Lb70/i;

    invoke-direct {p2, p0}, Lb70/i;-><init>(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;)V

    .line 4
    new-instance p3, Lb70/j;

    invoke-direct {p3, p0}, Lb70/j;-><init>(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;)V
...
.method private static final n(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;Li10/e;)V
    .locals 1

    .line 1
    invoke-virtual {p1}, Li10/e;->getSuccess()Z
    ...
    :cond_0
    new-instance p0, Lorg/xbet/ui_common/exception/UIStringException;
    ...
    :cond_1
    invoke-direct {p0, p1}, Lorg/xbet/ui_common/exception/UIStringException;-><init>(Ljava/lang/String;)V
...
.method public f(Lcom/xbet/security/sections/question/views/SecretQuestionView;)V
    ...
    .line 2
    iget-object p1, p0, Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;->a:Lp50/h1;

    invoke-virtual {p1}, Lp50/h1;->e()Lg90/v;

    move-result-object p1

    sget-object v0, Lb70/m;->a:Lb70/m;
    ...
    invoke-direct {v0, p0}, Lb70/k;-><init>(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;)V

    .line 7
    new-instance v1, Lb70/j;

    invoke-direct {v1, p0}, Lb70/j;-><init>(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;)V
...
.method public final k(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, p1, p2}, Lorg/xbet/domain/security/interactors/SecretQuestionInteractor;->checkTextLength(ILjava/lang/String;Ljava/lang/String;)Lg90/v;
    ...
    invoke-direct {v2, p0, v0, p1, p2}, Lb70/l;-><init>(Lcom/xbet/security/sections/question/presenters/SecretQuestionPresenter;ILjava/lang/String;Ljava/lang/String;)V
...
.method public final p(Lorg/xbet/domain/security/models/SecretQuestionItem;)V
    ...
    invoke-interface {v0}, Lcom/xbet/security/sections/question/views/SecretQuestionView;->ib()V

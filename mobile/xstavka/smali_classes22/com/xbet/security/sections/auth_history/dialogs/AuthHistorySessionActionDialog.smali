...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->e:[Lpa0/i;
...
.method private constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)V
    ...
    .line 5
    invoke-direct {p0, v0}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->wh(Z)V

    move/from16 v0, p7

    .line 6
    invoke-direct {p0, v0}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->vh(Z)V
...
.method public static final synthetic D7(Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;)V
    .locals 0
...
.method public static synthetic G6(Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;Landroid/widget/Button;Landroid/widget/CompoundButton;Z)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->uf(Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;Landroid/widget/Button;Landroid/widget/CompoundButton;Z)V
...
.method private final Ke()Z
    ...
    sget-object v1, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->e:[Lpa0/i;
...
.method public static final synthetic Nb(Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;)V
    .locals 0
...
.method private final sd(Landroid/widget/Button;Z)V
    .locals 7

    .line 1
    invoke-direct {p0}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->Td()Z
    ...
    invoke-direct {p0, p2}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->xh(Z)I
...
.method private static final uf(Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;Landroid/widget/Button;Landroid/widget/CompoundButton;Z)V
    .locals 6

    xor-int/lit8 p2, p3, 0x1

    .line 1
    invoke-direct {p0, p1, p2}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->sd(Landroid/widget/Button;Z)V

    const-wide/16 v1, 0x0

    .line 2
    new-instance v3, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog$c;

    invoke-direct {v3, p3, p0}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog$c;-><init>(ZLcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;)V
...
.method private final xh(Z)I
    .locals 0

    if-eqz p1, :cond_0

    .line 1
    sget p1, La60/a;->primaryColor50New:I

    goto :goto_0

    :cond_0
    sget p1, La60/a;->primaryColorNew:I
...
.method protected initViews()V
    ...
    sget v1, La60/e;->btn_first_new:I
    ...
    .line 3
    new-instance v4, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog$b;

    invoke-direct {v4, p0}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog$b;-><init>(Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;)V
    ...
    .line 4
    invoke-direct {p0}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->Ke()Z
    ...
    .line 5
    invoke-direct {p0, v0, v1}, Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;->sd(Landroid/widget/Button;Z)V

    .line 6
    sget v1, La60/e;->check_box_group:I
    ...
    .line 7
    sget v1, La60/e;->check_box_confirm:I
    ...
    invoke-direct {v2, p0, v0}, Ln60/a;-><init>(Lcom/xbet/security/sections/auth_history/dialogs/AuthHistorySessionActionDialog;Landroid/widget/Button;)V
...
.method protected layoutResId()I
    ...
    .line 1
    sget v0, La60/f;->dialog_auth_history_session_action:I

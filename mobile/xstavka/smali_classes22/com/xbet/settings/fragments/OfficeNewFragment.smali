...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->c:Lca0/g;
    ...
    iput-object v0, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->d:Lca0/g;
    ...
    iput-object v0, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->f:Lca0/g;
...
.method private final Ah(Z)V
    ...
    .line 1
    sget v0, Lc70/d;->tv_toolbar_id_only:I
    ...
    .line 2
    sget v0, Lc70/d;->ll_toolbar_profile:I
...
.method private final Bh(Z)V
    ...
    .line 1
    :goto_0
    invoke-direct {p0, v0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Eh(I)V

    .line 2
    invoke-direct {p0, p1}, Lcom/xbet/settings/fragments/OfficeNewFragment;->xh(Z)V

    .line 3
    invoke-direct {p0, p1}, Lcom/xbet/settings/fragments/OfficeNewFragment;->yh(Z)V

    if-nez p1, :cond_1

    .line 4
    invoke-direct {p0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->zh()V
...
.method private final Ch(Z)V
    ...
    .line 1
    sget v0, Lc70/d;->tv_profile_id_only:I
    ...
    .line 2
    sget v0, Lc70/d;->ll_profile_info:I
    ...
    .line 3
    invoke-direct {p0, p1}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Ah(Z)V
...
.method private final Dh()V
    ...
    .line 1
    sget v0, Lc70/d;->img_profile_background:I
...
.method private final Eh(I)V
    ...
    invoke-direct {v1, p0, p1}, Ll70/c;-><init>(Lcom/xbet/settings/fragments/OfficeNewFragment;I)V
...
.method private static final Fh(Lcom/xbet/settings/fragments/OfficeNewFragment;ILcom/google/android/material/appbar/AppBarLayout;I)V
    .locals 7
    ...
    .line 3
    sget p1, Lc70/d;->cl_need_auth_container:I
    ...
    .line 4
    :cond_3
    sget p1, Lc70/d;->cl_info_container:I
    ...
    .line 5
    :goto_2
    sget p1, Lc70/d;->iv_profile_preview:I
    ...
    .line 8
    :cond_8
    sget p1, Lc70/d;->shimmer_info_container:I
    ...
    .line 9
    :goto_6
    sget p1, Lc70/d;->iv_shimmer_profile_preview:I
    ...
    .line 14
    :goto_c
    sget p1, Lc70/d;->tabs_corners_bg:I
...
.method private final Gh()I
    ...
    .line 1
    iget-object v0, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->f:Lca0/g;
...
.method private final Jh()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->d:Lca0/g;
...
.method public static synthetic Ke(Lcom/xbet/settings/fragments/OfficeNewFragment;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Lh(Lcom/xbet/settings/fragments/OfficeNewFragment;Landroid/view/View;)V

    return-void
.end method

.method private static final Kh(Lcom/xbet/settings/fragments/OfficeNewFragment;Landroid/view/View;)V
    .locals 0

    .line 1
    invoke-virtual {p0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Ih()Lcom/xbet/settings/presenters/OfficeNewPresenter;
...
.method private static final Lh(Lcom/xbet/settings/fragments/OfficeNewFragment;Landroid/view/View;)V
    .locals 0
...
.method private final Mh(Z)V
    ...
    new-instance v1, Ll70/e;

    invoke-direct {v1, p0, p1}, Ll70/e;-><init>(Lcom/xbet/settings/fragments/OfficeNewFragment;Z)V
...
.method public static synthetic Nb(Lcom/xbet/settings/fragments/OfficeNewFragment;Ljava/util/List;Lcom/google/android/material/tabs/TabLayout$Tab;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Ph(Lcom/xbet/settings/fragments/OfficeNewFragment;Ljava/util/List;Lcom/google/android/material/tabs/TabLayout$Tab;I)V

    return-void
.end method

.method private static final Nh(Lcom/xbet/settings/fragments/OfficeNewFragment;Z)V
    .locals 5
...
.method private static final Ph(Lcom/xbet/settings/fragments/OfficeNewFragment;Ljava/util/List;Lcom/google/android/material/tabs/TabLayout$Tab;I)V
    .locals 0
...
.method public static synthetic Td(Lcom/xbet/settings/fragments/OfficeNewFragment;Z)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Nh(Lcom/xbet/settings/fragments/OfficeNewFragment;Z)V
...
.method private final getFromTipsSection()Z
    ...
    .line 1
    iget-object v0, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->c:Lca0/g;
...
.method private final initSystemBars()V
    ...
    sget v3, Lc70/a;->darkBackgroundNew:I
...
.method public static synthetic sd(Lcom/xbet/settings/fragments/OfficeNewFragment;ILcom/google/android/material/appbar/AppBarLayout;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Fh(Lcom/xbet/settings/fragments/OfficeNewFragment;ILcom/google/android/material/appbar/AppBarLayout;I)V
...
.method private final stopShimmer()V
    ...
    .line 1
    sget v0, Lc70/d;->shimmer_info_container:I
    ...
    .line 2
    :cond_0
    sget v0, Lc70/d;->shimmer_toolbar_info_container:I
...
.method public static synthetic uf(Lcom/xbet/settings/fragments/OfficeNewFragment;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Kh(Lcom/xbet/settings/fragments/OfficeNewFragment;Landroid/view/View;)V

    return-void
.end method

.method public static final synthetic vh(Lcom/xbet/settings/fragments/OfficeNewFragment;)Ljava/util/List;
    .locals 0
...
.method public static final synthetic wh(Lcom/xbet/settings/fragments/OfficeNewFragment;Z)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Mh(Z)V

    return-void
.end method

.method private final xh(Z)V
    .locals 7
    ...
    .line 4
    invoke-direct/range {v1 .. v6}, Lorg/xbet/ui_common/viewcomponents/viewpager/ViewPager2OnPageChangeCallback;-><init>(Lka0/l;Lka0/q;Lka0/l;ILkotlin/jvm/internal/h;)V
...
.method private final yh(Z)V
    ...
    .line 2
    sget v0, Lc70/d;->cl_need_auth_container:I
    ...
    .line 3
    sget v0, Lc70/d;->cl_info_container:I
    ...
    .line 4
    sget p1, Lc70/d;->tv_nav_to_login:I
    ...
    new-instance v3, Lcom/xbet/settings/fragments/OfficeNewFragment$c;

    invoke-direct {v3, p0}, Lcom/xbet/settings/fragments/OfficeNewFragment$c;-><init>(Lcom/xbet/settings/fragments/OfficeNewFragment;)V
...
.method private final zh()V
    ...
    .line 1
    sget v0, Lc70/d;->cl_user_short_info:I
    ...
    new-instance v4, Lcom/xbet/settings/fragments/OfficeNewFragment$d;

    invoke-direct {v4, p0}, Lcom/xbet/settings/fragments/OfficeNewFragment$d;-><init>(Lcom/xbet/settings/fragments/OfficeNewFragment;)V
    ...
    .line 2
    sget v0, Lc70/d;->iv_profile_preview:I
    ...
    new-instance v4, Lcom/xbet/settings/fragments/OfficeNewFragment$e;

    invoke-direct {v4, p0}, Lcom/xbet/settings/fragments/OfficeNewFragment$e;-><init>(Lcom/xbet/settings/fragments/OfficeNewFragment;)V
...
# virtual methods
.method public final Hh()Lk70/a$a;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    .line 1
    iget-object v0, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->a:Lk70/a$a;
...
.method public final Ih()Lcom/xbet/settings/presenters/OfficeNewPresenter;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public Ka()V
    ...
    .line 1
    invoke-direct {p0, v0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Bh(Z)V

    .line 2
    invoke-direct {p0, v0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Ah(Z)V
...
.method public final Oh()Lcom/xbet/settings/presenters/OfficeNewPresenter;
    .locals 2
    ...
    .line 1
    invoke-virtual {p0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Hh()Lk70/a$a;
...
.method public Y1(Lcom/xbet/onexuser/domain/entity/j;)V
    .locals 5
    ...
    .line 2
    invoke-direct {p0, v0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Ch(Z)V
...
.method public g1(Lcom/xbet/onexuser/domain/entity/j;)V
    .locals 6
    .param p1    # Lcom/xbet/onexuser/domain/entity/j;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 3
    sget v0, Lc70/d;->tv_toolbar_profile_name:I
    ...
    .line 4
    sget v0, Lc70/d;->tv_toolbar_profile_id:I
    ...
    .line 5
    sget v0, Lc70/d;->tv_profile_name:I
    ...
    .line 6
    sget v0, Lc70/d;->tv_profile_id:I
...
.method public i()V
    ...
    .line 2
    sget v0, Lc70/d;->ll_toolbar_info_container:I
...
.method protected initViews()V
    ...
    invoke-direct {v1, p0}, Ll70/b;-><init>(Lcom/xbet/settings/fragments/OfficeNewFragment;)V

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/Toolbar;->setNavigationOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 4
    sget v0, Lc70/d;->fake_toolbar:I
    ...
    sget v2, Lc70/f;->personal_area:I
    ...
    invoke-direct {v1, p0}, Ll70/a;-><init>(Lcom/xbet/settings/fragments/OfficeNewFragment;)V

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/Toolbar;->setNavigationOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 6
    sget v0, Lc70/d;->tabs:I
    ...
    .line 7
    invoke-direct {p0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Dh()V
    ...
    invoke-direct {v0, v1, v2, v3}, Ld70/a;-><init>(Landroidx/fragment/app/FragmentManager;Landroidx/lifecycle/r;Z)V

    iput-object v0, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->e:Ld70/a;

    .line 9
    sget v0, Lc70/d;->viewpager:I
    ...
    iget-object v1, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->e:Ld70/a;
...
.method protected inject()V
    ...
    const-string v1, "null cannot be cast to non-null type com.xbet.settings.di.SettingsComponentProvider"
    ...
    .line 2
    invoke-interface {v0}, Lk70/g;->settingsComponent()Lk70/c;
    ...
    invoke-direct {p0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Gh()I

    move-result v3

    invoke-direct {p0}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Jh()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v1, v2, v3, v4}, Lk70/h;-><init>(ZILjava/lang/String;)V

    invoke-interface {v0, v1}, Lk70/c;->inject(Lk70/h;)Lk70/a;

    move-result-object v0

    .line 4
    invoke-interface {v0, p0}, Lk70/a;->inject(Lcom/xbet/settings/fragments/OfficeNewFragment;)V
...
.method public k3(Ljava/util/List;I)V
    ...
    .line 2
    iget-object v0, p0, Lcom/xbet/settings/fragments/OfficeNewFragment;->e:Ld70/a;
    ...
    invoke-direct {v5, p0, p1}, Ll70/d;-><init>(Lcom/xbet/settings/fragments/OfficeNewFragment;Ljava/util/List;)V
    ...
    :goto_0
    invoke-virtual {v1, p2}, Ld70/a;->a(I)I
...
.method public l()V
    ...
    .line 5
    :cond_1
    invoke-direct {p0, v1}, Lcom/xbet/settings/fragments/OfficeNewFragment;->Eh(I)V
...
.method protected layoutResId()I
    ...
    .line 1
    sget v0, Lc70/e;->fragment_office_new:I

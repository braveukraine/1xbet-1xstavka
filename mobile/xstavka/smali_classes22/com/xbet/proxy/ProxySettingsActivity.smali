...
.method public constructor <init>()V
    ...
    .line 3
    iput-object v0, p0, Lcom/xbet/proxy/ProxySettingsActivity;->c:Lca0/g;

    return-void
.end method

.method public static synthetic Ah(Ljava/lang/CharSequence;IILandroid/text/Spanned;II)Ljava/lang/CharSequence;
    .locals 0

    invoke-static/range {p0 .. p5}, Lcom/xbet/proxy/ProxySettingsActivity;->Uh(Ljava/lang/CharSequence;IILandroid/text/Spanned;II)Ljava/lang/CharSequence;
...
.method public static synthetic Bh(Lcom/xbet/proxy/ProxySettingsActivity;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/proxy/ProxySettingsActivity;->Th(Lcom/xbet/proxy/ProxySettingsActivity;Landroid/view/View;)V

    return-void
.end method

.method public static final synthetic Ch(Lcom/xbet/proxy/ProxySettingsActivity;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Hh()V

    return-void
.end method

.method public static final synthetic Dh(Lcom/xbet/proxy/ProxySettingsActivity;)V
    .locals 0
...
.method public static final synthetic Eh(Lcom/xbet/proxy/ProxySettingsActivity;Z)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/xbet/proxy/ProxySettingsActivity;->Oh(Z)V

    return-void
.end method

.method public static final synthetic Fh(Lcom/xbet/proxy/ProxySettingsActivity;Lcom/xbet/proxy/e;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/xbet/proxy/ProxySettingsActivity;->Ph(Lcom/xbet/proxy/e;)V

    return-void
.end method

.method public static final synthetic Gh(Lcom/xbet/proxy/ProxySettingsActivity;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Wh()V
...
.method private final Hh()V
    ...
    .line 1
    invoke-direct {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Jh()Ly50/a;

    move-result-object v0

    iget-object v0, v0, Ly50/a;->e:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    iget-object v0, v0, Ly50/a;->j:Lcom/google/android/material/switchmaterial/SwitchMaterial;
    ...
    iget-object v3, v3, Ly50/a;->d:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    iget-object v3, v3, Ly50/a;->j:Lcom/google/android/material/switchmaterial/SwitchMaterial;
    ...
    iget-object v0, v0, Ly50/a;->d:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    .line 7
    :goto_2
    invoke-virtual {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Kh()Lcom/xbet/proxy/j;
    ...
    .line 9
    sget-object v5, Lzi/i;->HTTP:Lzi/i;
    ...
    iget-object v0, v0, Ly50/a;->f:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    iget-object v0, v0, Ly50/a;->c:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    .line 13
    invoke-virtual/range {v3 .. v9}, Lcom/xbet/proxy/j;->k(ZLzi/i;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
...
.method private final Ih(Z)V
    ...
    iget-object v0, v0, Ly50/a;->g:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
    ...
    invoke-virtual {v0, p0, v3, v2}, Lorg/xbet/ui_common/utils/AndroidUtilities;->hideKeyboard(Landroid/content/Context;Landroid/view/View;I)V
    ...
    iget-object v0, v0, Ly50/a;->m:Landroid/view/View;
    ...
    iget-object v1, v1, Ly50/a;->e:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    iget-object v1, v1, Ly50/a;->d:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    iget-object v2, v2, Ly50/a;->f:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    iget-object v2, v2, Ly50/a;->c:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
...
.method private final Jh()Ly50/a;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/xbet/proxy/ProxySettingsActivity;->c:Lca0/g;
...
.method private final Mh()V
    ...
    invoke-static {p0, v1, v0}, Lorg/xbet/ui_common/utils/ExtensionsKt;->onDialogResultOkListener(Landroidx/appcompat/app/AppCompatActivity;Ljava/lang/String;Lka0/a;)V
    ...
    invoke-static {p0, v1, v0}, Lorg/xbet/ui_common/utils/ExtensionsKt;->onDialogResultNeutralListener(Landroidx/appcompat/app/AppCompatActivity;Ljava/lang/String;Lka0/a;)V
...
.method private final Oh(Z)V
    ...
    invoke-virtual {p1, v1}, Lcom/xbet/proxy/ProxyCheckingWaitDialog$a;->a(Lka0/a;)Lcom/xbet/proxy/ProxyCheckingWaitDialog;
...
.method private final Ph(Lcom/xbet/proxy/e;)V
    .locals 3
    ...
    .line 2
    iget-object v1, v0, Ly50/a;->j:Lcom/google/android/material/switchmaterial/SwitchMaterial;
    ...
    .line 3
    iget-object v1, v0, Ly50/a;->e:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    .line 4
    iget-object v1, v0, Ly50/a;->d:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    .line 5
    iget-object v1, v0, Ly50/a;->f:Lorg/xbet/ui_common/viewcomponents/layouts/linear/TextInputEditTextNew;
    ...
    invoke-direct {p0, p1}, Lcom/xbet/proxy/ProxySettingsActivity;->Ih(Z)V
...
.method private final Rh()V
    ...
    invoke-virtual {v0}, Lcom/xbet/proxy/j;->getState()Lkotlinx/coroutines/flow/s;
    ...
    invoke-static {v0, v1}, Lkotlinx/coroutines/flow/h;->k(Lkotlinx/coroutines/flow/f;Lka0/p;)Lkotlinx/coroutines/flow/f;
    ...
    invoke-static {v0, v1}, Lkotlinx/coroutines/flow/h;->j(Lkotlinx/coroutines/flow/f;Lkotlinx/coroutines/l0;)Lkotlinx/coroutines/v1;
...
.method private final Sh()V
    ...
    iget-object v0, v0, Ly50/a;->k:Lcom/google/android/material/appbar/MaterialToolbar;
    ...
    .line 9
    sget-object v2, Lcom/xbet/proxy/a;->a:Lcom/xbet/proxy/a;
    ...
    .line 11
    invoke-direct {p0, v3}, Lcom/xbet/proxy/ProxySettingsActivity;->Ih(Z)V
    ...
    new-instance v1, Lcom/xbet/proxy/c;

    invoke-direct {v1, p0}, Lcom/xbet/proxy/c;-><init>(Lcom/xbet/proxy/ProxySettingsActivity;)V
    ...
    iget-object v0, v0, Ly50/a;->l:Landroid/widget/TextView;

    invoke-direct {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Jh()Ly50/a;

    move-result-object v1

    iget-object v1, v1, Ly50/a;->j:Lcom/google/android/material/switchmaterial/SwitchMaterial;

    invoke-static {v0, v1}, Lorg/xbet/ui_common/utils/ViewExtensionsKt;->changeSwitchState(Landroid/view/View;Landroidx/appcompat/widget/SwitchCompat;)V
    ...
    iget-object v1, v0, Ly50/a;->g:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;

    const-wide/16 v2, 0x0

    new-instance v4, Lcom/xbet/proxy/ProxySettingsActivity$f;

    invoke-direct {v4, p0}, Lcom/xbet/proxy/ProxySettingsActivity$f;-><init>(Lcom/xbet/proxy/ProxySettingsActivity;)V
...
.method private static final Th(Lcom/xbet/proxy/ProxySettingsActivity;Landroid/view/View;)V
    .locals 0
...
.method private static final Uh(Ljava/lang/CharSequence;IILandroid/text/Spanned;II)Ljava/lang/CharSequence;
    .locals 1
...
.method private static final Vh(Lcom/xbet/proxy/ProxySettingsActivity;Landroid/widget/CompoundButton;Z)V
    .locals 0

    .line 1
    invoke-direct {p0, p2}, Lcom/xbet/proxy/ProxySettingsActivity;->Ih(Z)V
...
.method public static synthetic zh(Lcom/xbet/proxy/ProxySettingsActivity;Landroid/widget/CompoundButton;Z)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xbet/proxy/ProxySettingsActivity;->Vh(Lcom/xbet/proxy/ProxySettingsActivity;Landroid/widget/CompoundButton;Z)V
...
# virtual methods
.method public final Kh()Lcom/xbet/proxy/j;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public final Lh()Landroidx/lifecycle/u0$b;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public final Qh(Lcom/xbet/proxy/j;)V
    .locals 0
...
.method public inject()V
    ...
    const-string v1, "null cannot be cast to non-null type com.xbet.proxy.di.ProxySettingsComponentProvider"
    ...
    .line 2
    invoke-interface {v0}, Lz50/b;->proxySettingsComponent()Lz50/a;

    move-result-object v0

    .line 3
    invoke-interface {v0, p0}, Lz50/a;->inject(Lcom/xbet/proxy/ProxySettingsActivity;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 2
    invoke-direct {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Nh()V
    ...
    invoke-virtual {p1}, Ly50/a;->b()Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Lh()Landroidx/lifecycle/u0$b;
    ...
    invoke-virtual {p0, p1}, Lcom/xbet/proxy/ProxySettingsActivity;->Qh(Lcom/xbet/proxy/j;)V

    .line 5
    invoke-direct {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Sh()V

    .line 6
    invoke-direct {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Rh()V

    .line 7
    invoke-direct {p0}, Lcom/xbet/proxy/ProxySettingsActivity;->Mh()V

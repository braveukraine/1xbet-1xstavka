...
.method private writeBHT(Lcb0/d;ILorg/jmrtd/cbeff/SimpleCBEFFInfo;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-virtual {p1, p2}, Lcb0/d;->b(I)V
    ...
    invoke-virtual {p1, p3}, Lcb0/d;->d([B)V
...
.method private writeBIT(Lcb0/d;ILorg/jmrtd/cbeff/SimpleCBEFFInfo;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-direct {p0, p1, p2, p3}, Lorg/jmrtd/cbeff/ISO781611Encoder;->writeBHT(Lcb0/d;ILorg/jmrtd/cbeff/SimpleCBEFFInfo;)V
    ...
    invoke-direct {p0, p1, p2}, Lorg/jmrtd/cbeff/ISO781611Encoder;->writeBiometricDataBlock(Lcb0/d;Lorg/jmrtd/cbeff/BiometricDataBlock;)V
...
.method private writeBITGroup(Ljava/util/List;Ljava/io/OutputStream;)V
    ...
    .line 1
    instance-of v0, p2, Lcb0/d;

    if-eqz v0, :cond_0

    check-cast p2, Lcb0/d;
    ...
    invoke-direct {v0, p2}, Lcb0/d;-><init>(Ljava/io/OutputStream;)V
    ...
    .line 2
    invoke-virtual {p2, v0}, Lcb0/d;->b(I)V
    ...
    .line 5
    invoke-virtual {p2, v1}, Lcb0/d;->d([B)V
    ...
    .line 7
    invoke-direct {p0, p2, v3, v1}, Lorg/jmrtd/cbeff/ISO781611Encoder;->writeBIT(Lcb0/d;ILorg/jmrtd/cbeff/SimpleCBEFFInfo;)V
    ...
    .line 8
    :cond_1
    invoke-virtual {p2}, Lcb0/d;->e()V

    return-void
.end method

.method private writeBiometricDataBlock(Lcb0/d;Lorg/jmrtd/cbeff/BiometricDataBlock;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",

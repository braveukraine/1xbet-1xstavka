...
.method private final createNodesForFenceStart(Lorg/intellij/markdown/parser/LookaheadText$Position;Lca0/m;Lorg/intellij/markdown/parser/ProductionHolder;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v3, v2, v0}, Loa0/f;-><init>(II)V

    sget-object v2, Lorg/intellij/markdown/MarkdownTokenTypes;->CODE_FENCE_START:Lorg/intellij/markdown/IElementType;

    invoke-direct {v1, v3, v2}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;-><init>(Loa0/f;Lorg/intellij/markdown/IElementType;)V
    ...
    invoke-direct {v1, v0, p1}, Loa0/f;-><init>(II)V

    sget-object p1, Lorg/intellij/markdown/MarkdownTokenTypes;->FENCE_LANG:Lorg/intellij/markdown/IElementType;

    invoke-direct {p2, v1, p1}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;-><init>(Loa0/f;Lorg/intellij/markdown/IElementType;)V
...
.method private final getFenceStartAndInfo(Lorg/intellij/markdown/parser/LookaheadText$Position;Lorg/intellij/markdown/parser/constraints/MarkdownConstraints;)Lca0/m;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-direct {p2, v1, v0}, Lca0/m;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public createMarkerBlocks(Lorg/intellij/markdown/parser/LookaheadText$Position;Lorg/intellij/markdown/parser/ProductionHolder;Lorg/intellij/markdown/parser/MarkerProcessor$StateInfo;)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v0}, Lorg/intellij/markdown/parser/markerblocks/providers/CodeFenceProvider;->getFenceStartAndInfo(Lorg/intellij/markdown/parser/LookaheadText$Position;Lorg/intellij/markdown/parser/constraints/MarkdownConstraints;)Lca0/m;
    ...
    .line 2
    invoke-direct {p0, p1, v0, p2}, Lorg/intellij/markdown/parser/markerblocks/providers/CodeFenceProvider;->createNodesForFenceStart(Lorg/intellij/markdown/parser/LookaheadText$Position;Lca0/m;Lorg/intellij/markdown/parser/ProductionHolder;)V
...
.method public interruptsParagraph(Lorg/intellij/markdown/parser/LookaheadText$Position;Lorg/intellij/markdown/parser/constraints/MarkdownConstraints;)Z
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lorg/intellij/markdown/parser/markerblocks/providers/CodeFenceProvider;->getFenceStartAndInfo(Lorg/intellij/markdown/parser/LookaheadText$Position;Lorg/intellij/markdown/parser/constraints/MarkdownConstraints;)Lca0/m;

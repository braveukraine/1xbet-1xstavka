...
.method private final getDrawable(Landroid/content/Context;Lf6/b;)Landroid/graphics/drawable/Drawable;
    .locals 0

    .line 1
    invoke-direct {p0, p2}, Lorg/xbet/promotions/app_and_win/widgets/WheelBitmapFactory;->getDrawableResFromId(Lf6/b;)I
...
.method private final getDrawableResFromId(Lf6/b;)I
    .locals 1
    ...
    .line 2
    sget p1, Lij/f;->app_win_watches_icon:I

    goto :goto_0

    .line 3
    :cond_0
    sget p1, Lij/f;->app_win_free_bet_icon:I
    ...
    .line 5
    :cond_2
    sget p1, Lij/f;->app_win_bonus_icon:I

    goto :goto_0

    .line 6
    :cond_3
    sget p1, Lij/f;->app_win_lucky_wheel_icon:I

    goto :goto_0

    .line 7
    :cond_4
    sget p1, Lij/f;->app_win_ticket_icon:I
...
.method public final createBitmap(Landroid/content/Context;ILjava/util/List;)Landroid/graphics/Bitmap;
    ...
    .line 8
    invoke-static {v12, v2}, Loa0/g;->m(II)Loa0/f;
    ...
    .line 12
    sget v12, Lij/f;->app_win_wheel_sector:I
    ...
    invoke-direct {v11, v0, v3}, Lorg/xbet/promotions/app_and_win/widgets/WheelBitmapFactory;->getDrawable(Landroid/content/Context;Lf6/b;)Landroid/graphics/drawable/Drawable;

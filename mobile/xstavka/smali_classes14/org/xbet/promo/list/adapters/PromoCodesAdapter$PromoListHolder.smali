...
.field private final detailsAdapter$delegate:Lca0/g;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Lorg/xbet/promo/list/adapters/PromoCodesAdapter;Landroid/view/View;)V
    ...
    iput-object p1, p0, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->detailsAdapter$delegate:Lca0/g;
...
.method private final getConditions(Lz7/h;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1}, Lz7/e;->a()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1}, Lz7/e;->b()Ljava/lang/String;

    move-result-object v1

    invoke-direct {v2, v3, v1}, Lz7/f;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final getDateToUse(Lz7/h;)Ljava/lang/String;
    .locals 3
...
.method private final getDetails(Lz7/h;)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p1}, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->getConditions(Lz7/h;)Ljava/util/List;

    move-result-object v0

    .line 2
    invoke-direct {p0, p1}, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->getPromoCodeSum(Lz7/h;)Lz7/f;
    ...
    .line 3
    invoke-direct {p0, p1}, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->getStatusDetails(Lz7/h;)Lz7/f;
...
.method private final getDetailsAdapter()Lorg/xbet/promo/list/adapters/PromoCodeDetailsAdapter;
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->detailsAdapter$delegate:Lca0/g;
...
.method private final getPromoCodeSum(Lz7/h;)Lz7/f;
    .locals 9
    ...
    .line 4
    invoke-direct {v0, v1, p1}, Lz7/f;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    return-object v0
.end method

.method private final getStatusDetails(Lz7/h;)Lz7/f;
    .locals 2
    ...
    .line 5
    :cond_2
    invoke-direct {p0, p1}, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->getDateToUse(Lz7/h;)Ljava/lang/String;
    ...
    .line 6
    :cond_3
    invoke-direct {p0, p1}, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->getUsedDate(Lz7/h;)Ljava/lang/String;
...
.method private final getUsedDate(Lz7/h;)Ljava/lang/String;
    .locals 3
...
.method public bridge synthetic bind(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->bind(Lz7/h;)V

    return-void
.end method

.method public bind(Lz7/h;)V
    .locals 7
    .param p1    # Lz7/h;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    new-instance v4, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder$bind$1;

    iget-object v0, p0, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->this$0:Lorg/xbet/promo/list/adapters/PromoCodesAdapter;

    invoke-direct {v4, v0, p1}, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder$bind$1;-><init>(Lorg/xbet/promo/list/adapters/PromoCodesAdapter;Lz7/h;)V
    ...
    .line 6
    sget-object v1, Lz7/i;->Companion:Lz7/i$a;

    invoke-virtual {p1}, Lz7/h;->g()I

    move-result v2

    invoke-virtual {v1, v2}, Lz7/i$a;->a(I)Lz7/i;
    ...
    invoke-direct {p0, p1}, Lorg/xbet/promo/list/adapters/PromoCodesAdapter$PromoListHolder;->getDetails(Lz7/h;)Ljava/util/List;

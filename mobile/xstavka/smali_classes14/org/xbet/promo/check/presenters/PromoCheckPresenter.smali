...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "router",
        "<init>",
        "(Ly7/d;Lorg/xbet/promo/check/di/PromoCheckProvider;Lorg/xbet/ui_common/router/AppScreensProvider;Lcom/xbet/onexcore/utils/b;ZLorg/xbet/promo/check/models/GiftsInfo;Lorg/xbet/ui_common/router/BaseOneXRouter;)V",
        "Companion",
        "promo_release"
    }
    k = 0x1
...
.field private final interactor:Ly7/d;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Ly7/d;Lorg/xbet/promo/check/di/PromoCheckProvider;Lorg/xbet/ui_common/router/AppScreensProvider;Lcom/xbet/onexcore/utils/b;ZLorg/xbet/promo/check/models/GiftsInfo;Lorg/xbet/ui_common/router/BaseOneXRouter;)V
    .locals 0
    .param p1    # Ly7/d;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/promo/check/presenters/PromoCheckPresenter;->interactor:Ly7/d;
...
.method public static synthetic a(Lorg/xbet/promo/check/presenters/PromoCheckPresenter;Ljava/lang/String;Lz7/d;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/promo/check/presenters/PromoCheckPresenter;->usePromoCode$lambda-5(Lorg/xbet/promo/check/presenters/PromoCheckPresenter;Ljava/lang/String;Lz7/d;)V
...
.method public static synthetic c(Lorg/xbet/promo/check/presenters/PromoCheckPresenter;Lz7/h;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/promo/check/presenters/PromoCheckPresenter;->getPromoCode$lambda-1(Lorg/xbet/promo/check/presenters/PromoCheckPresenter;Lz7/h;)V
...
.method private final getCurrentPromoCodeDescriptionList(Lz7/h;)Ljava/util/List;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-virtual {p1}, Lz7/h;->h()Ljava/lang/String;

    move-result-object v4

    .line 5
    invoke-direct {v1, v3, v4}, Lz7/g;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 6
    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 7
    invoke-virtual {p1}, Lz7/h;->c()Ljava/util/List;
    ...
    invoke-virtual {v3}, Lz7/e;->a()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lz7/e;->b()Ljava/lang/String;

    move-result-object v3

    invoke-direct {v4, v5, v3}, Lz7/g;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lz7/h;->b()D

    move-result-wide v4

    invoke-virtual {p1}, Lz7/h;->a()Ljava/lang/String;
    ...
    .line 13
    invoke-direct {v1, v2, v3}, Lz7/g;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 17
    invoke-direct {p0, p1}, Lorg/xbet/promo/check/presenters/PromoCheckPresenter;->getStatusText(Lz7/h;)Ljava/lang/String;

    move-result-object p1

    .line 18
    invoke-direct {v1, v2, p1}, Lz7/g;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final getPromoCode(Ljava/lang/String;)V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/promo/check/presenters/PromoCheckPresenter;->interactor:Ly7/d;

    invoke-virtual {v0, p1}, Ly7/d;->e(Ljava/lang/String;)Lg90/v;
...
.method private static final getPromoCode$lambda-1(Lorg/xbet/promo/check/presenters/PromoCheckPresenter;Lz7/h;)V
    .locals 2
    ...
    .line 3
    invoke-direct {p0, p1}, Lorg/xbet/promo/check/presenters/PromoCheckPresenter;->getCurrentPromoCodeDescriptionList(Lz7/h;)Ljava/util/List;

    move-result-object p1

    .line 4
    invoke-direct {v0, v1, p1}, Lz7/a;-><init>(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-interface {p1, v0}, Lorg/xbet/promo/check/views/PromoCheckView;->enterDetailsState(Lz7/a;)V
...
.method private final getStatusText(Lz7/h;)Ljava/lang/String;
    .locals 11

    .line 1
    sget-object v0, Lz7/i;->Companion:Lz7/i$a;

    invoke-virtual {p1}, Lz7/h;->g()I

    move-result v1

    invoke-virtual {v0, v1}, Lz7/i$a;->a(I)Lz7/i;
    ...
    .line 5
    invoke-virtual {p1}, Lz7/h;->d()Ljava/lang/Long;
...
.method private final usePromoCode(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Ly7/d;->l(Ljava/lang/String;)Lg90/v;
...
.method private static final usePromoCode$lambda-5(Lorg/xbet/promo/check/presenters/PromoCheckPresenter;Ljava/lang/String;Lz7/d;)V
    .locals 1
    ...
    invoke-virtual {p2}, Lz7/d;->a()Ljava/lang/String;
...
.method public onActionButtonClick()V
    ...
    invoke-virtual {v2}, Lorg/xbet/promo/check/models/GiftsInfo;->getPartitionId()J

    move-result-wide v2

    .line 8
    iget-object v4, p0, Lorg/xbet/promo/check/presenters/PromoCheckPresenter;->giftsInfo:Lorg/xbet/promo/check/models/GiftsInfo;

    invoke-virtual {v4}, Lorg/xbet/promo/check/models/GiftsInfo;->getBonusesCount()I

    move-result v4

    .line 9
    iget-object v5, p0, Lorg/xbet/promo/check/presenters/PromoCheckPresenter;->giftsInfo:Lorg/xbet/promo/check/models/GiftsInfo;

    invoke-virtual {v5}, Lorg/xbet/promo/check/models/GiftsInfo;->getFreeSpinsCount()I

    move-result v5

    .line 10
    invoke-interface {v1, v2, v3, v4, v5}, Lorg/xbet/ui_common/router/AppScreensProvider;->casinoGiftsFragmentScreen(JII)Lcom/github/terrakok/cicerone/q;

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "prophylaxisStatus",
        "<init>",
        "(Lorg/xbet/starter/prophylaxis/repositories/ProphylaxisRepository;Ldj/a;)V",
        "starter"
    }
    k = 0x1
    mv = {
...
.field private final prophylaxisStatus:Ldj/a;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Lorg/xbet/starter/prophylaxis/repositories/ProphylaxisRepository;Ldj/a;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lorg/xbet/starter/prophylaxis/interactors/ProphylaxisInteractor;->prophylaxisStatus:Ldj/a;
...
.method private static final checkProphylaxis$lambda-0(Lorg/xbet/starter/prophylaxis/interactors/ProphylaxisInteractor;Lorg/xbet/starter/prophylaxis/models/Prophylaxis;)V
    ...
    .line 2
    iget-object p0, p0, Lorg/xbet/starter/prophylaxis/interactors/ProphylaxisInteractor;->prophylaxisStatus:Ldj/a;

    invoke-virtual {p1}, Lorg/xbet/starter/prophylaxis/models/Prophylaxis;->getHasProphylaxis()Z

    move-result p1

    invoke-interface {p0, p1}, Ldj/a;->saveProphylaxisStatus(Z)V
...
.method private static final getPushProphylaxisValue$lambda-1(Lorg/xbet/starter/prophylaxis/interactors/ProphylaxisInteractor;)Ljava/lang/Boolean;
    ...
    invoke-interface {p0}, Ldj/a;->getPushProphylaxisValue()Z
...
# virtual methods
.method public final checkProphylaxis(Z)Lg90/o;
    .locals 1
    ...
    invoke-interface {v0, p1}, Lorg/xbet/starter/prophylaxis/repositories/ProphylaxisRepository;->checkProphylaxis(Z)Lg90/o;
    ...
    invoke-direct {v0, p0}, Lqg0/a;-><init>(Lorg/xbet/starter/prophylaxis/interactors/ProphylaxisInteractor;)V
...
.method public final getFingerPrintScreenStatus()Lg90/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lorg/xbet/starter/prophylaxis/repositories/ProphylaxisRepository;->getFingerPrintScreenStatus()Lg90/o;
...
.method public final getPushProphylaxisValue()Lg90/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {v0, p0}, Lqg0/b;-><init>(Lorg/xbet/starter/prophylaxis/interactors/ProphylaxisInteractor;)V
...
.method public final saveProphylaxisValue(Z)V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/starter/prophylaxis/interactors/ProphylaxisInteractor;->prophylaxisStatus:Ldj/a;

    invoke-interface {v0, p1}, Ldj/a;->saveProphylaxisValue(Z)V

...
# direct methods
.method public constructor <init>(Le50/j$b;)V
    .locals 17
    .param p1    # Le50/j$b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 4
    invoke-virtual/range {p1 .. p1}, Le50/j$b;->b()Ljava/util/List;
    ...
    .line 7
    check-cast v3, Le50/j$b$b;

    if-eqz v3, :cond_7

    .line 8
    invoke-virtual {v3}, Le50/j$b$b;->f()I

    move-result v5

    .line 9
    invoke-virtual/range {p1 .. p1}, Le50/j$b;->c()Ljava/util/List;
    ...
    check-cast v8, Le50/j$b$c;

    if-eqz v8, :cond_1

    invoke-virtual {v8}, Le50/j$b$c;->b()I

    move-result v8

    invoke-virtual {v3}, Le50/j$b$b;->g()I
    ...
    :goto_2
    check-cast v6, Le50/j$b$c;

    if-eqz v6, :cond_6

    invoke-virtual {v6}, Le50/j$b$c;->a()Ljava/lang/String;
    ...
    .line 10
    invoke-virtual {v3}, Le50/j$b$b;->h()D
    ...
    .line 11
    invoke-virtual {v3}, Le50/j$b$b;->e()Le50/j$a;
    ...
    invoke-virtual {v3}, Le50/j$b$b;->d()Z

    move-result v11

    invoke-virtual {v4, v6, v11}, Lf50/c$a;->a(IZ)Lf50/c;

    move-result-object v11

    .line 13
    invoke-virtual {v3}, Le50/j$b$b;->j()Z

    move-result v12

    .line 14
    invoke-virtual {v3}, Le50/j$b$b;->a()Ljava/util/List;
    ...
    .line 15
    invoke-virtual {v3}, Le50/j$b$b;->i()Ljava/lang/Boolean;
    ...
    .line 16
    :goto_3
    invoke-virtual {v3}, Le50/j$b$b;->b()Z
    ...
    .line 19
    invoke-virtual {v3}, Le50/j$b$b;->c()Z
    ...
    invoke-direct/range {v4 .. v16}, Le50/g;-><init>(ILjava/util/List;Ljava/lang/String;Le50/j$a;Lf50/c;Ljava/lang/String;ZZZZZZ)V
    ...
    .line 24
    :cond_8
    invoke-virtual/range {p1 .. p1}, Le50/j$b;->a()Ljava/util/List;
    ...
    .line 29
    invoke-virtual {v3}, Le50/j$b$a;->b()I

    move-result v5

    .line 30
    invoke-virtual {v3}, Le50/j$b$a;->a()Ljava/lang/String;
    ...
    .line 31
    invoke-direct {v4, v5, v3}, Le50/c;-><init>(ILjava/lang/String;)V

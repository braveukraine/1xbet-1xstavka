...
# instance fields
.field private final mBitmapPool$delegate:Lr90/g;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final mBitmapProvider$delegate:Lr90/g;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final mResources$delegate:Lr90/g;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Lcom/bumptech/glide/c;)V
    ...
    iput-object p2, p0, Lorg/xbet/client1/util/glide/SvgBitmapDrawableTranscoder;->mBitmapPool$delegate:Lr90/g;
    ...
    iput-object p1, p0, Lorg/xbet/client1/util/glide/SvgBitmapDrawableTranscoder;->mResources$delegate:Lr90/g;
    ...
    iput-object p1, p0, Lorg/xbet/client1/util/glide/SvgBitmapDrawableTranscoder;->mBitmapProvider$delegate:Lr90/g;

    return-void
.end method

.method public static final synthetic access$getMBitmapPool(Lorg/xbet/client1/util/glide/SvgBitmapDrawableTranscoder;)Lcom/bumptech/glide/load/engine/bitmap_recycle/d;
    .locals 0

    invoke-direct {p0}, Lorg/xbet/client1/util/glide/SvgBitmapDrawableTranscoder;->getMBitmapPool()Lcom/bumptech/glide/load/engine/bitmap_recycle/d;
...
.method private final getMBitmapPool()Lcom/bumptech/glide/load/engine/bitmap_recycle/d;
    .locals 1

    iget-object v0, p0, Lorg/xbet/client1/util/glide/SvgBitmapDrawableTranscoder;->mBitmapPool$delegate:Lr90/g;
...
.method private final getMBitmapProvider()Lorg/xbet/client1/util/glide/SvgBitmapDrawableTranscoder$PoolBitmapProvider;
    ...
    iget-object v0, p0, Lorg/xbet/client1/util/glide/SvgBitmapDrawableTranscoder;->mBitmapProvider$delegate:Lr90/g;
...
.method private final getMResources()Landroid/content/res/Resources;
    ...
    iget-object v0, p0, Lorg/xbet/client1/util/glide/SvgBitmapDrawableTranscoder;->mResources$delegate:Lr90/g;
...
.method private final prepareSvg(Lcom/bumptech/glide/load/engine/u;Lcom/bumptech/glide/load/i;)V
    ...
    invoke-virtual {v0}, Lcom/caverock/androidsvg/h;->i()F
    ...
    invoke-virtual {v1}, Lcom/caverock/androidsvg/h;->g()F
    ...
    invoke-static {p1, p2}, Lorg/xbet/ui_common/glide/utils/SvgUtils;->scaleDocumentSize(Lcom/caverock/androidsvg/h;F)V
...
.method public transcode(Lcom/bumptech/glide/load/engine/u;Lcom/bumptech/glide/load/i;)Lcom/bumptech/glide/load/engine/u;
    ...
    invoke-static {p1, v0, p2}, Lorg/xbet/ui_common/glide/utils/SvgUtils;->toBitmap(Lcom/caverock/androidsvg/h;Lorg/xbet/ui_common/glide/utils/BitmapProvider;Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, p1, v1}, Lcom/bumptech/glide/load/resource/bitmap/e;-><init>(Landroid/graphics/Bitmap;Lcom/bumptech/glide/load/engine/bitmap_recycle/d;)V

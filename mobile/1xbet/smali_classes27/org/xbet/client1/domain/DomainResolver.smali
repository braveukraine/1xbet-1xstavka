...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "appSettingsManager",
        "<init>",
        "(Llh/s;Lni/e;Lorg/xbet/client1/util/security/SecurityImpl;Lzi/b;)V",
        "Companion",
        "app_prodRelease"
    }
    k = 0x1
...
.field private final txtProvider:Llh/s;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Llh/s;Lni/e;Lorg/xbet/client1/util/security/SecurityImpl;Lzi/b;)V
    .locals 0
    .param p1    # Llh/s;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/client1/domain/DomainResolver;->txtProvider:Llh/s;

    .line 3
    iput-object p2, p0, Lorg/xbet/client1/domain/DomainResolver;->logger:Lni/e;

    .line 4
    iput-object p3, p0, Lorg/xbet/client1/domain/DomainResolver;->securityImpl:Lorg/xbet/client1/util/security/SecurityImpl;

    .line 5
    iput-object p4, p0, Lorg/xbet/client1/domain/DomainResolver;->appSettingsManager:Lzi/b;

    return-void
.end method

.method public static synthetic a(Lorg/xbet/client1/domain/DomainResolver;Ljava/lang/String;)Lv80/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/domain/DomainResolver;->checkTxtDomain$lambda-2(Lorg/xbet/client1/domain/DomainResolver;Ljava/lang/String;)Lv80/m;
...
.method private static final checkTxtDomain$lambda-2(Lorg/xbet/client1/domain/DomainResolver;Ljava/lang/String;)Lv80/m;
    .locals 1
    ...
    invoke-direct {p0}, Lorg/xbet/client1/domain/DomainResolver;->resolveDomain()Lv80/k;
...
.method private static final checkTxtDomainForUpdate$lambda-1(Lorg/xbet/client1/domain/DomainResolver;Ljava/lang/String;)Lv80/m;
    .locals 2
    ...
    invoke-virtual {p0}, Lorg/xbet/client1/domain/DomainResolver;->checkTxtDomain()Lv80/k;
...
.method public static synthetic d(Lea0/k;Llh/d;)Ljava/lang/String;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/domain/DomainResolver;->resolveDomain$lambda-7(Lea0/k;Llh/d;)Ljava/lang/String;
...
.method public static synthetic e(Llh/d;)Z
    .locals 0

    invoke-static {p0}, Lorg/xbet/client1/domain/DomainResolver;->resolveDomain$lambda-4(Llh/d;)Z
...
.method public static synthetic f(Lorg/xbet/client1/domain/DomainResolver;Llh/d;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/domain/DomainResolver;->resolveDomain$lambda-5(Lorg/xbet/client1/domain/DomainResolver;Llh/d;)V

    return-void
.end method

.method public static synthetic g(Lorg/xbet/client1/domain/DomainResolver;Llh/d;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/domain/DomainResolver;->resolveDomain$lambda-3(Lorg/xbet/client1/domain/DomainResolver;Llh/d;)V
...
.method public static synthetic h(Lorg/xbet/client1/domain/DomainResolver;Ljava/lang/String;)Lv80/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/domain/DomainResolver;->checkTxtDomainForUpdate$lambda-1(Lorg/xbet/client1/domain/DomainResolver;Ljava/lang/String;)Lv80/m;
...
.method private final makeReadableSomeFun()[Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/xbet/client1/domain/DomainResolver;->appSettingsManager:Lzi/b;

    invoke-interface {v1}, Lzi/b;->timeZone()Lxi/b;

    move-result-object v1

    invoke-virtual {v0, v1}, Lorg/xbet/client1/domain/DomainRange$Companion;->load(Lxi/b;)Lorg/xbet/client1/domain/DomainRange;
    ...
    invoke-direct {v7, v8, v9}, Lkh/b;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v6, v5, v7}, Lcom/xbet/domainresolver/utils/a;->a(Ljava/lang/String;Lkh/b;)Ljava/lang/String;
...
.method private final resolveDomain()Lv80/k;
    .locals 8
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/client1/domain/DomainResolver;->txtProvider:Llh/s;

    invoke-virtual {v0}, Llh/s;->u()Lv80/o;
    ...
    new-instance v2, Lorg/xbet/client1/domain/l;

    invoke-direct {v2, v1}, Lorg/xbet/client1/domain/l;-><init>(Lea0/k;)V
    ...
    .line 9
    iget-object v1, p0, Lorg/xbet/client1/domain/DomainResolver;->txtProvider:Llh/s;
    ...
    invoke-direct {v4, v3, v5}, Lkh/b;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 12
    invoke-static/range {v1 .. v7}, Llh/s;->F(Llh/s;[Ljava/lang/String;Ljava/lang/String;Lkh/b;Ljava/lang/String;ILjava/lang/Object;)V

    return-object v0
.end method

.method private static final resolveDomain$lambda-3(Lorg/xbet/client1/domain/DomainResolver;Llh/d;)V
    .locals 2

    iget-object p0, p0, Lorg/xbet/client1/domain/DomainResolver;->logger:Lni/e;
...
.method private static final resolveDomain$lambda-4(Llh/d;)Z
    .locals 0

    invoke-virtual {p0}, Llh/d;->a()Z
...
.method private static final resolveDomain$lambda-5(Lorg/xbet/client1/domain/DomainResolver;Llh/d;)V
    .locals 0

    iget-object p0, p0, Lorg/xbet/client1/domain/DomainResolver;->txtProvider:Llh/s;

    invoke-virtual {p0}, Llh/s;->t()V
...
.method private static final resolveDomain$lambda-7(Lea0/k;Llh/d;)Ljava/lang/String;
    .locals 0
...
# virtual methods
.method public checkTxtDomain()Lv80/k;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public checkTxtDomainForUpdate()Lv80/k;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 2
    new-instance v1, Lorg/xbet/client1/domain/n;

    invoke-direct {v1, p0}, Lorg/xbet/client1/domain/n;-><init>(Lorg/xbet/client1/domain/DomainResolver;)V
...
.method public final getSipDomain(Ljava/lang/String;)Lv80/o;
    .locals 3
    ...
    invoke-static {v0, p1, v1, v2, v1}, Llh/s;->D(Llh/s;Ljava/lang/String;Lkh/b;ILjava/lang/Object;)Lv80/o;

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "testRepository",
        "<init>",
        "(Lzi/b;Lorg/xbet/client1/new_arch/repositories/updater/AppUpdaterRepository;Lzi/k;Lorg/xbet/client1/new_arch/data/mapper/updater/AppUpdaterMapper;Lcom/google/gson/Gson;)V",
        "app_prodRelease"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Lzi/b;Lorg/xbet/client1/new_arch/repositories/updater/AppUpdaterRepository;Lzi/k;Lorg/xbet/client1/new_arch/data/mapper/updater/AppUpdaterMapper;Lcom/google/gson/Gson;)V
    .locals 0
    .param p1    # Lzi/b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->appSettingsManager:Lzi/b;
    ...
    .line 4
    iput-object p3, p0, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->testRepository:Lzi/k;
...
.method public static synthetic a(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;ZZLorg/xbet/client1/apidata/requests/result/start_app/ResolveVersionResponse;)Lr90/r;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->checkUpdate$lambda-3(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;ZZLorg/xbet/client1/apidata/requests/result/start_app/ResolveVersionResponse;)Lr90/r;
...
.method private final checkFakeWordsStatus()Lv80/k;
    .locals 2
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->testRepository:Lzi/k;
    ...
    sget-object v1, Lob0/g;->a:Lob0/g;
...
.method private final checkShownStatus(Z)Lv80/k;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
    ...
    invoke-virtual {p1}, Lorg/xbet/client1/new_arch/repositories/updater/AppUpdaterRepository;->getShowStatus()Lv80/v;

    move-result-object p1

    sget-object v0, Lob0/f;->a:Lob0/f;
...
.method public static synthetic checkUpdate$default(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;ZZZILjava/lang/Object;)Lv80/v;
    .locals 1
    ...
    :cond_2
    invoke-virtual {p0, p1, p2, p3}, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->checkUpdate(ZZZ)Lv80/v;
...
.method private static final checkUpdate$lambda-0(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;Ljava/lang/Boolean;)Lv80/z;
    .locals 1

    .line 1
    invoke-direct {p0}, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->checkFakeWordsStatus()Lv80/k;
    ...
    iget-object p0, p0, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->appSettingsManager:Lzi/b;

    invoke-interface {p0}, Lzi/b;->service()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Lorg/xbet/client1/new_arch/repositories/updater/AppUpdaterRepository;->getLetters(Ljava/lang/String;)Lv80/v;
...
.method private static final checkUpdate$lambda-3(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;ZZLorg/xbet/client1/apidata/requests/result/start_app/ResolveVersionResponse;)Lr90/r;
    .locals 9
    ...
    .line 2
    iget-object p0, p0, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->testRepository:Lzi/k;

    invoke-interface {p0}, Lzi/k;->getOverrideUpdate()Z

    move-result v2

    const/16 v3, 0x62

    const-wide/16 v4, 0x11d6
    ...
    .line 3
    invoke-virtual/range {v0 .. v8}, Lorg/xbet/client1/new_arch/data/mapper/updater/AppUpdaterMapper;->invoke(Lorg/xbet/client1/apidata/requests/result/start_app/ResolveVersionResponse;ZIJZZZ)Lr90/r;
...
.method private static final checkUpdate$lambda-4(ZLorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;Lr90/r;)V
    .locals 0

    invoke-virtual {p2}, Lr90/r;->d()Ljava/lang/Object;
...
.method public static synthetic d(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;Ljava/lang/Boolean;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->checkUpdate$lambda-0(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;Ljava/lang/Boolean;)Lv80/z;
...
.method public static synthetic e(ZLorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;Lr90/r;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->checkUpdate$lambda-4(ZLorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;Lr90/r;)V
...
# virtual methods
.method public final checkUpdate(ZZZ)Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ)",
    ...
    .line 1
    invoke-direct {p0, p3}, Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;->checkShownStatus(Z)Lv80/k;
    ...
    invoke-direct {v1, p0}, Lob0/b;-><init>(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;)V
    ...
    invoke-direct {v1, p0}, Lob0/c;-><init>(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;)V
    ...
    invoke-direct {v1, p0}, Lob0/d;-><init>(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lob0/e;-><init>(Lorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;ZZ)V
    ...
    invoke-direct {p2, p3, p0}, Lob0/a;-><init>(ZLorg/xbet/client1/new_arch/presentation/interactor/updater/AppUpdaterInteractor;)V

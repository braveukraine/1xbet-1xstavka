...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "repository",
        "<init>",
        "(Le50/j1;Lcom/xbet/onexuser/domain/managers/k0;)V",
        "app_prodRelease"
    }
    k = 0x1
    mv = {
...
# instance fields
.field private final repository:Le50/j1;
...
# direct methods
.method public constructor <init>(Le50/j1;Lcom/xbet/onexuser/domain/managers/k0;)V
    .locals 0
    .param p1    # Le50/j1;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/client1/new_arch/domain/profile/AuthHistoryInteractor;->repository:Le50/j1;
...
.method public static synthetic a(Lr90/m;)Ljava/util/List;
    ...
    invoke-static {p0}, Lorg/xbet/client1/new_arch/domain/profile/AuthHistoryInteractor;->getHistory$lambda-5(Lr90/m;)Ljava/util/List;
...
.method public static final synthetic access$getRepository$p(Lorg/xbet/client1/new_arch/domain/profile/AuthHistoryInteractor;)Le50/j1;
    .locals 0

    iget-object p0, p0, Lorg/xbet/client1/new_arch/domain/profile/AuthHistoryInteractor;->repository:Le50/j1;

    return-object p0
.end method

.method public static synthetic b(Lr30/a$b;)Lr90/m;
    .locals 0

    invoke-static {p0}, Lorg/xbet/client1/new_arch/domain/profile/AuthHistoryInteractor;->getHistory$lambda-1(Lr30/a$b;)Lr90/m;
...
.method private static final getHistory$lambda-1(Lr30/a$b;)Lr90/m;
    .locals 5

    .line 1
    invoke-virtual {p0}, Lr30/a$b;->a()Ljava/util/List;
    ...
    .line 4
    check-cast v3, Lr30/a$a;

    .line 5
    new-instance v4, La60/c;

    invoke-direct {v4, v3}, La60/c;-><init>(Lr30/a$a;)V
    ...
    :cond_1
    invoke-virtual {p0}, Lr30/a$b;->b()Ljava/util/List;
    ...
    .line 9
    check-cast v1, Lr30/a$a;

    .line 10
    new-instance v3, La60/c;

    invoke-direct {v3, v1}, La60/c;-><init>(Lr30/a$a;)V
    ...
    .line 11
    :cond_3
    invoke-static {v2, v0}, Lr90/s;->a(Ljava/lang/Object;Ljava/lang/Object;)Lr90/m;
...
.method private static final getHistory$lambda-5(Lr90/m;)Ljava/util/List;
    .locals 19

    .line 1
    invoke-virtual/range {p0 .. p0}, Lr90/m;->a()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Ljava/util/List;

    invoke-virtual/range {p0 .. p0}, Lr90/m;->b()Ljava/lang/Object;
    ...
    sget-object v5, La60/b;->ACTIVE:La60/b;

    new-instance v15, La60/c;
    ...
    invoke-direct/range {v6 .. v16}, La60/c;-><init>(Ljava/lang/String;Ljava/lang/String;JLf50/b;Ljava/lang/String;ZZILkotlin/jvm/internal/h;)V

    invoke-direct {v2, v5, v3}, La60/a;-><init>(La60/b;La60/c;)V
    ...
    .line 6
    check-cast v5, La60/c;

    .line 7
    new-instance v6, La60/a;

    sget-object v7, La60/b;->SIMPLE:La60/b;

    invoke-direct {v6, v7, v5}, La60/a;-><init>(La60/b;La60/c;)V
    ...
    sget-object v3, La60/b;->DIVIDER:La60/b;
    ...
    invoke-direct/range {v5 .. v15}, La60/c;-><init>(Ljava/lang/String;Ljava/lang/String;JLf50/b;Ljava/lang/String;ZZILkotlin/jvm/internal/h;)V

    invoke-direct {v2, v3, v4}, La60/a;-><init>(La60/b;La60/c;)V
    ...
    new-array v2, v2, [La60/a;

    .line 15
    new-instance v4, La60/a;

    sget-object v5, La60/b;->RESET_SESSION:La60/b;
    ...
    invoke-direct {v4, v5, v3}, La60/a;-><init>(La60/b;La60/c;)V
    ...
    sget-object v4, La60/b;->DIVIDER:La60/b;
    ...
    invoke-direct {v3, v4, v0}, La60/a;-><init>(La60/b;La60/c;)V
    ...
    sget-object v4, La60/b;->HISTORY:La60/b;
    ...
    sget-object v5, La60/b;->SIMPLE:La60/b;
...
# virtual methods
.method public final getHistory()Lv80/v;
    .locals 3
    ...
    iget-object v2, p0, Lorg/xbet/client1/new_arch/domain/profile/AuthHistoryInteractor;->repository:Le50/j1;
...
.method public final resetAllSession(Z)Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
...
.method public final resetSession(Ljava/lang/String;)Lv80/v;
    .locals 2

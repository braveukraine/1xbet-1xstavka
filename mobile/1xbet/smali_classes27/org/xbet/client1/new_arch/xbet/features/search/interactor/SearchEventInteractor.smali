...
.method public constructor <init>(Lcom/xbet/onexuser/domain/user/c;Lc50/g;Lzi/b;Lorg/xbet/client1/new_arch/domain/profile/GeoInteractor;Lorg/xbet/domain/betting/searching/repositories/PopularSearchRepository;Lorg/xbet/client1/new_arch/xbet/base/models/mappers/ParamsMapper;Lorg/xbet/client1/new_arch/xbet/features/subscriptions/repositories/SubscriptionManager;Lorg/xbet/domain/betting/feed/favorites/FavoritesRepository;Lorg/xbet/domain/betting/feed/favorites/FavoritesRepository;Lorg/xbet/client1/new_arch/xbet/features/top/repositories/TopMatchesRepository;Lorg/xbet/client1/new_arch/xbet/features/search/repository/SearchEventRepository;Lorg/xbet/domain/betting/repositories/SportRepository;Lorg/xbet/domain/betting/repositories/EventRepository;Lorg/xbet/data/betting/betconstructor/repositories/EventGroupRepositoryImpl;Lorg/xbet/client1/new_arch/xbet/base/models/mappers/BaseBetMapper;)V
    ...
    .line 3
    iput-object p2, p0, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->profileInteractor:Lc50/g;

    .line 4
    iput-object p3, p0, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->appSettingsManager:Lzi/b;
...
.method public static synthetic a(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/lang/Boolean;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->getGeoId$lambda-28(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/lang/Boolean;)Lv80/z;
...
.method public static synthetic b(Ljava/util/List;Ljava/util/List;)Lr90/m;
    ...
    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-1$lambda-0(Ljava/util/List;Ljava/util/List;)Lr90/m;
...
.method public static synthetic d(Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lr90/r;
    ...
    invoke-static {p0, p1, p2}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-6$lambda-5(Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lr90/r;
...
.method public static synthetic e(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->getPopularSearch$lambda-15(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/r;
...
.method private final getGeoId()Lv80/v;
    .locals 2
    ...
    .line 2
    new-instance v1, Lyb0/s;

    invoke-direct {v1, p0}, Lyb0/s;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
...
.method private static final getGeoId$lambda-28(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/lang/Boolean;)Lv80/z;
    .locals 0
    ...
    invoke-virtual {p0}, Lorg/xbet/client1/new_arch/domain/profile/GeoInteractor;->getCurrentGeo()Lv80/v;

    move-result-object p0

    sget-object p1, Lyb0/j;->a:Lyb0/j;
...
.method private static final getGeoId$lambda-28$lambda-27(Ls40/b;)Ljava/lang/Integer;
    .locals 0
...
.method private final getPopularHint()Lv80/o;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-static/range {v0 .. v5}, Lorg/xbet/domain/betting/feed/favorites/FavoritesRepository$DefaultImpls;->getFavoriteTeams$default(Lorg/xbet/domain/betting/feed/favorites/FavoritesRepository;JZILjava/lang/Object;)Lv80/o;
    ...
    invoke-virtual {v0, v1}, Lv80/o;->L0(Lv80/r;)Lv80/o;

    move-result-object v0

    sget-object v1, Lyb0/k;->a:Lyb0/k;
    ...
    .line 5
    new-instance v1, Lyb0/v;

    invoke-direct {v1, p0}, Lyb0/v;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
    ...
    invoke-direct {v1, p0}, Lyb0/b;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
...
.method private static final getPopularHint$lambda-24(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/r;
    .locals 8
    ...
    invoke-static/range {v2 .. v7}, Lorg/xbet/client1/new_arch/xbet/features/top/repositories/TopMatchesRepository;->getTopPeriodically$default(Lorg/xbet/client1/new_arch/xbet/features/top/repositories/TopMatchesRepository;ZZLp40/b;ILjava/lang/Object;)Lv80/o;

    move-result-object v1

    sget-object v2, Lyb0/o;->a:Lyb0/o;
    ...
    invoke-direct {v2, p0, v0}, Lyb0/h;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;I)V
    ...
    .line 5
    new-instance v0, Lyb0/p;

    invoke-direct {v0, p1}, Lyb0/p;-><init>(Ljava/util/List;)V
...
.method private static final getPopularSearch$lambda-11(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/lang/Integer;)Lv80/z;
    .locals 5
    ...
    .line 2
    iget-object v1, p0, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->appSettingsManager:Lzi/b;
    ...
    .line 3
    iget-object v2, p0, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->appSettingsManager:Lzi/b;
    ...
    iget-object p0, p0, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->appSettingsManager:Lzi/b;
    ...
    .line 5
    :goto_1
    invoke-interface {v0, v1, p0, v3}, Lorg/xbet/domain/betting/searching/repositories/PopularSearchRepository;->getPopularSearch(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;)Lv80/v;
...
.method private static final getPopularSearch$lambda-15(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/r;
    .locals 1
    ...
    .line 2
    invoke-direct {p0}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->getPopularHint()Lv80/o;
...
.method public static synthetic h(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-1(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/z;
...
.method public static synthetic j(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->getPopularHint$lambda-24(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/r;
...
.method public static synthetic k(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/m;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-6(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/m;)Lv80/z;
...
.method public static synthetic l(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-4(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/z;
...
.method public static synthetic m(Ljava/util/List;Ljava/util/List;)Lr90/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-4$lambda-3(Ljava/util/List;Ljava/util/List;)Lr90/m;
...
.method public static synthetic n(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/m;)Ljava/util/List;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-9(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/m;)Ljava/util/List;
...
.method public static synthetic p(Ls40/b;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->getGeoId$lambda-28$lambda-27(Ls40/b;)Ljava/lang/Integer;
...
.method public static synthetic r(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/r;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-8(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/r;)Lv80/z;
...
.method private static final search$lambda-10(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;ZLjava/lang/String;Lr90/r;)Lv80/z;
    .locals 9
    ...
    .line 4
    invoke-virtual {p3, p1, p2}, Lorg/xbet/client1/new_arch/xbet/features/search/repository/SearchEventRepository;->searchEvent(ZLjava/util/Map;)Lv80/v;

    move-result-object p1

    .line 5
    new-instance p2, Lyb0/w;

    invoke-direct {p2, p0}, Lyb0/w;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
    ...
    .line 6
    new-instance p2, Lyb0/f;

    invoke-direct {p2, p0}, Lyb0/f;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
    ...
    .line 7
    new-instance p2, Lyb0/c;

    invoke-direct {p2, p0}, Lyb0/c;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
    ...
    invoke-direct {p2, p0}, Lyb0/d;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
    ...
    invoke-direct {p2, p0}, Lyb0/g;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
    ...
    .line 10
    new-instance p2, Lyb0/e;

    invoke-direct {p2, p0}, Lyb0/e;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
...
.method private static final search$lambda-10$lambda-1(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/z;
    .locals 1
    ...
    invoke-interface {p0, p1, v0}, Lorg/xbet/domain/betting/feed/favorites/FavoritesRepository;->gamesIsFavorite(Ljava/util/List;Lp40/b;)Lv80/v;
    ...
    invoke-direct {v0, p1}, Lyb0/a;-><init>(Ljava/util/List;)V
...
.method private static final search$lambda-10$lambda-1$lambda-0(Ljava/util/List;Ljava/util/List;)Lr90/m;
    .locals 0
...
.method private static final search$lambda-10$lambda-2(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/m;)Ljava/util/List;
    .locals 1
...
.method private static final search$lambda-10$lambda-4(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/util/List;)Lv80/z;
    .locals 1
    ...
    invoke-direct {v0, p1}, Lyb0/l;-><init>(Ljava/util/List;)V
...
.method private static final search$lambda-10$lambda-4$lambda-3(Ljava/util/List;Ljava/util/List;)Lr90/m;
    .locals 0
...
.method private static final search$lambda-10$lambda-6(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/m;)Lv80/z;
    .locals 2
    ...
    new-instance v1, Lyb0/q;

    invoke-direct {v1, v0, p1}, Lyb0/q;-><init>(Ljava/util/List;Ljava/util/List;)V
...
.method private static final search$lambda-10$lambda-6$lambda-5(Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lr90/r;
    .locals 1
...
.method private static final search$lambda-10$lambda-8(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/r;)Lv80/z;
    .locals 3
    ...
    .line 3
    new-instance v2, Lyb0/r;

    invoke-direct {v2, v0, v1, p1}, Lyb0/r;-><init>(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
...
.method private static final search$lambda-10$lambda-8$lambda-7(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lr90/m;
    .locals 1
...
.method private static final search$lambda-10$lambda-9(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/m;)Ljava/util/List;
    .locals 1
...
.method public static synthetic t(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/lang/Integer;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->getPopularSearch$lambda-11(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Ljava/lang/Integer;)Lv80/z;
...
.method public static synthetic u(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lr90/m;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-8$lambda-7(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lr90/m;
...
.method public static synthetic v(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;ZLjava/lang/String;Lr90/r;)Lv80/z;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;ZLjava/lang/String;Lr90/r;)Lv80/z;
...
.method public static synthetic w(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/m;)Ljava/util/List;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->search$lambda-10$lambda-2(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;Lr90/m;)Ljava/util/List;
...
# virtual methods
.method public final getPopularSearch()Lv80/o;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    invoke-direct {p0}, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->getGeoId()Lv80/v;
    ...
    invoke-direct {v1, p0}, Lyb0/t;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V

    invoke-virtual {v0, v1}, Lv80/v;->x(Ly80/l;)Lv80/v;

    move-result-object v0

    sget-object v1, Lyb0/m;->a:Lyb0/m;
    ...
    sget-object v1, Lyb0/n;->a:Lyb0/n;
    ...
    .line 5
    new-instance v1, Lyb0/u;

    invoke-direct {v1, p0}, Lyb0/u;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;)V
...
.method public final search(ZLjava/lang/String;)Lv80/v;
    .locals 2
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;->profileInteractor:Lc50/g;
    ...
    invoke-direct {v1, p0, p1, p2}, Lyb0/i;-><init>(Lorg/xbet/client1/new_arch/xbet/features/search/interactor/SearchEventInteractor;ZLjava/lang/String;)V

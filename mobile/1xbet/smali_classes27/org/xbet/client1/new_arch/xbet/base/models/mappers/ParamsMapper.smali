...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "appSettingsManager",
        "<init>",
        "(Lzi/b;Lorg/xbet/domain/betting/repositories/CoefViewPrefsRepository;Lorg/xbet/onexlocalization/LanguageRepository;)V",
        "Companion",
        "app_prodRelease"
    }
    k = 0x1
...
.method public constructor <init>(Lzi/b;Lorg/xbet/domain/betting/repositories/CoefViewPrefsRepository;Lorg/xbet/onexlocalization/LanguageRepository;)V
    .locals 0
    .param p1    # Lzi/b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/client1/new_arch/xbet/base/models/mappers/ParamsMapper;->appSettingsManager:Lzi/b;
...
.method private final group()Ljava/util/Map;
    ...
    iget-object v0, p0, Lorg/xbet/client1/new_arch/xbet/base/models/mappers/ParamsMapper;->appSettingsManager:Lzi/b;
...
.method public final bestGames(IZIZJ)Ljava/util/Map;
    ...
    .line 4
    invoke-static {v0, v1}, Lkotlin/collections/h0;->l(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
...
.method public final event(JZZIZJ)Ljava/util/Map;
    ...
    invoke-static {v0, v3}, Lkotlin/collections/h0;->l(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v0, v1}, Lkotlin/collections/h0;->m(Ljava/util/Map;Lr90/m;)Ljava/util/Map;
...
.method public final params(Lcom/xbet/zip/model/zip/game/a;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;Ljava/util/Set;ZLorg/xbet/client1/new_arch/xbet/base/models/entity/LineLiveType;IZJZZ)Ljava/util/Map;
    ...
    .line 4
    :goto_1
    invoke-static {p1, p2}, Lkotlin/collections/h0;->l(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 81
    :goto_9
    invoke-static {p1, p3}, Lkotlin/collections/h0;->l(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;

...
.method public static synthetic a(Lorg/xbet/client1/statistic/domain/StatisticLiveInteractor;JLjava/lang/Long;)Lv80/r;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/client1/statistic/domain/StatisticLiveInteractor;->getUpdatableFullStatistic$lambda-6(Lorg/xbet/client1/statistic/domain/StatisticLiveInteractor;JLjava/lang/Long;)Lv80/r;
...
.method public static synthetic b(Lr90/r;)Lv80/r;
    .locals 0

    invoke-static {p0}, Lorg/xbet/client1/statistic/domain/StatisticLiveInteractor;->getUpdatableFullStatistic$lambda-6$lambda-5(Lr90/r;)Lv80/r;
...
.method public static synthetic d(Lorg/xbet/client1/statistic/data/statistic_feed/GameStatistic;Ljava/util/List;Ljava/util/List;)Lr90/r;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/client1/statistic/domain/StatisticLiveInteractor;->getUpdatableFullStatistic$lambda-6$lambda-4(Lorg/xbet/client1/statistic/data/statistic_feed/GameStatistic;Ljava/util/List;Ljava/util/List;)Lr90/r;
...
.method public static synthetic e(Ljava/lang/Throwable;)Lv80/z;
    ...
    invoke-static {p0}, Lorg/xbet/client1/statistic/domain/StatisticLiveInteractor;->getUpdatableFullStatistic$lambda-6$lambda-2(Ljava/lang/Throwable;)Lv80/z;
...
.method public static synthetic f(Ljava/lang/Throwable;)Lv80/z;
    ...
    invoke-static {p0}, Lorg/xbet/client1/statistic/domain/StatisticLiveInteractor;->getUpdatableFullStatistic$lambda-6$lambda-3(Ljava/lang/Throwable;)Lv80/z;
...
.method private static final getUpdatableFullStatistic$lambda-6(Lorg/xbet/client1/statistic/domain/StatisticLiveInteractor;JLjava/lang/Long;)Lv80/r;
    .locals 6
    ...
    invoke-virtual {v0, p1, p2}, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->getShortStatistic(J)Lv80/v;

    move-result-object v0

    sget-object v1, Ldc0/g;->a:Ldc0/g;
    ...
    sget-object v1, Ldc0/e;->a:Ldc0/e;
    ...
    invoke-virtual {p0, p1, p2}, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->getCourseOfPlay(J)Lv80/v;

    move-result-object p0

    sget-object p1, Ldc0/f;->a:Ldc0/f;

    invoke-virtual {p0, p1}, Lv80/v;->J(Ly80/l;)Lv80/v;

    move-result-object p0

    sget-object p1, Ldc0/c;->a:Ldc0/c;

    .line 6
    invoke-static {p3, v0, p0, p1}, Lv80/v;->i0(Lv80/z;Lv80/z;Lv80/z;Ly80/h;)Lv80/v;

    move-result-object p0

    sget-object p1, Ldc0/h;->a:Ldc0/h;
...
.method private static final getUpdatableFullStatistic$lambda-6$lambda-2(Ljava/lang/Throwable;)Lv80/z;
    .locals 0
...
.method private static final getUpdatableFullStatistic$lambda-6$lambda-3(Ljava/lang/Throwable;)Lv80/z;
    .locals 0
...
.method private static final getUpdatableFullStatistic$lambda-6$lambda-4(Lorg/xbet/client1/statistic/data/statistic_feed/GameStatistic;Ljava/util/List;Ljava/util/List;)Lr90/r;
    .locals 1
...
.method private static final getUpdatableFullStatistic$lambda-6$lambda-5(Lr90/r;)Lv80/r;
    .locals 3
    ...
    invoke-virtual {p0}, Lr90/r;->b()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Ljava/util/List;

    invoke-virtual {p0}, Lr90/r;->c()Ljava/lang/Object;
...
# virtual methods
.method public final getUpdatableFullStatistic(J)Lv80/o;
    .locals 5
    ...
    .line 2
    new-instance v1, Ldc0/d;

    invoke-direct {v1, p0, p1, p2}, Ldc0/d;-><init>(Lorg/xbet/client1/statistic/domain/StatisticLiveInteractor;J)V

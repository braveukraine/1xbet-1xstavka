...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "serviceGenerator",
        "<init>",
        "(Lorg/xbet/client1/statistic/data/repositories/StatisticDataStore;Lorg/xbet/client1/statistic/data/repositories/F1StatisticDataStore;Lzi/b;Lui/j;Lorg/xbet/client1/statistic/data/mappers/F1StatMapper;Lorg/xbet/client1/new_arch/presentation/ui/game/mapper/SimpleGameMapper;)V",
        "app_prodRelease"
    }
    k = 0x1
    mv = {
...
.method public constructor <init>(Lorg/xbet/client1/statistic/data/repositories/StatisticDataStore;Lorg/xbet/client1/statistic/data/repositories/F1StatisticDataStore;Lzi/b;Lui/j;Lorg/xbet/client1/statistic/data/mappers/F1StatMapper;Lorg/xbet/client1/new_arch/presentation/ui/game/mapper/SimpleGameMapper;)V
    ...
    .line 4
    iput-object p3, p0, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->appSettingsManager:Lzi/b;

    .line 5
    iput-object p4, p0, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->serviceGenerator:Lui/j;
    ...
    iput-object p1, p0, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->service:Lz90/a;
...
.method public static final synthetic access$getServiceGenerator$p(Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;)Lui/j;
    .locals 0

    iget-object p0, p0, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->serviceGenerator:Lui/j;
...
.method public static synthetic f(Ly00/e;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->getCourseOfPlay$lambda-7(Ly00/e;)Ljava/lang/String;
...
.method private static final getCourseOfPlay$lambda-7(Ly00/e;)Ljava/lang/String;
    .locals 0
...
.method public static synthetic getFullStatistic$default(Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;JZILjava/lang/Object;)Lv80/v;
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->getFullStatistic(JZ)Lv80/v;
...
.method private final statistic(J)Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->service:Lz90/a;
    ...
    iget-object v1, p0, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->appSettingsManager:Lzi/b;

    invoke-interface {v1}, Lzi/b;->getLang()Ljava/lang/String;

    move-result-object v1

    invoke-interface {v0, p1, p2, v1}, Lorg/xbet/client1/statistic/data/network/StatisticApiService;->getFullStatistic(JLjava/lang/String;)Lv80/v;
...
# virtual methods
.method public final getCourseOfPlay(J)Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    invoke-interface {v0, p1, p2, v1}, Lorg/xbet/client1/statistic/data/network/StatisticApiService;->getCourseOfPlay(JLjava/lang/String;)Lv80/v;
...
.method public final getFullStatistic(JZ)Lv80/v;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JZ)",
    ...
    invoke-virtual {p3, p1, p2}, Lorg/xbet/client1/statistic/data/repositories/StatisticDataStore;->getStatistic(J)Lv80/k;

    move-result-object p3

    invoke-direct {p0, p1, p2}, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->statistic(J)Lv80/v;

    move-result-object p1

    invoke-virtual {p3, p1}, Lv80/k;->w(Lv80/z;)Lv80/v;
...
.method public final getPlayerInfo(Ljava/lang/String;J)Lv80/v;
    .locals 2
    ...
    invoke-interface {v0, p1, p2, p3, v1}, Lorg/xbet/client1/statistic/data/network/StatisticApiService;->getPlayerInfo(Ljava/lang/String;JLjava/lang/String;)Lv80/v;
...
.method public final getRatingShortTables(Ljava/lang/String;Ljava/lang/String;)Lv80/v;
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {v0, p1, p2}, Lorg/xbet/client1/statistic/data/network/StatisticApiService;->getRatingShortTables(Ljava/lang/String;Ljava/lang/String;)Lv80/v;
...
.method public final getRatingTable(J)Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    invoke-interface {v0, p1, p2, v1}, Lorg/xbet/client1/statistic/data/network/StatisticApiService;->getRatingTable(JLjava/lang/String;)Lv80/v;
...
.method public final getRatingTable(Ljava/lang/String;)Lv80/v;
    .locals 2
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {v0, p1, v1}, Lorg/xbet/client1/statistic/data/network/StatisticApiService;->getRatingTable(Ljava/lang/String;Ljava/lang/String;)Lv80/v;
...
.method public final getShortStatistic(J)Lv80/v;
    ...
    invoke-interface {v0, p1, p2, v1}, Lorg/xbet/client1/statistic/data/network/StatisticApiService;->getShortStatistic(JLjava/lang/String;)Lv80/v;
...
.method public getSimpleGameFromStatistic(JJZZ)Lv80/v;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JJZZ)",
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p5}, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->getFullStatistic(JZ)Lv80/v;
    ...
    invoke-virtual {p5, v7}, Lv80/v;->G(Ly80/l;)Lv80/v;
...
.method public final getStatistic(Ljava/lang/String;)Lv80/v;
    .locals 3
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Lorg/xbet/client1/statistic/data/repositories/StatisticDataStore;->getStatistic(Ljava/lang/String;)Lv80/k;

    move-result-object v0

    .line 2
    iget-object v1, p0, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->service:Lz90/a;
    ...
    iget-object v2, p0, Lorg/xbet/client1/statistic/data/repositories/StatisticRepository;->appSettingsManager:Lzi/b;

    invoke-interface {v2}, Lzi/b;->getLang()Ljava/lang/String;

    move-result-object v2

    invoke-interface {v1, p1, v2}, Lorg/xbet/client1/statistic/data/network/StatisticApiService;->getStatistic(Ljava/lang/String;Ljava/lang/String;)Lv80/v;

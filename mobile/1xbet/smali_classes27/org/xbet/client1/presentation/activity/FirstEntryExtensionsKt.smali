...
.method public static final getPushAction(Lorg/xbet/client1/presentation/activity/AppActivity;)Lorg/xbet/client1/new_arch/presentation/model/push/PushAction;
    ...
    invoke-direct {p0, v2, v2}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Authorization;-><init>(ZZ)V
    ...
    invoke-direct {p0, v3, v2}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Authorization;-><init>(ZZ)V
    ...
    invoke-direct {p0, v2, v3}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Authorization;-><init>(ZZ)V
    ...
    .line 45
    invoke-static {p0, v0}, Lorg/xbet/client1/presentation/activity/FirstEntryExtensionsKt;->getPushActionFromScreenType(Lorg/xbet/client1/presentation/activity/AppActivity;Ll40/e;)Lorg/xbet/client1/new_arch/presentation/model/push/PushAction;
...
.method private static final getPushActionFromScreenType(Lorg/xbet/client1/presentation/activity/AppActivity;Ll40/e;)Lorg/xbet/client1/new_arch/presentation/model/push/PushAction;
    .locals 25
    ...
    const-string v4, "ACTIVITY_RECREATED"
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$BetResult;-><init>(JJ)V
    ...
    check-cast v5, Lorg/xbet/authenticator/util/OperationConfirmation;
    ...
    invoke-direct {v0, v3, v5}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Authenticator;-><init>(Ljava/lang/String;Lorg/xbet/authenticator/util/OperationConfirmation;)V
    ...
    .line 14
    :goto_1
    new-instance v0, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Coupon;

    invoke-direct {v0, v3}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Coupon;-><init>(Ljava/lang/String;)V

    goto/16 :goto_8

    .line 15
    :pswitch_6
    sget-object v0, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Toto;->INSTANCE:Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Toto;
    ...
    .line 20
    :goto_3
    sget-object v2, Ll40/e;->CASINO_SLOTS:Ll40/e;
    ...
    invoke-direct/range {v10 .. v24}, Lcom/turturibus/slot/casino/presenter/CasinoItem;-><init>(JLjava/lang/String;Ljava/lang/String;IJJZLj20/e;ZILkotlin/jvm/internal/h;)V
    ...
    check-cast v5, Lorg/xbet/core/data/OneXGamesPromoType;

    :cond_8
    if-nez v5, :cond_9

    .line 30
    sget-object v5, Lorg/xbet/core/data/OneXGamesPromoType;->UNKNOWN:Lorg/xbet/core/data/OneXGamesPromoType;

    .line 31
    :cond_9
    new-instance v0, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$GamesGroup;

    invoke-direct {v0, v1, v5}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$GamesGroup;-><init>(ILorg/xbet/core/data/OneXGamesPromoType;)V
    ...
    invoke-direct {v0, v6}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Express;-><init>(Z)V
    ...
    .line 37
    new-instance v1, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$PromoGroup;

    invoke-direct {v1, v0}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$PromoGroup;-><init>(I)V
    ...
    invoke-direct {v0, v10, v6, v5}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$PromoGroup;-><init>(IILkotlin/jvm/internal/h;)V
    ...
    sget-object v4, Ll40/e;->LIVE_GAME:Ll40/e;
    ...
    :goto_6
    invoke-direct {v0, v2, v3, v6}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Game;-><init>(JZ)V
    ...
    invoke-static {v0}, Lorg/xbet/client1/presentation/activity/FirstEntryExtensionsKt;->parseFeedsParams(Landroid/content/Intent;)Lr90/m;
    ...
    .line 43
    :pswitch_10
    new-instance v0, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Group;
    ...
    invoke-direct {v0, v1}, Lorg/xbet/client1/new_arch/presentation/model/push/PushAction$Group;-><init>(Lorg/xbet/domain/betting/feed/linelive/models/LineLiveScreenType;)V
...
.method private static final parseFeedsParams(Landroid/content/Intent;)Lr90/m;
    .locals 5

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "configInteractor",
        "<init>",
        "(Ljg/a;Lorg/xbet/client1/new_arch/data/mapper/settings/SettingsInfoTypeModelMapper;Lorg/xbet/domain/betting/feed/favorites/providers/MenuConfigRepositoryProvider;Lorg/xbet/hidden_betting/domain/HiddenBettingInteractor;)V",
        "app_prodRelease"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Ljg/a;Lorg/xbet/client1/new_arch/data/mapper/settings/SettingsInfoTypeModelMapper;Lorg/xbet/domain/betting/feed/favorites/providers/MenuConfigRepositoryProvider;Lorg/xbet/hidden_betting/domain/HiddenBettingInteractor;)V
    .locals 0
    .param p1    # Ljg/a;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/client1/configs/remote/domain/SettingsConfigInteractor;->configInteractor:Ljg/a;
...
.method public final getInfoTypes()Ljava/util/List;
    ...
    iget-object v1, p0, Lorg/xbet/client1/configs/remote/domain/SettingsConfigInteractor;->configInteractor:Ljg/a;

    invoke-virtual {v1}, Ljg/a;->c()Lmg/h;

    move-result-object v1

    invoke-virtual {v1}, Lmg/h;->h()Ljava/util/List;

    move-result-object v1

    invoke-virtual {v0, v1}, Lorg/xbet/client1/new_arch/data/mapper/settings/SettingsInfoTypeModelMapper;->invoke(Ljava/util/List;)Lp5/c;

    move-result-object v0

    invoke-virtual {v0}, Lp5/c;->a()Ljava/util/List;
...
.method public getSettingsConfig()Lmg/h;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lorg/xbet/client1/configs/remote/domain/SettingsConfigInteractor;->configInteractor:Ljg/a;
...
.method public isAutoBetEnabled()Z
    ...
    invoke-virtual {p0}, Lorg/xbet/client1/configs/remote/domain/SettingsConfigInteractor;->getSettingsConfig()Lmg/h;

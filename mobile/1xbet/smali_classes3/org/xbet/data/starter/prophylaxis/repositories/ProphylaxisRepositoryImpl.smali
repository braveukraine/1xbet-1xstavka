...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "serviceModule",
        "<init>",
        "(Lui/j;Lzi/b;Lzi/k;Lorg/xbet/data/starter/prophylaxis/datasources/ProphylaxisDataSource;Lorg/xbet/data/starter/prophylaxis/mappers/ProphylaxisMapper;Lui/k;)V",
        "Companion",
        "starter_release"
    }
    k = 0x1
...
.method public constructor <init>(Lui/j;Lzi/b;Lzi/k;Lorg/xbet/data/starter/prophylaxis/datasources/ProphylaxisDataSource;Lorg/xbet/data/starter/prophylaxis/mappers/ProphylaxisMapper;Lui/k;)V
    .locals 0
    .param p1    # Lui/j;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p2, p0, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->appSettingsManager:Lzi/b;

    .line 3
    iput-object p3, p0, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->testRepository:Lzi/k;
    ...
    .line 6
    iput-object p6, p0, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->serviceModule:Lui/k;

    .line 7
    new-instance p2, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl$service$1;

    invoke-direct {p2, p1}, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl$service$1;-><init>(Lui/j;)V

    iput-object p2, p0, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->service:Lz90/a;

    return-void
.end method

.method public static synthetic a(Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;Lretrofit2/s;)Lv80/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->check$lambda-1(Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;Lretrofit2/s;)Lv80/r;
...
.method public static synthetic b(Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;Lretrofit2/s;)Lv80/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->checkHighLoad$lambda-2(Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;Lretrofit2/s;)Lv80/r;
...
.method public static synthetic c(Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;Ljava/lang/Long;)Lv80/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->checkProphylaxis$lambda-0(Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;Ljava/lang/Long;)Lv80/r;
...
.method private final check()Lv80/o;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->service:Lz90/a;
    ...
    iget-object v2, p0, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->serviceModule:Lui/k;

    invoke-interface {v2}, Lui/k;->getAPI_ENDPOINT()Ljava/lang/String;
    ...
    .line 4
    iget-object v2, p0, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->testRepository:Lzi/k;

    invoke-interface {v2}, Lzi/k;->getTestProphylaxis()Z
    ...
    .line 6
    invoke-interface {v0, v1}, Lorg/xbet/data/starter/prophylaxis/services/ProphylaxisService;->checkProphylaxis(Ljava/lang/String;)Lv80/o;
...
.method private static final check$lambda-1(Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;Lretrofit2/s;)Lv80/r;
    .locals 2
    ...
    invoke-static {p0}, Lv80/o;->d0(Ljava/lang/Throwable;)Lv80/o;
...
.method private final checkHighLoad()Lv80/o;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0, v1}, Lorg/xbet/data/starter/prophylaxis/services/ProphylaxisService;->checkHighLoad(Ljava/lang/String;)Lv80/o;
...
.method private static final checkHighLoad$lambda-2(Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;Lretrofit2/s;)Lv80/r;
    .locals 2
...
.method private static final checkProphylaxis$lambda-0(Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;Ljava/lang/Long;)Lv80/r;
    .locals 0

    invoke-direct {p0}, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->check()Lv80/o;

    move-result-object p1

    invoke-direct {p0}, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->checkHighLoad()Lv80/o;

    move-result-object p0

    invoke-static {p1, p0}, Lv80/o;->H0(Lv80/r;Lv80/r;)Lv80/o;
...
.method private final checkStandardDomain()Z
    ...
    iget-object v0, p0, Lorg/xbet/data/starter/prophylaxis/repositories/ProphylaxisRepositoryImpl;->appSettingsManager:Lzi/b;
...
# virtual methods
.method public checkProphylaxis(Z)Lv80/o;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
    ...
    .line 2
    invoke-static {v2, v3, v0, v1, p1}, Lv80/o;->A0(JJLjava/util/concurrent/TimeUnit;)Lv80/o;
...
.method public getFingerPrintScreenStatus()Lv80/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lorg/xbet/data/starter/prophylaxis/datasources/ProphylaxisDataSource;->getFingerPrintScreenStatus()Lv80/o;

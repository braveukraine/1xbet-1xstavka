...
.method public static synthetic b(Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;)Lv80/z;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->getCurrent$lambda-1(Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;)Lv80/z;
...
.method private final count()Lv80/v;
    .locals 1
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/AppStringsDao;->count()Lv80/v;
...
.method private static final getCurrent$lambda-1(Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;)Lv80/z;
    .locals 0
    ...
    .line 2
    :cond_0
    invoke-direct {p0, p1, p2}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->stringsByMainLocaleWithDefault(Ljava/lang/String;Ljava/lang/String;)Lv80/v;
...
.method private final insert(Ljava/util/Collection;)Lv80/b;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final stringsByLocale(Ljava/lang/String;)Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lorg/xbet/onexdatabase/dao/AppStringsDao;->byLocale(Ljava/lang/String;)Lv80/v;

    move-result-object v0

    new-instance v1, Lrc0/b;

    invoke-direct {v1, p0, p1}, Lrc0/b;-><init>(Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;Ljava/lang/String;)V
...
.method private final stringsByMainLocaleWithDefault(Ljava/lang/String;Ljava/lang/String;)Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p2}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->stringsByLocale(Ljava/lang/String;)Lv80/v;

    move-result-object p2

    invoke-direct {p0, p2}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->toMap(Lv80/v;)Lv80/v;

    move-result-object p2

    .line 2
    invoke-direct {p0, p1}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->stringsByLocale(Ljava/lang/String;)Lv80/v;

    move-result-object p1

    invoke-direct {p0, p1}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->toMap(Lv80/v;)Lv80/v;

    move-result-object p1

    sget-object v0, Lrc0/a;->a:Lrc0/a;

    .line 3
    invoke-static {p2, p1, v0}, Lv80/v;->j0(Lv80/z;Lv80/z;Ly80/c;)Lv80/v;
...
.method private static final stringsByMainLocaleWithDefault$lambda-3(Ljava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    .line 1
    invoke-static {p0, p1}, Lkotlin/collections/h0;->l(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
...
.method private final toMap(Lv80/v;)Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v0, Lrc0/e;->a:Lrc0/e;
...
# virtual methods
.method public getCurrent(Ljava/lang/String;Ljava/lang/String;)Lv80/v;
    .locals 2
    ...
    .line 1
    invoke-virtual {p0}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->isEmpty()Lv80/v;
    ...
    invoke-direct {v1, p0, p1, p2}, Lrc0/c;-><init>(Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;Ljava/lang/String;Ljava/lang/String;)V
...
.method public insertAndGet(Ljava/util/Collection;Ljava/lang/String;Ljava/lang/String;)Lv80/v;
    .locals 0
    ...
    .line 1
    invoke-direct {p0, p1}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->insert(Ljava/util/Collection;)Lv80/b;

    move-result-object p1

    .line 2
    invoke-direct {p0, p2, p3}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->stringsByMainLocaleWithDefault(Ljava/lang/String;Ljava/lang/String;)Lv80/v;
...
.method public isEmpty()Lv80/v;
    ...
    invoke-direct {p0}, Lorg/xbet/data/app_strings/AppStringsRepositoryImpl;->count()Lv80/v;

    move-result-object v0

    sget-object v1, Lrc0/d;->a:Lrc0/d;

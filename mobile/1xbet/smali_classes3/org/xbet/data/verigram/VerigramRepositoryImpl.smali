...
.method public static synthetic a(Ljava/util/HashMap;Lorg/xbet/domain/verigram/model/RegistrationInfoModel;)Lr90/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/verigram/VerigramRepositoryImpl;->sendData$lambda-0(Ljava/util/HashMap;Lorg/xbet/domain/verigram/model/RegistrationInfoModel;)Lr90/m;
...
.method public static synthetic b(Lorg/xbet/data/verigram/VerigramRepositoryImpl;Ly00/e;)Lorg/xbet/domain/verigram/model/VerigramModel;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/verigram/VerigramRepositoryImpl;->sendData$lambda-2(Lorg/xbet/data/verigram/VerigramRepositoryImpl;Ly00/e;)Lorg/xbet/domain/verigram/model/VerigramModel;
...
.method public static synthetic c(Lorg/xbet/data/verigram/VerigramRepositoryImpl;Lr90/m;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/verigram/VerigramRepositoryImpl;->sendData$lambda-1(Lorg/xbet/data/verigram/VerigramRepositoryImpl;Lr90/m;)Lv80/z;
...
.method private final createRequestData(Ljava/util/HashMap;Lorg/xbet/data/verigram/model/VerigramDocTypeEnum;Lorg/xbet/domain/verigram/model/RegistrationInfoModel;)Lorg/xbet/data/verigram/model/VerigramRequest;
    ...
    .line 11
    :goto_4
    invoke-virtual/range {p3 .. p3}, Lorg/xbet/domain/verigram/model/RegistrationInfoModel;->getRegion()Ld50/a;
    ...
    .line 12
    invoke-virtual/range {p3 .. p3}, Lorg/xbet/domain/verigram/model/RegistrationInfoModel;->getCity()Ld50/a;
    ...
    invoke-direct/range {v7 .. v21}, Lorg/xbet/data/verigram/model/VerigramRequest;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JJLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static final sendData$lambda-0(Ljava/util/HashMap;Lorg/xbet/domain/verigram/model/RegistrationInfoModel;)Lr90/m;
    .locals 0
...
.method private static final sendData$lambda-1(Lorg/xbet/data/verigram/VerigramRepositoryImpl;Lr90/m;)Lv80/z;
    .locals 8
    ...
    .line 14
    invoke-virtual/range {v2 .. v7}, Lorg/xbet/data/verigram/datasources/VerigramRemoteDataSources;->sendVerificationRequest(Lorg/xbet/data/verigram/model/VerigramRequest;Lorg/xbet/data/verigram/model/VerigramDocTypeEnum;Ljava/io/File;Ljava/io/File;[Ljava/io/File;)Lv80/v;
...
.method private static final sendData$lambda-2(Lorg/xbet/data/verigram/VerigramRepositoryImpl;Ly00/e;)Lorg/xbet/domain/verigram/model/VerigramModel;
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lorg/xbet/data/verigram/mapper/VerigramModelMapper;->invoke(Ly00/e;)Lorg/xbet/domain/verigram/model/VerigramModel;
...
.method public getDocumentData()Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lorg/xbet/data/verigram/datasources/VerigramDataSource;->getDocumentData()Lv80/v;
...
.method public getRegistrationInfo()Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lorg/xbet/data/verigram/datasources/VerigramDataSource;->getRegistrationInfo()Lv80/v;
...
.method public sendData()Lv80/v;
    ...
    .line 1
    invoke-virtual {p0}, Lorg/xbet/data/verigram/VerigramRepositoryImpl;->getDocumentData()Lv80/v;

    move-result-object v0

    .line 2
    invoke-virtual {p0}, Lorg/xbet/data/verigram/VerigramRepositoryImpl;->getRegistrationInfo()Lv80/v;

    move-result-object v1

    sget-object v2, Lmd0/a;->a:Lmd0/a;
    ...
    invoke-direct {v1, p0}, Lmd0/c;-><init>(Lorg/xbet/data/verigram/VerigramRepositoryImpl;)V
    ...
    invoke-direct {v1, p0}, Lmd0/b;-><init>(Lorg/xbet/data/verigram/VerigramRepositoryImpl;)V

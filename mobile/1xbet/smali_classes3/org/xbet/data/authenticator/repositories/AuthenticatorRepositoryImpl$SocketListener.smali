...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "appSettingsManager",
        "<init>",
        "(Lcom/google/gson/Gson;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/xbet/domain/authenticator/models/SocketOperation;Lzi/b;)V",
        "Companion",
        "office_release"
    }
    k = 0x1
...
.field private final observable:Lv80/o;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lv80/o<",
            "Lorg/xbet/data/authenticator/models/socket/SocketResponse;",
...
.method public constructor <init>(Lcom/google/gson/Gson;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/xbet/domain/authenticator/models/SocketOperation;Lzi/b;)V
    .locals 0
    ...
    .line 8
    iput-object p7, p0, Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;->appSettingsManager:Lzi/b;
    ...
    .line 11
    new-instance p1, Lorg/xbet/data/authenticator/repositories/v;

    invoke-direct {p1, p0}, Lorg/xbet/data/authenticator/repositories/v;-><init>(Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;)V

    invoke-static {p1}, Lv80/o;->A(Lv80/q;)Lv80/o;

    move-result-object p1

    iput-object p1, p0, Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;->observable:Lv80/o;
...
.method public static synthetic b(Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;Lv80/p;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;->observable$lambda-1(Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;Lv80/p;)V
...
.method private static final observable$lambda-1(Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;Lv80/p;)V
    .locals 1
    ...
    .line 2
    new-instance v0, Lorg/xbet/data/authenticator/repositories/u;

    invoke-direct {v0, p0}, Lorg/xbet/data/authenticator/repositories/u;-><init>(Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;)V

    invoke-static {v0}, Lx80/d;->d(Ljava/lang/Runnable;)Lx80/c;

    move-result-object p0

    invoke-interface {p1, p0}, Lv80/p;->g(Lx80/c;)V
...
.method private static final observable$lambda-1$lambda-0(Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;)V
    ...
    invoke-static {v0, v1}, Lkotlin/collections/n;->D(Ljava/util/List;Lz90/l;)Z
...
.method private final sendAuthorizationMessage()V
    ...
    .line 2
    iget-object v0, p0, Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;->appSettingsManager:Lzi/b;
    ...
    invoke-interface {v0}, Lzi/b;->osName()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lzi/b;->osVersion()Ljava/lang/String;
...
# virtual methods
.method public final getObservable()Lv80/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lorg/xbet/data/authenticator/repositories/AuthenticatorRepositoryImpl$SocketListener;->observable:Lv80/o;
...
.method public onClosed(Lokhttp3/h0;ILjava/lang/String;)V
    ...
    check-cast p2, Lv80/p;

    .line 4
    invoke-interface {p2}, Lv80/e;->onComplete()V
...
.method public onFailure(Lokhttp3/h0;Ljava/lang/Throwable;Lokhttp3/d0;)V
    ...
    check-cast p3, Lv80/p;

    .line 3
    invoke-interface {p3, p2}, Lv80/e;->onError(Ljava/lang/Throwable;)V
...
.method public onMessage(Lokhttp3/h0;Ljava/lang/String;)V
    ...
    .line 5
    invoke-interface {v0, p1}, Lv80/e;->onNext(Ljava/lang/Object;)V

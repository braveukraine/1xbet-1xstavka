...
.method public static synthetic a(Ly00/e;)Lorg/xbet/data/identification/models/CupisSendPhotoResponse;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;->uploadPhoto$lambda-2(Ly00/e;)Lorg/xbet/data/identification/models/CupisSendPhotoResponse;
...
.method public static synthetic d(Ly00/e;)Ljava/util/List;
    ...
    invoke-static {p0}, Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;->getRemainingDocs$lambda-5(Ly00/e;)Ljava/util/List;
...
.method public static synthetic f(Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;Lx80/c;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;->getRemainingDocs$lambda-4(Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;Lx80/c;)V
...
.method private static final getRemainingDocs$lambda-4(Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;Lx80/c;)V
    .locals 0
...
.method private static final getRemainingDocs$lambda-5(Ly00/e;)Ljava/util/List;
    .locals 0
...
.method private static final uploadPhoto$lambda-2(Ly00/e;)Lorg/xbet/data/identification/models/CupisSendPhotoResponse;
    .locals 0
...
# virtual methods
.method public getDocTypes()Lv80/v;
    .locals 2
    ...
    invoke-virtual {v0}, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->getDocTypes()Lv80/v;
    ...
    invoke-direct {v1, p0}, Lhd0/c;-><init>(Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;)V
...
.method public getRemainingDocs(Z)Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
    ...
    invoke-virtual {p1}, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->getRemainingDocs()Lv80/v;
    ...
    invoke-direct {v0, p0}, Lhd0/a;-><init>(Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;)V

    invoke-virtual {p1, v0}, Lv80/v;->r(Ly80/g;)Lv80/v;

    move-result-object p1

    sget-object v0, Lhd0/f;->a:Lhd0/f;
    ...
    invoke-direct {v0, p0}, Lhd0/b;-><init>(Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;)V
...
.method public sendDocument(Ljava/lang/String;I)Lv80/b;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2}, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->sendDocument(Ljava/lang/String;I)Lv80/v;
...
.method public uploadPhoto(Ljava/lang/String;I)Lv80/v;
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p1, p2}, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->uploadPhoto(Ljava/lang/String;I)Lv80/v;

    move-result-object p1

    sget-object p2, Lhd0/e;->a:Lhd0/e;
    ...
    invoke-direct {p2, p0}, Lhd0/d;-><init>(Lorg/xbet/data/identification/repositories/UploadFileRepositoryImpl;)V

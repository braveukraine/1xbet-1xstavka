...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "serviceGenerator",
        "<init>",
        "(Lcom/xbet/onexuser/domain/managers/k0;Lzi/b;Lui/j;)V",
        "office_release"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Lcom/xbet/onexuser/domain/managers/k0;Lzi/b;Lui/j;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->appSettingsManager:Lzi/b;

    .line 4
    new-instance p1, Lorg/xbet/data/identification/datasources/UploadFileDataSource$service$2;

    invoke-direct {p1, p3}, Lorg/xbet/data/identification/datasources/UploadFileDataSource$service$2;-><init>(Lui/j;)V

    invoke-static {p1}, Lr90/h;->b(Lz90/a;)Lr90/g;

    move-result-object p1

    iput-object p1, p0, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->service$delegate:Lr90/g;

    return-void
.end method

.method public static synthetic a(Ly00/e;)Ljava/util/List;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->getDocTypes$lambda-0(Ly00/e;)Ljava/util/List;
...
.method public static final synthetic access$getAppSettingsManager$p(Lorg/xbet/data/identification/datasources/UploadFileDataSource;)Lzi/b;
    .locals 0

    iget-object p0, p0, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->appSettingsManager:Lzi/b;
...
.method private static final getDocTypes$lambda-0(Ly00/e;)Ljava/util/List;
    .locals 0
...
.method private final getService()Lorg/xbet/data/identification/services/IdentificationService;
    ...
    iget-object v0, p0, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->service$delegate:Lr90/g;
...
.method public final getDocTypes()Lv80/v;
    ...
    iget-object v1, p0, Lorg/xbet/data/identification/datasources/UploadFileDataSource;->appSettingsManager:Lzi/b;

    invoke-interface {v1}, Lzi/b;->getLang()Ljava/lang/String;

    move-result-object v1

    invoke-interface {v0, v1}, Lorg/xbet/data/identification/services/IdentificationService;->getDocTypes(Ljava/lang/String;)Lv80/v;
...
.method public final getRemainingDocs()Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final sendDocument(Ljava/lang/String;I)Lv80/v;
    .locals 2
...
.method public final uploadPhoto(Ljava/lang/String;I)Lv80/v;
    .locals 2
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation

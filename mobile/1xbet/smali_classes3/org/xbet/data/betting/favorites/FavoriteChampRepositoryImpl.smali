...
.method public static synthetic a(Ljava/util/List;)Lr90/m;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;->splittedChampsIdIsLive$lambda-11(Ljava/util/List;)Lr90/m;
...
.method public static synthetic d(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lr90/m;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;->isFavorite$lambda-2(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lr90/m;)Lv80/z;
...
.method private static final deleteAllFromList$lambda-8(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lr90/m;)Lv80/d;
    .locals 1
    ...
    invoke-virtual {p0, v0, p1}, Lorg/xbet/onexdatabase/dao/FavoriteChampDao;->deleteAllIfExist(Ljava/util/Set;Ljava/util/Set;)Lv80/b;
...
.method public static synthetic e(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;Ljava/lang/Long;)Lv80/z;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;->insert$lambda-7(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;Ljava/lang/Long;)Lv80/z;
...
.method public static synthetic g(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lr90/m;)Lv80/d;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;->deleteAllFromList$lambda-8(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lr90/m;)Lv80/d;
...
.method private static final insert$lambda-7(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;Ljava/lang/Long;)Lv80/z;
    .locals 4
...
.method private static final isFavorite$lambda-2(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lr90/m;)Lv80/z;
    .locals 1
    ...
    invoke-virtual {p0, v0, p1}, Lorg/xbet/onexdatabase/dao/FavoriteChampDao;->allIfExists(Ljava/util/Set;Ljava/util/Set;)Lv80/v;
...
.method private final splittedChampsIdIsLive(Ljava/util/List;)Lv80/o;
    .locals 1
    ...
    sget-object v0, Lvc0/f;->a:Lvc0/f;
...
.method private static final splittedChampsIdIsLive$lambda-11(Ljava/util/List;)Lr90/m;
    .locals 5
...
.method public all()Lv80/v;
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/FavoriteChampDao;->all()Lv80/v;

    move-result-object v0

    new-instance v1, Lvc0/b;

    invoke-direct {v1, p0}, Lvc0/b;-><init>(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;)V
...
.method public delete(Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;)Lv80/b;
    .locals 1
...
.method public deleteAll()Lv80/b;
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/FavoriteChampDao;->deleteAll()Lv80/b;
...
.method public deleteAllFromList(Ljava/util/List;)Lv80/b;
    ...
    .line 1
    invoke-direct {p0, p1}, Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;->splittedChampsIdIsLive(Ljava/util/List;)Lv80/o;
    ...
    invoke-direct {v0, p0}, Lvc0/d;-><init>(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;)V

    invoke-virtual {p1, v0}, Lv80/o;->t1(Ly80/l;)Lv80/b;
...
.method public getScreenTypeById(J)Lv80/v;
    ...
    invoke-virtual {v0, p1, p2}, Lorg/xbet/onexdatabase/dao/FavoriteChampDao;->getScreenTypeById(J)Lv80/v;
...
.method public insert(Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;)Lv80/v;
    .locals 2
    .param p1    # Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/FavoriteChampDao;->count()Lv80/v;

    move-result-object v0

    .line 2
    new-instance v1, Lvc0/e;

    invoke-direct {v1, p0, p1}, Lvc0/e;-><init>(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;)V
...
.method public isFavorite(Ljava/util/List;)Lv80/v;
    .locals 2
    .param p1    # Ljava/util/List;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    new-instance v1, Lvc0/c;

    invoke-direct {v1, p0}, Lvc0/c;-><init>(Lorg/xbet/data/betting/favorites/FavoriteChampRepositoryImpl;)V
    ...
    invoke-direct {v1, p1}, Lvc0/a;-><init>(Ljava/util/List;)V
...
.method public isFavorite(Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;)Lv80/v;
    .locals 3
    .param p1    # Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, v1, v2, p1}, Lorg/xbet/onexdatabase/dao/FavoriteChampDao;->firstIfExists(JZ)Lv80/v;

    move-result-object p1

    sget-object v0, Lvc0/g;->a:Lvc0/g;
...
.method public observeFavoriteCount()Lv80/o;
    ...
    invoke-virtual {v0}, Lorg/xbet/onexdatabase/dao/FavoriteChampDao;->observeFavoriteCount()Lv80/o;

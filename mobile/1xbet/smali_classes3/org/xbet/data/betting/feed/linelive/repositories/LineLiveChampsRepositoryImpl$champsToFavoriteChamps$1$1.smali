...
# instance fields
.field final synthetic $champ:Ld80/a;


# direct methods
.method constructor <init>(Ld80/a;)V
    .locals 0

    iput-object p1, p0, Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveChampsRepositoryImpl$champsToFavoriteChamps$1$1;->$champ:Ld80/a;
...
.method public final invoke()Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;
    ...
    iget-object v0, p0, Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveChampsRepositoryImpl$champsToFavoriteChamps$1$1;->$champ:Ld80/a;

    invoke-virtual {v0}, Ld80/a;->g()J

    move-result-wide v1

    iget-object v0, p0, Lorg/xbet/data/betting/feed/linelive/repositories/LineLiveChampsRepositoryImpl$champsToFavoriteChamps$1$1;->$champ:Ld80/a;

    invoke-virtual {v0}, Ld80/a;->i()Z

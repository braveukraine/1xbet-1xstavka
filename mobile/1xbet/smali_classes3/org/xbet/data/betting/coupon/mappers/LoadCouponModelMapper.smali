...
# virtual methods
.method public final invoke(Lx70/d$b;)Lorg/xbet/domain/betting/coupon/models/LoadCouponModel;
    .locals 10
    .param p1    # Lx70/d$b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 1
    invoke-virtual {p1}, Lx70/d$b;->a()Z

    move-result v1

    .line 2
    invoke-virtual {p1}, Lx70/d$b;->e()D

    move-result-wide v2

    .line 3
    invoke-virtual {p1}, Lx70/d$b;->c()J

    move-result-wide v4

    .line 4
    invoke-virtual {p1}, Lx70/d$b;->f()I

    move-result v6

    .line 5
    invoke-virtual {p1}, Lx70/d$b;->d()Z

    move-result v7

    .line 6
    invoke-virtual {p1}, Lx70/d$b;->b()Ljava/util/List;
    ...
    .line 9
    check-cast v9, Lx70/d$a;

    .line 10
    invoke-virtual {v0, v9}, Lorg/xbet/data/betting/coupon/mappers/LoadCouponEventModelMapper;->invoke(Lx70/d$a;)Lorg/xbet/domain/betting/coupon/models/LoadCouponEventModel;

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "appSettingsManager",
        "<init>",
        "(Ln40/t;Lcom/xbet/onexuser/domain/user/c;Lzi/b;Lorg/xbet/data/betting/finbet/mappers/BetResultMapper;Lorg/xbet/data/betting/finbet/mappers/FinanceDataMapper;Lorg/xbet/data/betting/finbet/mappers/FinanceInstrumentModelMapper;Lorg/xbet/data/betting/finbet/datasources/FinBetDataSourceRemote;)V",
        "Companion",
        "betting_release"
    }
    k = 0x1
...
.method public constructor <init>(Ln40/t;Lcom/xbet/onexuser/domain/user/c;Lzi/b;Lorg/xbet/data/betting/finbet/mappers/BetResultMapper;Lorg/xbet/data/betting/finbet/mappers/FinanceDataMapper;Lorg/xbet/data/betting/finbet/mappers/FinanceInstrumentModelMapper;Lorg/xbet/data/betting/finbet/datasources/FinBetDataSourceRemote;)V
    .locals 0
    .param p1    # Ln40/t;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->balanceInteractor:Ln40/t;
    ...
    .line 4
    iput-object p3, p0, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->appSettingsManager:Lzi/b;
...
.method public static synthetic a(Lorg/xbet/domain/betting/finbet/models/FinBetRequestModel;Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;Lr90/m;)Lorg/xbet/data/betting/finbet/models/requests/FinanceBetRequest;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->makeQuickBet$lambda-6(Lorg/xbet/domain/betting/finbet/models/FinBetRequestModel;Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;Lr90/m;)Lorg/xbet/data/betting/finbet/models/requests/FinanceBetRequest;
...
.method public static synthetic e(Lc40/b;Lo40/a;)Lr90/m;
    ...
    invoke-static {p0, p1}, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->makeQuickBet$lambda-5(Lc40/b;Lo40/a;)Lr90/m;
...
.method public static synthetic f(Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;Ljava/lang/String;Lorg/xbet/data/betting/finbet/models/requests/FinanceBetRequest;)Lv80/z;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->makeQuickBet$lambda-7(Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;Ljava/lang/String;Lorg/xbet/data/betting/finbet/models/requests/FinanceBetRequest;)Lv80/z;
...
.method private static final makeQuickBet$lambda-5(Lc40/b;Lo40/a;)Lr90/m;
    .locals 0
...
.method private static final makeQuickBet$lambda-6(Lorg/xbet/domain/betting/finbet/models/FinBetRequestModel;Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;Lr90/m;)Lorg/xbet/data/betting/finbet/models/requests/FinanceBetRequest;
    .locals 40
    ...
    .line 2
    invoke-virtual/range {p2 .. p2}, Lr90/m;->c()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lc40/b;

    invoke-virtual {v3}, Lc40/b;->e()J
    ...
    .line 4
    iget-object v1, v0, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->appSettingsManager:Lzi/b;
    ...
    .line 18
    iget-object v0, v0, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->appSettingsManager:Lzi/b;
...
.method private static final makeQuickBet$lambda-7(Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;Ljava/lang/String;Lorg/xbet/data/betting/finbet/models/requests/FinanceBetRequest;)Lv80/z;
    .locals 0
    ...
    invoke-virtual {p0, p1, p2}, Lorg/xbet/data/betting/finbet/datasources/FinBetDataSourceRemote;->requestMakeNewBet(Ljava/lang/String;Lorg/xbet/data/betting/finbet/models/requests/FinanceBetRequest;)Lv80/v;
...
# virtual methods
.method public getFinanceData(IILorg/xbet/domain/betting/finbet/enums/FinancePeriodEnum;I)Lv80/v;
    .locals 6
    ...
    iget-object p3, p0, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->appSettingsManager:Lzi/b;
    ...
    invoke-virtual/range {v0 .. v5}, Lorg/xbet/data/betting/finbet/datasources/FinBetDataSourceRemote;->getFinanceData(IIIILjava/lang/String;)Lv80/v;

    move-result-object p1

    .line 2
    new-instance p2, Lzc0/d;

    invoke-direct {p2, p0}, Lzc0/d;-><init>(Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;)V

    invoke-virtual {p1, p2}, Lv80/v;->G(Ly80/l;)Lv80/v;

    move-result-object p1

    sget-object p2, Lzc0/h;->a:Lzc0/h;
...
.method public getInstruments()Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v1, p0, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->appSettingsManager:Lzi/b;

    invoke-interface {v1}, Lzi/b;->getLang()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lorg/xbet/data/betting/finbet/datasources/FinBetDataSourceRemote;->getFinanceInstruments(Ljava/lang/String;)Lv80/v;
    ...
    invoke-direct {v1, p0}, Lzc0/b;-><init>(Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;)V

    invoke-virtual {v0, v1}, Lv80/v;->G(Ly80/l;)Lv80/v;

    move-result-object v0

    sget-object v1, Lzc0/g;->a:Lzc0/g;
...
.method public makeQuickBet(Ljava/lang/String;Lorg/xbet/domain/betting/finbet/models/FinBetRequestModel;)Lv80/v;
    .locals 3
    ...
    .line 2
    iget-object v1, p0, Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;->balanceInteractor:Ln40/t;
    ...
    invoke-direct {v1, p2, p0}, Lzc0/f;-><init>(Lorg/xbet/domain/betting/finbet/models/FinBetRequestModel;Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;)V
    ...
    invoke-direct {v0, p0, p1}, Lzc0/e;-><init>(Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p0}, Lzc0/c;-><init>(Lorg/xbet/data/betting/finbet/repository/FinBetRepositoryImpl;)V

...
.method public getChampsHistoryResults(Ljava/util/Set;JJLjava/lang/String;II)Lv80/v;
    .locals 11
    ...
    .line 3
    invoke-virtual {v1, v2}, Lorg/xbet/data/betting/results/datasources/ChampsResultsRemoteDataSource;->getChampsHistoryResults(Ljava/util/Map;)Lv80/v;
    ...
    invoke-interface {v2}, Lorg/xbet/domain/betting/repositories/SportRepository;->all()Lv80/v;
    ...
    new-instance v4, Lbd0/a;

    invoke-direct {v4, v3}, Lbd0/a;-><init>(Lorg/xbet/data/betting/results/mappers/ListChampsResultsItemsMapper;)V

    invoke-virtual {v1, v2, v4}, Lv80/v;->l0(Lv80/z;Ly80/c;)Lv80/v;
...
.method public getExpandedGroupIds()Lv80/o;
    ...
    invoke-virtual {v0}, Lorg/xbet/data/betting/results/datasources/ChampsResultsLocalDataSource;->getExpandedGroupIds()Lv80/o;

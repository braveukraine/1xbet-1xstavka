...
# virtual methods
.method public cacheHistoryGames(Ljava/util/List;)Lv80/b;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lbd0/b;-><init>(Lorg/xbet/data/betting/results/repositories/GamesResultsRepositoryImpl;Ljava/util/List;)V
...
.method public getCachedGamesHistoryResults()Lv80/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lorg/xbet/data/betting/results/datasources/GamesResultsLocalDataSource;->getCachedItems()Lv80/o;
...
.method public getExpandedGroupIds()Lv80/o;
    ...
    invoke-virtual {v0}, Lorg/xbet/data/betting/results/datasources/GamesResultsLocalDataSource;->getExpandedGroupIds()Lv80/o;
...
.method public getGamesHistoryResults(Ljava/util/Set;JJLjava/lang/String;II)Lv80/v;
    .locals 11
    ...
    .line 3
    invoke-virtual {v1, v2}, Lorg/xbet/data/betting/results/datasources/GamesResultsRemoteDataSource;->getGamesHistoryResults(Ljava/util/Map;)Lv80/v;

    move-result-object v1

    sget-object v2, Lbd0/d;->a:Lbd0/d;
    ...
    invoke-direct {v3, v2}, Lbd0/c;-><init>(Lorg/xbet/data/betting/results/mappers/ListGamesResultsItemsMapper;)V
...
.method public toggleGroupExpansion(J)V
    ...
    invoke-static {v0, p1}, Lkotlin/collections/p0;->i(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;
    ...
    :cond_0
    invoke-static {v0, p1}, Lkotlin/collections/p0;->k(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;

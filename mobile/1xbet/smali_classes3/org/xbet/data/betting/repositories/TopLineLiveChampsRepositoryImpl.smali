...
.method public static synthetic b(Ljava/util/List;Ljava/util/List;)Lr90/m;
    ...
    invoke-static {p0, p1}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->toPairWithFavoriteFlags$lambda-7$lambda-6$lambda-5(Ljava/util/List;Ljava/util/List;)Lr90/m;
...
.method private final convertToFavoriteChamps(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Ld80/a;->g()J

    move-result-wide v5

    invoke-virtual {v3}, Ld80/a;->i()Z
...
.method public static synthetic f(JZLorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Ljava/lang/Boolean;)Lv80/z;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->updateFavorite$lambda-4(JZLorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Ljava/lang/Boolean;)Lv80/z;
...
.method public static synthetic g(Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Ljava/util/List;)Lv80/r;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->toPairWithFavoriteFlags$lambda-7(Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Ljava/util/List;)Lv80/r;
...
.method public static synthetic h(Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Lr90/m;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->toChampsListBySports$lambda-11(Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Lr90/m;)Lv80/z;
...
.method public static synthetic i(Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Ljava/util/List;Ljava/util/List;Ljava/lang/Long;)Lv80/z;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->toPairWithFavoriteFlags$lambda-7$lambda-6(Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Ljava/util/List;Ljava/util/List;Ljava/lang/Long;)Lv80/z;
...
.method private final toChampsListBySports(Lv80/o;)Lv80/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final toChampsListBySports$lambda-11(Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Lr90/m;)Lv80/z;
    .locals 3
...
.method private static final toPairWithFavoriteFlags$lambda-7(Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Ljava/util/List;)Lv80/r;
    .locals 3
...
.method private static final toPairWithFavoriteFlags$lambda-7$lambda-6(Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Ljava/util/List;Ljava/util/List;Ljava/lang/Long;)Lv80/z;
    .locals 0
...
.method private static final toPairWithFavoriteFlags$lambda-7$lambda-6$lambda-5(Ljava/util/List;Ljava/util/List;)Lr90/m;
    .locals 1
...
.method private static final updateFavorite$lambda-4(JZLorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;Ljava/lang/Boolean;)Lv80/z;
    .locals 8
    ...
    invoke-direct {p3, v7}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->removeFromFavorite(Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;)Lv80/v;
    ...
    invoke-interface {p0, v7}, Lorg/xbet/domain/betting/favorites/FavoriteChampRepository;->insert(Lorg/xbet/domain/betting/favorites/models/FavoriteChamp;)Lv80/v;
...
.method public getCachedTopChamps(Z)Lv80/v;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
...
.method public getLineTopChamps(ILjava/lang/String;)Lv80/o;
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lorg/xbet/data/betting/feed/linelive/datasouces/ChampsLineRemoteDataSource;->getChamps(Ljava/util/Map;)Lv80/v;
    ...
    .line 3
    invoke-virtual {p0, p1}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->extractJsonValue(Lv80/v;)Lv80/v;
    ...
    invoke-virtual {p0, p1, v0, p2}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->toSportZipList(Lv80/v;ZLorg/xbet/data/betting/feed/linelive/mappers/SportsZipMapper;)Lv80/v;

    move-result-object p1

    .line 5
    invoke-direct {p0, p1}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->toPairWithFavoriteFlags(Lv80/v;)Lv80/o;

    move-result-object p1

    .line 6
    invoke-direct {p0, p1}, Lorg/xbet/data/betting/repositories/TopLineLiveChampsRepositoryImpl;->toChampsListBySports(Lv80/o;)Lv80/o;
...
.method public getLiveTopChamps(ILjava/lang/String;)Lv80/o;
    .locals 2
    .param p2    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Lorg/xbet/data/betting/feed/linelive/datasouces/ChampsLiveRemoteDataSource;->getChamps(Ljava/util/Map;)Lv80/v;
...
.method public updateFavorite(JZ)Lv80/v;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JZ)",

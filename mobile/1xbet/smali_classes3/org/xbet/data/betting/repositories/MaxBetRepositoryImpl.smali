...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "serviceGenerator",
        "<init>",
        "(Lorg/xbet/data/betting/mappers/BetEventMapper;Lw00/c;Lui/j;)V",
        "Companion",
        "betting_release"
    }
    k = 0x1
...
.method public constructor <init>(Lorg/xbet/data/betting/mappers/BetEventMapper;Lw00/c;Lui/j;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lorg/xbet/data/betting/repositories/MaxBetRepositoryImpl;->maxBetCacheRepository:Lw00/c;

    .line 4
    new-instance p1, Lorg/xbet/data/betting/repositories/MaxBetRepositoryImpl$service$1;

    invoke-direct {p1, p3}, Lorg/xbet/data/betting/repositories/MaxBetRepositoryImpl$service$1;-><init>(Lui/j;)V

    iput-object p1, p0, Lorg/xbet/data/betting/repositories/MaxBetRepositoryImpl;->service:Lz90/a;

    return-void
.end method

.method public static synthetic a(Ljava/lang/Throwable;)Lv80/z;
    .locals 0

    invoke-static {p0}, Lorg/xbet/data/betting/repositories/MaxBetRepositoryImpl;->getMaxBet$lambda-0(Ljava/lang/Throwable;)Lv80/z;
...
.method private static final getMaxBet$lambda-0(Ljava/lang/Throwable;)Lv80/z;
    .locals 3
...
.method public clearCache()V
    ...
    iget-object v0, p0, Lorg/xbet/data/betting/repositories/MaxBetRepositoryImpl;->maxBetCacheRepository:Lw00/c;
...
.method public getMaxBet(Ljava/lang/String;JJLjava/util/List;)Lv80/v;
    .locals 7
    ...
    .line 5
    invoke-virtual {v0, v1}, Lorg/xbet/data/betting/mappers/BetEventMapper;->invoke(Lp40/a;)Lorg/xbet/data/betting/models/responses/BetEvent;
    ...
    .line 6
    iget-object p2, p0, Lorg/xbet/data/betting/repositories/MaxBetRepositoryImpl;->maxBetCacheRepository:Lw00/c;
    ...
    .line 8
    iget-object p4, p0, Lorg/xbet/data/betting/repositories/MaxBetRepositoryImpl;->service:Lz90/a;
    ...
    invoke-interface {p4, p1, p6}, Lorg/xbet/data/betting/services/BetService;->getMaxBet(Ljava/lang/String;Lorg/xbet/data/betting/models/requests/MaxBetRequest;)Lv80/v;
    ...
    .line 9
    invoke-virtual {p1, p4}, Lv80/v;->J(Ly80/l;)Lv80/v;

    move-result-object p1

    .line 10
    invoke-virtual {p2, p3, p1}, Lw00/c;->d(ILv80/v;)Lv80/v;

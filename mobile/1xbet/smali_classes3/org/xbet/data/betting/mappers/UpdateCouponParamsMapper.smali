...
.method public final invoke(Lorg/xbet/data/betting/models/requests/UpdateCouponRequest;)Lorg/xbet/domain/betting/models/UpdateCouponParams;
    ...
    .line 1
    invoke-virtual/range {p1 .. p1}, Ld30/c;->getUserId()J

    move-result-wide v1

    .line 2
    invoke-virtual/range {p1 .. p1}, Ld30/c;->getUserBonusId()J

    move-result-wide v3

    .line 3
    invoke-virtual/range {p1 .. p1}, Ld30/c;->getAppGUID()Ljava/lang/String;

    move-result-object v5

    .line 4
    invoke-virtual/range {p1 .. p1}, Ld30/c;->getLanguage()Ljava/lang/String;
    ...
    .line 17
    invoke-virtual {v15, v14}, Lorg/xbet/data/betting/mappers/BetEventModelMapper;->invoke(Lorg/xbet/data/betting/models/responses/BetEvent;)Lp40/a;

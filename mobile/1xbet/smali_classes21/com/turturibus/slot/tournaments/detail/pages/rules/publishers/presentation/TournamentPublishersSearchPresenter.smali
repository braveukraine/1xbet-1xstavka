...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "errorHandler",
        "<init>",
        "(Ltd/l;Ls10/h;Li10/a;Lcom/xbet/onexuser/domain/user/c;JJJLn40/t;Ln40/m0;Lorg/xbet/ui_common/router/BaseOneXRouter;Lorg/xbet/ui_common/utils/ErrorHandler;)V",
        "ui_slots_release"
    }
    k = 0x1
    mv = {
...
# instance fields
.field private final j:Ltd/l;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final k:Ls10/h;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final l:Li10/a;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Ltd/l;Ls10/h;Li10/a;Lcom/xbet/onexuser/domain/user/c;JJJLn40/t;Ln40/m0;Lorg/xbet/ui_common/router/BaseOneXRouter;Lorg/xbet/ui_common/utils/ErrorHandler;)V
    .locals 11
    .param p1    # Ltd/l;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object v0, v10, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->j:Ltd/l;

    move-object v0, p2

    .line 3
    iput-object v0, v10, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->k:Ls10/h;

    move-object v0, p3

    .line 4
    iput-object v0, v10, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->l:Li10/a;

    move-object v0, p4

    .line 5
    iput-object v0, v10, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->m:Lcom/xbet/onexuser/domain/user/c;

    move-wide/from16 v0, p5

    .line 6
    iput-wide v0, v10, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->n:J

    move-wide/from16 v0, p9

    .line 7
    iput-wide v0, v10, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->o:J
    ...
    iput-object v0, v10, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->p:Ljava/lang/String;
    ...
    iput-object v0, v10, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->q:Ljava/util/List;
...
.method public static synthetic O(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;Lj20/a;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->c0(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;Lj20/a;)V
...
.method public static synthetic Q(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;Ljava/lang/String;Lv10/a;)Lv80/z;
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->b0(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;Ljava/lang/String;Lv10/a;)Lv80/z;
...
.method private static final T(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;Ljava/lang/Boolean;)V
    ...
    invoke-interface {p0, p1}, Lcom/turturibus/slot/gamesbycategory/ui/view/AggregatorGamesView;->Ae(Z)V
...
.method private final U()V
    ...
    .line 1
    iget-object v0, p0, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->l:Li10/a;
    ...
    invoke-direct {v1, p0}, Lzd/h;-><init>(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;)V

    .line 4
    new-instance v2, Lzd/g;

    invoke-direct {v2, p0}, Lzd/g;-><init>(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;)V
...
.method private final Z(Ljava/util/List;)V
    ...
    invoke-interface {v0, p1}, Lcom/turturibus/slot/available/publishers/views/AvailablePublishersView;->nd(Z)V
...
.method private final a0(Ljava/lang/String;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->k:Ls10/h;
    ...
    invoke-direct {v1, p0, p1}, Lzd/i;-><init>(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0}, Lzd/d;-><init>(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;)V

    .line 6
    new-instance v1, Lzd/g;

    invoke-direct {v1, p0}, Lzd/g;-><init>(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;)V
...
.method private static final b0(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;Ljava/lang/String;Lv10/a;)Lv80/z;
    .locals 2
    ...
    .line 2
    iget-object p2, p0, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;->j:Ltd/l;
    ...
    invoke-virtual {p2, v0, v1, p1}, Ltd/l;->M(JLjava/lang/String;)Lv80/v;
...
.method private static final c0(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;Lj20/a;)V
    .locals 2
...
.method private final checkAuth()V
    ...
    invoke-direct {v1, p0}, Lzd/e;-><init>(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;)V

    .line 5
    new-instance v2, Lzd/f;

    invoke-direct {v2, p0}, Lzd/f;-><init>(Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchPresenter;)V
...
.method public final W(Lw40/a;)V
    .locals 4
    .param p1    # Lw40/a;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {v0, v1, v2, v3}, Lcom/turturibus/slot/tournaments/detail/pages/rules/publishers/presentation/TournamentPublishersSearchView;->B(Lcom/turturibus/slot/b;J)V

    return-void
.end method

.method public final X(JLk10/g;)V
    .locals 13
    .param p3    # Lk10/g;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation

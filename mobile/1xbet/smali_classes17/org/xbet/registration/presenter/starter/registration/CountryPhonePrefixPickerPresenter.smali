...
# instance fields
.field private final countryCodeInteractor:Lg00/g;
...
# direct methods
.method public constructor <init>(Lg00/g;)V
    .locals 0
    .param p1    # Lg00/g;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/registration/presenter/starter/registration/CountryPhonePrefixPickerPresenter;->countryCodeInteractor:Lg00/g;

    return-void
.end method

.method public static synthetic a(Lorg/xbet/registration/presenter/starter/registration/CountryPhonePrefixPickerPresenter;Ljava/util/List;Ld50/a;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/registration/presenter/starter/registration/CountryPhonePrefixPickerPresenter;->onCountryAddedManually$lambda-1(Lorg/xbet/registration/presenter/starter/registration/CountryPhonePrefixPickerPresenter;Ljava/util/List;Ld50/a;)V

    return-void
.end method

.method private static final onCountryAddedManually$lambda-1(Lorg/xbet/registration/presenter/starter/registration/CountryPhonePrefixPickerPresenter;Ljava/util/List;Ld50/a;)V
    .locals 16

    .line 1
    invoke-static/range {p2 .. p2}, Ld50/b;->a(Ld50/a;)Z
    ...
    invoke-virtual/range {p2 .. p2}, Ld50/a;->d()J
    ...
    invoke-static/range {v4 .. v15}, Ld50/a;->b(Ld50/a;JLjava/lang/String;ZLd50/c;ZZLjava/lang/String;ZILjava/lang/Object;)Ld50/a;

    move-result-object v1

    invoke-interface {v0, v1}, Lorg/xbet/registration/registration/view/starter/registration/CountryPhonePrefixPickerView;->selectCountry(Ld50/a;)V
...
.method public final onCountryAddedManually(Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 4
    :cond_1
    iget-object v0, p0, Lorg/xbet/registration/presenter/starter/registration/CountryPhonePrefixPickerPresenter;->countryCodeInteractor:Lg00/g;

    invoke-virtual {v0, p1}, Lg00/g;->g(Ljava/lang/String;)Lv80/v;
...
.method public final search(Ljava/util/List;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lg00/g;->i(Ljava/util/List;Ljava/lang/String;)Lv80/v;

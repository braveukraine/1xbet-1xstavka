...
.field private final downloadingDisposable:Lx80/b;
...
.method public constructor <init>(Lcom/insystem/testsupplib/network/ws/base/RequestSender;Lcom/insystem/testsupplib/network/rest/Api;Ljava/lang/String;Lcom/insystem/testsupplib/data/Models;)V
    ...
    iput-object p1, p0, Lcom/insystem/testsupplib/network/ws/service/MainService;->downloadingDisposable:Lx80/b;
...
.method public static synthetic j(Lcom/insystem/testsupplib/network/ws/service/MainService;Lx80/c;Lcom/insystem/testsupplib/data/models/storage/result/FileUrlExtended;Lcom/insystem/testsupplib/network/ws/files/FileState;Lcom/google/gson/JsonObject;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/insystem/testsupplib/network/ws/service/MainService;->lambda$onTrackedResponse$1(Lx80/c;Lcom/insystem/testsupplib/data/models/storage/result/FileUrlExtended;Lcom/insystem/testsupplib/network/ws/files/FileState;Lcom/google/gson/JsonObject;)V
...
.method private synthetic lambda$onTrackedResponse$1(Lx80/c;Lcom/insystem/testsupplib/data/models/storage/result/FileUrlExtended;Lcom/insystem/testsupplib/network/ws/files/FileState;Lcom/google/gson/JsonObject;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private saveFileToDisk(Ljava/io/File;Lcom/insystem/testsupplib/data/models/storage/result/FileLink;Lokhttp3/e0;)Ljava/io/File;
    ...
    .line 18
    invoke-interface {v7}, Lx80/c;->e()Z
    ...
    .line 19
    iget-object v8, v1, Lcom/insystem/testsupplib/network/ws/service/MainService;->downloadingDisposable:Lx80/b;

    invoke-virtual {v8, v7}, Lx80/b;->b(Lx80/c;)Z
...
.method public onTrackedResponse(Lcom/insystem/testsupplib/data/models/storage/result/FileLink;)V
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/insystem/testsupplib/network/rest/Api;->downloadFile(Ljava/lang/String;JJ)Lv80/k;
    ...
    invoke-virtual {v0, v2}, Lv80/k;->u(Lv80/u;)Lv80/k;
    ...
    .line 22
    invoke-virtual {v0, v2}, Lv80/k;->n(Ly80/l;)Lv80/k;
    ...
    invoke-virtual {v0, v1}, Lv80/k;->o(Lv80/u;)Lv80/k;
    ...
    .line 26
    iget-object p1, p0, Lcom/insystem/testsupplib/network/ws/service/MainService;->downloadingDisposable:Lx80/b;
...
.method public onTrackedResponse(Lcom/insystem/testsupplib/data/models/storage/result/FileUrlExtended;)V
    ...
    invoke-virtual {v1, v2}, Lv80/f;->X(Lv80/u;)Lv80/f;
    ...
    sget-object v4, Lcom/insystem/testsupplib/network/ws/d;->a:Lcom/insystem/testsupplib/network/ws/d;

    .line 9
    invoke-virtual {v2, v3, v4}, Lv80/f;->T(Ly80/g;Ly80/g;)Lx80/c;

    move-result-object v2

    .line 10
    iget-object v3, p0, Lcom/insystem/testsupplib/network/ws/service/CompoundService;->subscriptions:Lx80/b;
    ...
    invoke-virtual {v4, v5, v6, v1}, Lcom/insystem/testsupplib/network/rest/Api;->uploadFile(Ljava/lang/String;Ljava/io/File;Lio/reactivex/processors/b;)Lv80/k;
    ...
    invoke-virtual {v1, v4}, Lv80/k;->u(Lv80/u;)Lv80/k;

    move-result-object v1

    new-instance v4, Lcom/insystem/testsupplib/network/ws/service/b;

    invoke-direct {v4, p0, v2, p1, v0}, Lcom/insystem/testsupplib/network/ws/service/b;-><init>(Lcom/insystem/testsupplib/network/ws/service/MainService;Lx80/c;Lcom/insystem/testsupplib/data/models/storage/result/FileUrlExtended;Lcom/insystem/testsupplib/network/ws/files/FileState;)V

    sget-object p1, Lcom/insystem/testsupplib/network/ws/d;->a:Lcom/insystem/testsupplib/network/ws/d;

    .line 12
    invoke-virtual {v1, v4, p1}, Lv80/k;->r(Ly80/g;Ly80/g;)Lx80/c;

    move-result-object p1

    .line 13
    invoke-virtual {v3, p1}, Lx80/b;->c(Lx80/c;)Z

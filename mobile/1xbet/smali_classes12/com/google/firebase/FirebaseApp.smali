...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/FirebaseOptions;)V
    ...
    .line 10
    invoke-static {p1, p2}, Lcom/google/firebase/components/ComponentDiscovery;->c(Landroid/content/Context;Ljava/lang/Class;)Lcom/google/firebase/components/ComponentDiscovery;

    move-result-object p2

    .line 11
    invoke-virtual {p2}, Lcom/google/firebase/components/ComponentDiscovery;->b()Ljava/util/List;

    move-result-object p2

    .line 12
    sget-object v0, Lcom/google/firebase/FirebaseApp;->k:Ljava/util/concurrent/Executor;

    .line 13
    invoke-static {v0}, Lcom/google/firebase/components/ComponentRuntime;->i(Ljava/util/concurrent/Executor;)Lcom/google/firebase/components/ComponentRuntime$Builder;

    move-result-object v0

    .line 14
    invoke-virtual {v0, p2}, Lcom/google/firebase/components/ComponentRuntime$Builder;->d(Ljava/util/Collection;)Lcom/google/firebase/components/ComponentRuntime$Builder;
    ...
    .line 15
    invoke-virtual {p2, v0}, Lcom/google/firebase/components/ComponentRuntime$Builder;->c(Lcom/google/firebase/components/ComponentRegistrar;)Lcom/google/firebase/components/ComponentRuntime$Builder;
    ...
    .line 16
    invoke-static {p1, v0, v2}, Lcom/google/firebase/components/Component;->p(Ljava/lang/Object;Ljava/lang/Class;[Ljava/lang/Class;)Lcom/google/firebase/components/Component;

    move-result-object v0

    invoke-virtual {p2, v0}, Lcom/google/firebase/components/ComponentRuntime$Builder;->b(Lcom/google/firebase/components/Component;)Lcom/google/firebase/components/ComponentRuntime$Builder;
    ...
    .line 17
    invoke-static {p0, v0, v2}, Lcom/google/firebase/components/Component;->p(Ljava/lang/Object;Ljava/lang/Class;[Ljava/lang/Class;)Lcom/google/firebase/components/Component;
    ...
    .line 18
    invoke-static {p3, v0, v1}, Lcom/google/firebase/components/Component;->p(Ljava/lang/Object;Ljava/lang/Class;[Ljava/lang/Class;)Lcom/google/firebase/components/Component;

    move-result-object p3

    invoke-virtual {p2, p3}, Lcom/google/firebase/components/ComponentRuntime$Builder;->b(Lcom/google/firebase/components/Component;)Lcom/google/firebase/components/ComponentRuntime$Builder;

    move-result-object p2

    .line 19
    invoke-virtual {p2}, Lcom/google/firebase/components/ComponentRuntime$Builder;->e()Lcom/google/firebase/components/ComponentRuntime;
...
.method public static synthetic a(Lcom/google/firebase/FirebaseApp;Landroid/content/Context;)Lcom/google/firebase/internal/DataCollectionConfigStorage;
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/FirebaseApp;->s(Landroid/content/Context;)Lcom/google/firebase/internal/DataCollectionConfigStorage;
...
.method static synthetic c(Lcom/google/firebase/FirebaseApp;)V
    ...
    invoke-direct {p0}, Lcom/google/firebase/FirebaseApp;->m()V
...
.method static synthetic e(Lcom/google/firebase/FirebaseApp;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/FirebaseApp;->u(Z)V
...
.method public static i()Lcom/google/firebase/FirebaseApp;
    .locals 4
...
.method private m()V
    ...
    invoke-virtual {p0}, Lcom/google/firebase/FirebaseApp;->r()Z

    move-result v1

    invoke-virtual {v0, v1}, Lcom/google/firebase/components/ComponentRuntime;->l(Z)V

    :goto_0
    return-void
.end method

.method public static n(Landroid/content/Context;)Lcom/google/firebase/FirebaseApp;
    .locals 3
    ...
    .line 7
    :cond_1
    invoke-static {p0, v1}, Lcom/google/firebase/FirebaseApp;->o(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;)Lcom/google/firebase/FirebaseApp;
...
.method public static o(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;)Lcom/google/firebase/FirebaseApp;
    .locals 1

    const-string v0, "[DEFAULT]"

    invoke-static {p0, p1, v0}, Lcom/google/firebase/FirebaseApp;->p(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
...
.method public static p(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
    .locals 5
    ...
    .line 2
    invoke-static {p2}, Lcom/google/firebase/FirebaseApp;->t(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 8
    invoke-static {v2, v3}, Lcom/google/android/gms/common/internal/Preconditions;->o(ZLjava/lang/Object;)V
    ...
    .line 13
    invoke-direct {v2}, Lcom/google/firebase/FirebaseApp;->m()V
...
.method private synthetic s(Landroid/content/Context;)Lcom/google/firebase/internal/DataCollectionConfigStorage;
    .locals 4
...
.method public k()Lcom/google/firebase/FirebaseOptions;
    .locals 1

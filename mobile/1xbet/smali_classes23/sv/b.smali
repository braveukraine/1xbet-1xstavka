...
.method public constructor <init>(Lrm/b;Lzi/b;)V
    ...
    .line 2
    iput-object p2, p0, Lsv/b;->a:Lzi/b;

    .line 3
    new-instance p2, Lsv/b$a;

    invoke-direct {p2, p1}, Lsv/b$a;-><init>(Lrm/b;)V

    invoke-static {p2}, Lr90/h;->b(Lz90/a;)Lr90/g;

    move-result-object p1

    iput-object p1, p0, Lsv/b;->b:Lr90/g;
...
.method private final b()Lcom/xbet/onexgames/features/scratchlottery/services/ScratchLotteryApiService;
    ...
    iget-object v0, p0, Lsv/b;->b:Lr90/g;
...
.method public final a(Ljava/lang/String;)Lv80/v;
    ...
    .line 1
    invoke-direct {p0}, Lsv/b;->b()Lcom/xbet/onexgames/features/scratchlottery/services/ScratchLotteryApiService;

    move-result-object v0

    new-instance v1, Lxb/e;

    iget-object v2, p0, Lsv/b;->a:Lzi/b;

    invoke-interface {v2}, Lzi/b;->getLang()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lsv/b;->a:Lzi/b;
    ...
    invoke-interface {v0, p1, v1}, Lcom/xbet/onexgames/features/scratchlottery/services/ScratchLotteryApiService;->getCurrentGame(Ljava/lang/String;Lxb/e;)Lv80/v;
...
.method public final c(Ljava/lang/String;ILtv/b$a;)Lv80/v;
    .locals 10
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    invoke-virtual {p3}, Ltv/b$a;->d()I

    move-result v3

    .line 3
    invoke-virtual {p3}, Ltv/b$a;->e()Ljava/lang/String;

    move-result-object v5

    .line 4
    iget-object p3, p0, Lsv/b;->a:Lzi/b;
    ...
    .line 7
    invoke-interface {v0, p1, p3}, Lcom/xbet/onexgames/features/scratchlottery/services/ScratchLotteryApiService;->makeAction(Ljava/lang/String;Lxb/a;)Lv80/v;

    move-result-object p1

    sget-object p2, Lsv/a;->a:Lsv/a;
...
.method public final d(Ljava/lang/String;JFLorg/xbet/core/data/GameBonus;)Lv80/v;
    .locals 15
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 5
    iget-object v2, v0, Lsv/b;->a:Lzi/b;
    ...
    .line 7
    invoke-direct/range {v2 .. v13}, Ltv/a;-><init>(IFJLorg/xbet/core/data/LuckyWheelBonusType;JLjava/lang/String;IILkotlin/jvm/internal/h;)V

    move-object/from16 v2, p1

    .line 8
    invoke-interface {v1, v2, v14}, Lcom/xbet/onexgames/features/scratchlottery/services/ScratchLotteryApiService;->createGame(Ljava/lang/String;Ltv/a;)Lv80/v;

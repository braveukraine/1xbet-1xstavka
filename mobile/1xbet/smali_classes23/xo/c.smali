...
.method public constructor <init>(Lrm/b;Lzi/b;)V
    ...
    .line 2
    iput-object p2, p0, Lxo/c;->a:Lzi/b;

    .line 3
    new-instance p2, Lxo/c$a;

    invoke-direct {p2, p1}, Lxo/c$a;-><init>(Lrm/b;)V

    iput-object p2, p0, Lxo/c;->b:Lz90/a;
...
# virtual methods
.method public final a(Ljava/lang/String;IJFLorg/xbet/core/data/GameBonus;Lu40/b;)Lv80/v;
    .locals 15
    ...
    .line 1
    iget-object v1, v0, Lxo/c;->b:Lz90/a;
    ...
    .line 2
    invoke-virtual/range {p7 .. p7}, Lu40/b;->e()I
    ...
    .line 5
    iget-object v2, v0, Lxo/c;->a:Lzi/b;
    ...
    .line 8
    invoke-interface {v1, v3, v2}, Lcom/xbet/onexgames/features/chests/common/services/ChestsApiService;->startPlay(Ljava/lang/String;Lxb/c;)Lv80/v;

    move-result-object v1

    sget-object v2, Lxo/a;->a:Lxo/a;

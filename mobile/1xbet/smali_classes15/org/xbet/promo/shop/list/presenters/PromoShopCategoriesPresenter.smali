...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "errorHandler",
        "<init>",
        "(Lx7/q;Ljg/a;Ln40/t;Lorg/xbet/ui_common/router/navigation/SettingsScreenProvider;Lorg/xbet/ui_common/router/BaseOneXRouter;Lorg/xbet/ui_common/utils/internet/ConnectionObserver;Lorg/xbet/ui_common/utils/ErrorHandler;)V",
        "Companion",
        "promo_release"
    }
    k = 0x1
...
.method public constructor <init>(Lx7/q;Ljg/a;Ln40/t;Lorg/xbet/ui_common/router/navigation/SettingsScreenProvider;Lorg/xbet/ui_common/router/BaseOneXRouter;Lorg/xbet/ui_common/utils/internet/ConnectionObserver;Lorg/xbet/ui_common/utils/ErrorHandler;)V
    .locals 0
    .param p1    # Lx7/q;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->promoShopInteractor:Lx7/q;

    .line 3
    iput-object p2, p0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->configInteractor:Ljg/a;

    .line 4
    iput-object p3, p0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->balanceInteractor:Ln40/t;
    ...
    .line 6
    iput-object p5, p0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->router:Lorg/xbet/ui_common/router/BaseOneXRouter;
...
.method public static synthetic b(Ljava/util/List;Lo40/a;)Lr90/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->updateData$lambda-1(Ljava/util/List;Lo40/a;)Lr90/m;
...
.method public static synthetic c(Lea0/k;Lo40/a;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->updateBalance$lambda-0(Lea0/k;Lo40/a;)Ljava/lang/Integer;
...
.method public static synthetic d(Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;Ly7/b;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->onRequestBonusClick$lambda-3(Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;Ly7/b;)V
...
.method public static synthetic g(Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;Lr90/m;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->updateData$lambda-2(Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;Lr90/m;)V
...
.method private static final onRequestBonusClick$lambda-3(Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;Ly7/b;)V
    .locals 2
    ...
    invoke-interface {p0, p1}, Lorg/xbet/promo/shop/list/views/PromoShopCategoriesView;->showBonusResultDialog(Ly7/b;)V
...
.method private final updateBalance()V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->balanceInteractor:Ln40/t;
    ...
    invoke-direct {v2, v1}, Lorg/xbet/promo/shop/list/presenters/g;-><init>(Lea0/k;)V
...
.method private static final updateBalance$lambda-0(Lea0/k;Lo40/a;)Ljava/lang/Integer;
    .locals 0
...
.method private static final updateData$lambda-1(Ljava/util/List;Lo40/a;)Lr90/m;
    .locals 0

    invoke-virtual {p1}, Lo40/a;->p()I
...
.method private static final updateData$lambda-2(Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;Lr90/m;)V
    .locals 2
...
.method public final onCategoryClick(Ly7/j;)V
    .locals 4
    .param p1    # Ly7/j;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->router:Lorg/xbet/ui_common/router/BaseOneXRouter;
...
.method protected onFirstViewAttach()V
    ...
    .line 4
    iget-object v1, p0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->configInteractor:Ljg/a;

    invoke-virtual {v1}, Ljg/a;->b()Lkg/b;

    move-result-object v1

    invoke-virtual {v1}, Lkg/b;->a0()Z
...
.method public final onPromoClick(Ly7/l;)V
    .locals 10
    .param p1    # Ly7/l;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public final onRequestBonusClick()V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->promoShopInteractor:Lx7/q;

    invoke-virtual {v0}, Lx7/q;->r()Lv80/v;
...
.method public updateData()V
    ...
    .line 1
    iget-object v1, v0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->promoShopInteractor:Lx7/q;

    invoke-virtual {v1}, Lx7/q;->l()Lv80/v;

    move-result-object v1

    .line 2
    iget-object v2, v0, Lorg/xbet/promo/shop/list/presenters/PromoShopCategoriesPresenter;->balanceInteractor:Ln40/t;

    invoke-virtual {v2}, Ln40/t;->T()Lv80/v;

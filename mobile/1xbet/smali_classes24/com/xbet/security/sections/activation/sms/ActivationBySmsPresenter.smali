...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "errorHandler",
        "<init>",
        "(Lx50/f;Lc50/g;Lorg/xbet/ui_common/router/navigation/SettingsScreenProvider;Lorg/xbet/ui_common/router/AppScreensProvider;Lcom/xbet/onexcore/utils/c;Lorg/xbet/ui_common/router/NavBarRouter;Lv20/b;Ls50/c;Ljg/a;Lorg/xbet/ui_common/router/BaseOneXRouter;Lorg/xbet/ui_common/utils/ErrorHandler;)V",
        "p",
        "a",
        "security_release"
    }
...
# static fields
.field public static final p:Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter$a;
...
.field private final g:Lv20/b;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final h:Lkg/b;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->p:Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter$a;

    return-void
.end method

.method public constructor <init>(Lx50/f;Lc50/g;Lorg/xbet/ui_common/router/navigation/SettingsScreenProvider;Lorg/xbet/ui_common/router/AppScreensProvider;Lcom/xbet/onexcore/utils/c;Lorg/xbet/ui_common/router/NavBarRouter;Lv20/b;Ls50/c;Ljg/a;Lorg/xbet/ui_common/router/BaseOneXRouter;Lorg/xbet/ui_common/utils/ErrorHandler;)V
    .locals 0
    .param p1    # Lx50/f;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->a:Lx50/f;

    .line 3
    iput-object p2, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->b:Lc50/g;
    ...
    .line 8
    iput-object p7, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->g:Lv20/b;

    .line 9
    invoke-virtual {p9}, Ljg/a;->b()Lkg/b;

    move-result-object p1

    iput-object p1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->h:Lkg/b;
    ...
    iput-object p1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->i:Lz30/a;
    ...
    .line 13
    invoke-virtual {p8}, Ls50/c;->c()Ljava/lang/String;
    ...
    .line 14
    invoke-virtual {p8}, Ls50/c;->d()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->m:Ljava/lang/String;

    .line 15
    invoke-virtual {p8}, Ls50/c;->b()Lv20/c;

    move-result-object p1

    iput-object p1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->n:Lv20/c;
...
.method private final B(Z)V
    ...
    .line 1
    iget-object v0, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->a:Lx50/f;

    invoke-interface {v0, p1}, Lx50/f;->migrateAuthenticator(Z)Lv80/b;
...
.method private static final C(ZLcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;)V
    ...
    .line 1
    invoke-virtual {p1}, Lorg/xbet/security_core/BaseSecurityPresenter;->getRouter()Lorg/xbet/ui_common/router/BaseOneXRouter;
    ...
    invoke-virtual {p0, v2, v0}, Lorg/xbet/ui_common/router/NavBarRouter;->clearStackAndSetScreen(Lorg/xbet/ui_common/router/NavBarScreenTypes;Lz90/l;)V
...
.method private final G(Lx20/a;J)V
    .locals 1

    .line 1
    instance-of v0, p1, Lx20/c;
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->Z(Lx20/c;J)V

    goto :goto_0

    .line 3
    :cond_0
    instance-of v0, p1, Lx20/g;

    if-eqz v0, :cond_1

    .line 4
    check-cast p1, Lx20/g;

    invoke-direct {p0, p1}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->d0(Lx20/g;)V

    goto :goto_0

    .line 5
    :cond_1
    instance-of v0, p1, Lx20/b;
    ...
    invoke-direct {p0, p1}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->Y(Lx20/b;)V
    ...
    invoke-direct {p0, p1}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->b0(Lx20/e;)V

    goto :goto_0

    .line 9
    :cond_3
    instance-of v0, p1, Lx20/d;
    ...
    invoke-direct {p0, p1}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->a0(Lx20/d;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->c0(Lx20/f;J)V
...
.method private final H()V
    ...
    invoke-interface {v0}, Lx50/f;->registerAuthenticator()Lv80/b;
...
.method private final J()V
    ...
    invoke-interface {v0}, Lx50/f;->resendRegistrationSms()Lv80/b;
...
.method private static final K(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;)V
    ...
    invoke-interface {v0, p0, v1}, Lcom/xbet/security/sections/activation/sms/ActivatePhoneView;->ah(Ljava/lang/String;I)V
...
.method private final L()V
    ...
    iget-object v1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->i:Lz30/a;
    ...
    :goto_0
    invoke-interface {v0, v1, v2}, Lx50/f;->smsSendCode(Lz30/a;Z)Lv80/v;
...
.method private static final M(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
    .locals 0
...
.method private static final N(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
    .locals 2
    ...
    invoke-interface {v0, v1, p1}, Lcom/xbet/security/sections/activation/sms/ActivatePhoneView;->ah(Ljava/lang/String;I)V

    const/4 p1, 0x1

    .line 2
    iput-boolean p1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->o:Z
...
.method private static final Q(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lx20/a;)V
    .locals 0

    iget-object p0, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->b:Lc50/g;
...
.method private static final R(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;JLx20/a;)V
    .locals 2
    ...
    .line 2
    invoke-direct {p0, p3, p1, p2}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->G(Lx20/a;J)V
...
.method private static final V(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
    .locals 0
...
.method private static final W(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
    .locals 2
...
.method private final Y(Lx20/b;)V
    .locals 2
    ...
    .line 2
    invoke-virtual {p1}, Lx20/b;->a()Ljava/lang/String;
...
.method private final Z(Lx20/c;J)V
    .locals 3

    .line 1
    iget-object v0, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->a:Lx50/f;

    invoke-virtual {p1}, Lx20/c;->a()Ljava/util/List;

    move-result-object v1

    invoke-interface {v0, v1}, Lx50/f;->putAnswerTypes(Ljava/util/List;)V
    ...
    .line 4
    invoke-virtual {p1}, Lx20/c;->c()Ljava/lang/String;

    move-result-object v2

    .line 5
    invoke-virtual {p1}, Lx20/c;->b()Lz30/a;

    move-result-object p1

    .line 6
    invoke-interface {v1, v2, p1, p2, p3}, Lorg/xbet/ui_common/router/navigation/SettingsScreenProvider;->questionFragmentScreen(Ljava/lang/String;Lz30/a;J)Lcom/github/terrakok/cicerone/q;
...
.method private final a0(Lx20/d;)V
    .locals 4
    ...
    invoke-virtual {p1}, Lx20/d;->b()J

    move-result-wide v1

    invoke-virtual {p1}, Lx20/d;->a()Ljava/lang/String;

    move-result-object p1

    iget-object v3, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->l:Ljava/lang/String;

    invoke-interface {v0, v1, v2, p1, v3}, Lcom/xbet/security/sections/activation/sms/ActivatePhoneView;->Y7(JLjava/lang/String;Ljava/lang/String;)V
...
.method private final b0(Lx20/e;)V
    .locals 2
    ...
    .line 2
    invoke-virtual {p1}, Lx20/e;->a()Ljava/lang/String;
...
.method private final c0(Lx20/f;J)V
    .locals 9
    ...
    .line 6
    iget-object v5, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->m:Ljava/lang/String;
    ...
    .line 8
    invoke-interface/range {v1 .. v8}, Lorg/xbet/ui_common/router/navigation/SettingsScreenProvider;->activationBySmsFragmentScreenByTime(Lz30/a;ILjava/lang/String;Ljava/lang/String;JZ)Lcom/github/terrakok/cicerone/q;
...
.method public static synthetic d(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lx20/a;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->Q(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lx20/a;)V

    return-void
.end method

.method private final d0(Lx20/g;)V
    .locals 4
    ...
    .line 2
    invoke-virtual {p1}, Lx20/g;->b()Lw30/a;

    move-result-object v1

    .line 3
    iget-object v2, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->h:Lkg/b;

    invoke-virtual {v2}, Lkg/b;->L0()Z

    move-result v2

    .line 4
    invoke-virtual {p1}, Lx20/g;->a()Ljava/lang/String;

    move-result-object v3

    .line 5
    invoke-interface {v0, v1, v2, v3}, Lcom/xbet/security/sections/activation/sms/ActivatePhoneView;->v7(Lw30/a;ZLjava/lang/String;)V
...
.method public static synthetic e(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->V(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
...
.method public static synthetic h(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->W(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
...
.method public static synthetic k(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->M(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
...
.method public static synthetic n(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;JLx20/a;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->R(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;JLx20/a;)V

    return-void
.end method

.method public static synthetic o(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->N(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;Lb30/b;)V
...
.method private final s(Ljava/lang/String;)V
    ...
    .line 2
    :cond_1
    iget-object p1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->g:Lv20/b;
...
.method private static final w(Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;ZLjava/lang/String;)V
    ...
    invoke-interface {p2, v0, v1}, Lcom/xbet/security/sections/activation/sms/ActivatePhoneView;->I7(Ljava/lang/String;Z)V
...
.method private final z(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, v2, v1}, Lorg/xbet/ui_common/router/NavBarRouter;->clearStackAndSetScreen(Lorg/xbet/ui_common/router/NavBarScreenTypes;Lz90/l;)V
...
.method public final P(Ljava/lang/String;J)V
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->a:Lx50/f;
    ...
    :goto_0
    invoke-interface {v1, p1, v0}, Lx50/f;->checkSmsCode(Ljava/lang/String;Z)Lv80/v;
    ...
    .line 5
    invoke-interface {v0, p1, v1}, Lx50/f;->checkSmsCode(Ljava/lang/String;Lz30/a;)Lv80/v;
    ...
    .line 7
    invoke-virtual {p1, v0, v1, v2}, Lv80/v;->j(JLjava/util/concurrent/TimeUnit;)Lv80/v;
    ...
    .line 13
    :cond_3
    iget-object p2, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->a:Lx50/f;

    invoke-interface {p2, p1}, Lx50/f;->registerVerify(Ljava/lang/String;)Lv80/b;
    ...
    .line 14
    invoke-static/range {v0 .. v5}, Lorg/xbet/ui_common/utils/rx/RxExtension2Kt;->applySchedulers$default(Lv80/b;Lv80/u;Lv80/u;Lv80/u;ILjava/lang/Object;)Lv80/b;
...
.method public final U()V
    ...
    .line 2
    :cond_0
    iget-object v2, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->a:Lx50/f;

    .line 3
    iget-object v3, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->i:Lz30/a;
    ...
    .line 4
    :goto_0
    invoke-interface {v2, v3, v1}, Lx50/f;->smsSendCode(Lz30/a;Z)Lv80/v;
    ...
    invoke-interface {v0}, Lx50/f;->activatePhone()Lv80/v;
...
.method public onBackPressed()V
    ...
    .line 1
    iget-boolean v0, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->o:Z
    ...
    invoke-virtual {v0, v1}, Lv20/a;->a(I)I
    ...
    iget-object v2, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->n:Lv20/c;
    ...
    invoke-interface {v0, v6}, Lcom/xbet/security/sections/activation/sms/ActivatePhoneView;->s7(Z)V
...
.method public final u(Ljava/lang/String;I)V
    ...
    .line 1
    iget-object v0, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->h:Lkg/b;
    ...
    invoke-interface {v0, p1, p2}, Lcom/xbet/security/sections/activation/sms/ActivatePhoneView;->ah(Ljava/lang/String;I)V

    .line 5
    iput-boolean v2, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->o:Z
    ...
    invoke-interface {p1, p2, v3}, Lcom/xbet/security/sections/activation/sms/ActivatePhoneView;->I7(Ljava/lang/String;Z)V
    ...
    .line 10
    :cond_3
    iget-object p1, p0, Lcom/xbet/security/sections/activation/sms/ActivationBySmsPresenter;->a:Lx50/f;

    invoke-interface {p1}, Lx50/f;->getUserPhone()Lv80/v;

...
.method public constructor <init>(Lio/noties/markwon/core/c;I)V
    ...
    iput-object v0, p0, Lm80/b;->b:Landroid/graphics/Paint;

    .line 3
    invoke-static {}, Lm80/g;->c()Landroid/graphics/RectF;

    move-result-object v0

    iput-object v0, p0, Lm80/b;->c:Landroid/graphics/RectF;

    .line 4
    invoke-static {}, Lm80/g;->b()Landroid/graphics/Rect;

    move-result-object v0

    iput-object v0, p0, Lm80/b;->d:Landroid/graphics/Rect;

    .line 5
    iput-object p1, p0, Lm80/b;->a:Lio/noties/markwon/core/c;

    .line 6
    iput p2, p0, Lm80/b;->e:I
...
.method public drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    .line 2
    :cond_0
    iget-object p5, p0, Lm80/b;->b:Landroid/graphics/Paint;

    invoke-virtual {p5, p2}, Landroid/graphics/Paint;->set(Landroid/graphics/Paint;)V

    .line 3
    iget-object p2, p0, Lm80/b;->a:Lio/noties/markwon/core/c;
    ...
    .line 5
    :try_start_0
    iget-object p5, p0, Lm80/b;->a:Lio/noties/markwon/core/c;
    ...
    .line 6
    iget-object p7, p0, Lm80/b;->b:Landroid/graphics/Paint;

    invoke-virtual {p7}, Landroid/graphics/Paint;->descent()F

    move-result p7

    iget-object p8, p0, Lm80/b;->b:Landroid/graphics/Paint;
    ...
    .line 7
    iget-object p9, p0, Lm80/b;->a:Lio/noties/markwon/core/c;
    ...
    .line 14
    :goto_3
    iget-object p4, p0, Lm80/b;->b:Landroid/graphics/Paint;
    ...
    .line 16
    :cond_4
    iget-object p4, p0, Lm80/b;->d:Landroid/graphics/Rect;

    invoke-virtual {p4, p10, p6, p3, p7}, Landroid/graphics/Rect;->set(IIII)V

    .line 17
    iget-object p3, p0, Lm80/b;->b:Landroid/graphics/Paint;
    ...
    .line 18
    iget-object p3, p0, Lm80/b;->d:Landroid/graphics/Rect;
    ...
    :cond_5
    :goto_4
    iget-object p4, p0, Lm80/b;->c:Landroid/graphics/RectF;
    ...
    .line 24
    iget-object p3, p0, Lm80/b;->c:Landroid/graphics/RectF;
...
.method public getLeadingMargin(Z)I
    ...
    iget-object p1, p0, Lm80/b;->a:Lio/noties/markwon/core/c;

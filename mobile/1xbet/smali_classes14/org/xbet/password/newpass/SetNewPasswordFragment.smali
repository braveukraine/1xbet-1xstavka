.class public final Lorg/xbet/password/newpass/SetNewPasswordFragment;
.super Lorg/xbet/security_core/NewBaseSecurityFragment;
.source "SetNewPasswordFragment.kt"

# interfaces
.implements Lorg/xbet/password/newpass/SetNewPasswordView;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/xbet/password/newpass/SetNewPasswordFragment$Companion;
    }
.end annotation
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lorg/xbet/password/databinding/FragmentNewPasswordBinding;",
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "()Lorg/xbet/password/newpass/SetNewPasswordPresenter;",
        "setPresenter",
        "(Lorg/xbet/password/newpass/SetNewPasswordPresenter;)V",
        "Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;",
        "setNewPasswordFactory",
        "Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;",
        "getSetNewPasswordFactory",
        "()Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;",
        "setSetNewPasswordFactory",
        "(Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;)V",
        "binding$delegate",
        ...
        "(Lv20/b;)V",
        "navigation",
        "org/xbet/password/newpass/SetNewPasswordFragment$changeListener$2$1",
        "changeListener$delegate",
        "Lr90/g;",
        "getChangeListener",
        "()Lorg/xbet/password/newpass/SetNewPasswordFragment$changeListener$2$1;",
        "changeListener",
        "<init>",
        "()V",
        "(Ljava/lang/String;Ljava/lang/String;Lorg/xbet/password/restore/models/RestoreType;JLv20/b;)V",
        "Companion",
        "password_release"
    }
    k = 0x1
...
.field public static final Companion:Lorg/xbet/password/newpass/SetNewPasswordFragment$Companion;
...
.field public presenter:Lorg/xbet/password/newpass/SetNewPasswordPresenter;
    .annotation runtime Lmoxy/presenter/InjectPresenter;
    .end annotation
.end field

.field public setNewPasswordFactory:Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;
...
.method static constructor <clinit>()V
    ...
    const-class v2, Lorg/xbet/password/newpass/SetNewPasswordFragment;

    const-string v3, "binding"

    const-string v4, "getBinding()Lorg/xbet/password/databinding/FragmentNewPasswordBinding;"
    ...
    sput-object v0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->$$delegatedProperties:[Lea0/i;

    new-instance v0, Lorg/xbet/password/newpass/SetNewPasswordFragment$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lorg/xbet/password/newpass/SetNewPasswordFragment$Companion;-><init>(Lkotlin/jvm/internal/h;)V

    sput-object v0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->Companion:Lorg/xbet/password/newpass/SetNewPasswordFragment$Companion;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->_$_findViewCache:Ljava/util/Map;

    invoke-direct {p0}, Lorg/xbet/security_core/NewBaseSecurityFragment;-><init>()V

    .line 2
    sget-object v0, Lorg/xbet/password/newpass/SetNewPasswordFragment$binding$2;->INSTANCE:Lorg/xbet/password/newpass/SetNewPasswordFragment$binding$2;
    ...
    iput-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->binding$delegate:Lkotlin/properties/c;
    ...
    iput-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->token$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleString;
    ...
    iput-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->guid$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleString;
    ...
    iput-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->userId$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleLong;
    ...
    iput-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->type$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleParcelable;
    ...
    iput-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->navigation$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleSerializable;

    .line 8
    new-instance v0, Lorg/xbet/password/newpass/SetNewPasswordFragment$changeListener$2;

    invoke-direct {v0, p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment$changeListener$2;-><init>(Lorg/xbet/password/newpass/SetNewPasswordFragment;)V

    invoke-static {v0}, Lr90/h;->b(Lz90/a;)Lr90/g;

    move-result-object v0

    iput-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->changeListener$delegate:Lr90/g;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/xbet/password/restore/models/RestoreType;JLv20/b;)V
    .locals 0
    ...
    .line 9
    invoke-direct {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;-><init>()V

    .line 10
    invoke-direct {p0, p1}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->setToken(Ljava/lang/String;)V

    .line 11
    invoke-direct {p0, p2}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->setGuid(Ljava/lang/String;)V

    .line 12
    invoke-direct {p0, p3}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->setType(Lorg/xbet/password/restore/models/RestoreType;)V

    .line 13
    invoke-direct {p0, p4, p5}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->setUserId(J)V

    .line 14
    invoke-direct {p0, p6}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->setNavigation(Lv20/b;)V

    return-void
.end method

.method public static final synthetic access$getNavigation(Lorg/xbet/password/newpass/SetNewPasswordFragment;)Lv20/b;
    .locals 0

    invoke-direct {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->getNavigation()Lv20/b;
...
.method public static final synthetic access$getUserId(Lorg/xbet/password/newpass/SetNewPasswordFragment;)J
    .locals 2

    invoke-direct {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->getUserId()J
...
.method private final getChangeListener()Lorg/xbet/password/newpass/SetNewPasswordFragment$changeListener$2$1;
    .locals 1

    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->changeListener$delegate:Lr90/g;

    invoke-interface {v0}, Lr90/g;->getValue()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lorg/xbet/password/newpass/SetNewPasswordFragment$changeListener$2$1;
...
.method private final getGuid()Ljava/lang/String;
    ...
    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->guid$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleString;

    sget-object v1, Lorg/xbet/password/newpass/SetNewPasswordFragment;->$$delegatedProperties:[Lea0/i;
...
.method private final getNavigation()Lv20/b;
    ...
    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->navigation$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleSerializable;
...
.method private final getToken()Ljava/lang/String;
    ...
    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->token$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleString;
...
.method private final getType()Lorg/xbet/password/restore/models/RestoreType;
    ...
    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->type$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleParcelable;
...
.method private final getUserId()J
    ...
    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->userId$delegate:Lorg/xbet/ui_common/kotlin/delegates/android/BundleLong;
...
.method private final initBackDialogListener()V
    ...
    new-instance v0, Lorg/xbet/password/newpass/SetNewPasswordFragment$initBackDialogListener$1;

    invoke-direct {v0, p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment$initBackDialogListener$1;-><init>(Lorg/xbet/password/newpass/SetNewPasswordFragment;)V
...
.method private final initExpiredTokenErrorDialogListener()V
    ...
    new-instance v0, Lorg/xbet/password/newpass/SetNewPasswordFragment$initExpiredTokenErrorDialogListener$1;

    invoke-direct {v0, p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment$initExpiredTokenErrorDialogListener$1;-><init>(Lorg/xbet/password/newpass/SetNewPasswordFragment;)V
...
.method public _$_clearFindViewByIdCache()V
    ...
    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->_$_findViewCache:Ljava/util/Map;
...
.method public clearPasswordErrors()V
    ...
    .line 1
    invoke-virtual {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->getBinding()Lorg/xbet/password/databinding/FragmentNewPasswordBinding;
    ...
    iget-object v0, v0, Lorg/xbet/password/databinding/FragmentNewPasswordBinding;->confirmPassword:Lcom/google/android/material/textfield/TextInputLayout;
...
.method protected getBinding()Lorg/xbet/password/databinding/FragmentNewPasswordBinding;
    .locals 3
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    .line 2
    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->binding$delegate:Lkotlin/properties/c;
    ...
    check-cast v0, Lorg/xbet/password/databinding/FragmentNewPasswordBinding;
...
.method public getPresenter()Lorg/xbet/password/newpass/SetNewPasswordPresenter;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    .line 2
    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->presenter:Lorg/xbet/password/newpass/SetNewPasswordPresenter;
...
.method public bridge synthetic getPresenter()Lorg/xbet/security_core/BaseSecurityPresenter;
    ...
    .line 1
    invoke-virtual {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->getPresenter()Lorg/xbet/password/newpass/SetNewPasswordPresenter;
...
.method public final getSetNewPasswordFactory()Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->setNewPasswordFactory:Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;
...
.method protected initViews()V
    ...
    new-instance v1, Lorg/xbet/password/newpass/SetNewPasswordFragment$initViews$1;

    invoke-direct {v1, p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment$initViews$1;-><init>(Lorg/xbet/password/newpass/SetNewPasswordFragment;)V
    ...
    .line 5
    invoke-direct {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->initExpiredTokenErrorDialogListener()V

    .line 6
    invoke-direct {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->initBackDialogListener()V
...
.method protected inject()V
    ...
    .line 7
    invoke-interface {v0, p0}, Lorg/xbet/password/di/PasswordComponent;->inject(Lorg/xbet/password/newpass/SetNewPasswordFragment;)V
...
.method public onBackPressed()Z
    ...
    invoke-virtual {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->showBackDialog()V
...
.method public synthetic onDestroyView()V
    ...
    invoke-virtual {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->_$_clearFindViewByIdCache()V
...
.method public onPause()V
    ...
    iget-object v0, v0, Lorg/xbet/password/databinding/FragmentNewPasswordBinding;->newPasswordEt:Landroid/widget/EditText;

    invoke-direct {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->getChangeListener()Lorg/xbet/password/newpass/SetNewPasswordFragment$changeListener$2$1;
    ...
    iget-object v0, v0, Lorg/xbet/password/databinding/FragmentNewPasswordBinding;->confirmPasswordEt:Landroid/widget/EditText;
...
.method public passwordChanged()V
    ...
    sget v2, Lorg/xbet/password/R$string;->password_has_changed:I
...
.method public final provide()Lorg/xbet/password/newpass/SetNewPasswordPresenter;
    .locals 8
    ...
    invoke-virtual {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->getSetNewPasswordFactory()Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;

    move-result-object v0

    new-instance v7, Lorg/xbet/password/common/TokenRestoreData;

    invoke-direct {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->getToken()Ljava/lang/String;

    move-result-object v2

    invoke-direct {p0}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->getGuid()Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v6}, Lorg/xbet/password/common/TokenRestoreData;-><init>(Ljava/lang/String;Ljava/lang/String;Lorg/xbet/password/restore/models/RestoreType;ILkotlin/jvm/internal/h;)V
    ...
    invoke-interface {v0, v7, v1, v2}, Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;->create(Lorg/xbet/password/common/TokenRestoreData;Lv20/b;Lorg/xbet/ui_common/router/BaseOneXRouter;)Lorg/xbet/password/newpass/SetNewPasswordPresenter;
...
.method public setPasswordRequirements(Lcom/xbet/onexuser/domain/entity/i;)V
    ...
    iget-object v0, v0, Lorg/xbet/password/databinding/FragmentNewPasswordBinding;->passwordRequirementView:Lorg/xbet/ui_common/viewcomponents/views/PasswordRequirementViewNew;
...
.method public setPresenter(Lorg/xbet/password/newpass/SetNewPasswordPresenter;)V
    .locals 0
    .param p1    # Lorg/xbet/password/newpass/SetNewPasswordPresenter;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param

    .line 2
    iput-object p1, p0, Lorg/xbet/password/newpass/SetNewPasswordFragment;->presenter:Lorg/xbet/password/newpass/SetNewPasswordPresenter;
...
.method public bridge synthetic setPresenter(Lorg/xbet/security_core/BaseSecurityPresenter;)V
    ...
    .line 1
    check-cast p1, Lorg/xbet/password/newpass/SetNewPasswordPresenter;

    invoke-virtual {p0, p1}, Lorg/xbet/password/newpass/SetNewPasswordFragment;->setPresenter(Lorg/xbet/password/newpass/SetNewPasswordPresenter;)V

    return-void
.end method

.method public final setSetNewPasswordFactory(Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;)V
    .locals 0
    .param p1    # Lorg/xbet/password/di/PasswordComponent$SetNewPasswordFactory;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public showPasswordError()V
    ...
    sget v1, Lorg/xbet/password/R$string;->does_not_meet_the_requirements_error:I

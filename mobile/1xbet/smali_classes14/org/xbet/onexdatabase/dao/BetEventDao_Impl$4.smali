.class Lorg/xbet/onexdatabase/dao/BetEventDao_Impl$4;
...
.method constructor <init>(Lorg/xbet/onexdatabase/dao/BetEventDao_Impl;Landroidx/room/q0;)V
    ...
    iput-object p1, p0, Lorg/xbet/onexdatabase/dao/BetEventDao_Impl$4;->this$0:Lorg/xbet/onexdatabase/dao/BetEventDao_Impl;
...
.method public bridge synthetic bind(Lu0/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lorg/xbet/onexdatabase/dao/BetEventDao_Impl$4;->bind(Lu0/k;Lorg/xbet/onexdatabase/entity/BetEventEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `bet_events` SET `id` = ?,`game_id` = ?,`player_id` = ?,`sport_id` = ?,`player_name` = ?,`game_match_name` = ?,`group_name` = ?,`express_number` = ?,`coefficient` = ?,`param` = ?,`time` = ?,`name` = ?,`kind` = ?,`type` = ? WHERE `id` = ?"

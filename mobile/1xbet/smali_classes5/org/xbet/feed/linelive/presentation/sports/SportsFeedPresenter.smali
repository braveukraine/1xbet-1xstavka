...
.field private selectionViewState:Lr90/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lr90/m<",
            "Ljava/lang/Boolean;",
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->$$delegatedProperties:[Lea0/i;
...
.method public constructor <init>(Lc50/g;Lorg/xbet/domain/betting/feed/linelive/interactors/FeedsFilterInteractor;Lorg/xbet/domain/betting/feed/linelive/interactors/LineLiveSportsInteractor;Lorg/xbet/domain/betting/feed/linelive/interactors/MultiselectIntaractor;Lorg/xbet/domain/betting/feed/betonyours/providers/FollowedCountriesProvider;Lorg/xbet/domain/betting/feed/linelive/models/LineLiveScreenType;ZLorg/xbet/feed/linelive/presentation/mappers/SportItemMapper;Lorg/xbet/ui_common/utils/internet/ConnectionObserver;Lorg/xbet/ui_common/utils/ErrorHandler;)V
    .locals 0
    .param p1    # Lc50/g;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->profileInteractor:Lc50/g;
    ...
    iput-object p1, p0, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->selectionViewState:Lr90/m;
...
.method public static final synthetic access$lineDataProvider(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;I)Lv80/o;
    .locals 0

    invoke-direct {p0, p1, p2}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->lineDataProvider(Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;I)Lv80/o;
...
.method public static final synthetic access$liveDataProvider(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;ZI)Lv80/o;
    .locals 0

    invoke-direct {p0, p1, p2}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->liveDataProvider(ZI)Lv80/o;
...
.method private final actualizeSelections(Ljava/util/List;)V
    ...
    invoke-virtual {v1}, Lorg/xbet/domain/betting/feed/linelive/interactors/MultiselectIntaractor;->getSelectedIds()Lv80/o;

    move-result-object v1

    .line 3
    invoke-virtual {v1}, Lv80/o;->g0()Lv80/k;
    ...
    .line 7
    invoke-virtual/range {v0 .. v5}, Lorg/xbet/feed/linelive/presentation/utils/SelectedItemsUpdateHandler;->actualizeSelections(Lv80/k;Ljava/util/List;Lz90/p;Lz90/l;Lz90/l;)Lx80/c;

    move-result-object p1

    .line 8
    invoke-direct {p0, p1}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->setSelectionsDisposable(Lx80/c;)V
...
.method private static final attachView$lambda-0(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lr90/x;)Lv80/m;
    .locals 0
    ...
    invoke-virtual {p0}, Lorg/xbet/domain/betting/feed/linelive/interactors/MultiselectIntaractor;->getMultiselectActivity()Lv80/o;

    move-result-object p0

    invoke-virtual {p0}, Lv80/o;->g0()Lv80/k;

    move-result-object p0

    sget-object p1, Lorg/xbet/feed/linelive/presentation/sports/l;->a:Lorg/xbet/feed/linelive/presentation/sports/l;

    invoke-virtual {p0, p1}, Lv80/k;->n(Ly80/l;)Lv80/k;
...
.method public static synthetic b(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/util/List;)Ljava/util/List;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->lineDataProvider$lambda-7$lambda-6$lambda-5(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/util/List;)Ljava/util/List;
...
.method public static synthetic c(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lv80/o;Ljava/lang/Long;)Lv80/r;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->loadData$lambda-2(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lv80/o;Ljava/lang/Long;)Lv80/r;
...
.method public static synthetic d(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lr90/x;)Lv80/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->attachView$lambda-0(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lr90/x;)Lv80/m;
...
.method public static synthetic e(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    .locals 0
...
.method public static synthetic f(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/lang/Throwable;)V
    .locals 0
...
.method public static synthetic g(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/util/Set;)V
    .locals 0
...
.method private final getDataLoadingDisposable()Lx80/c;
    ...
    sget-object v1, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->$$delegatedProperties:[Lea0/i;
...
.method public static synthetic h(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;ZILjava/util/Set;)Lv80/r;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->liveDataProvider$lambda-10(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;ZILjava/util/Set;)Lv80/r;
...
.method public static synthetic i(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/util/List;)Ljava/util/List;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->liveDataProvider$lambda-10$lambda-9(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/util/List;)Ljava/util/List;
...
.method public static synthetic k(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;ILr90/m;Ljava/util/Set;)Lv80/r;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->lineDataProvider$lambda-7$lambda-6(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;ILr90/m;Ljava/util/Set;)Lv80/r;
...
.method private final lineDataProvider()Lv80/o;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 2
    iget-object v1, p0, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->profileInteractor:Lc50/g;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->withCountryId(Lv80/o;Lc50/g;Lz90/p;)Lv80/o;
...
.method private final lineDataProvider(Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;I)Lv80/o;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v1, Lorg/xbet/feed/linelive/presentation/sports/h;

    invoke-direct {v1, p0, p1, p2}, Lorg/xbet/feed/linelive/presentation/sports/h;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;I)V
...
.method private static final lineDataProvider$lambda-7(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;ILr90/m;)Lv80/r;
    .locals 2
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/feed/betonyours/providers/FollowedCountriesProvider;->getFollowedCountryIds()Lv80/o;
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lorg/xbet/feed/linelive/presentation/sports/i;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;ILr90/m;)V
...
.method private static final lineDataProvider$lambda-7$lambda-6(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;ILr90/m;Ljava/util/Set;)Lv80/r;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p4, p3}, Lorg/xbet/domain/betting/feed/linelive/interactors/LineLiveSportsInteractor;->getLineSports(Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;ILjava/util/Set;Lr90/m;)Lv80/o;

    move-result-object p1

    .line 2
    new-instance p2, Lorg/xbet/feed/linelive/presentation/sports/u;

    invoke-direct {p2, p0}, Lorg/xbet/feed/linelive/presentation/sports/u;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;)V
...
.method private static final lineDataProvider$lambda-7$lambda-6$lambda-5(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/util/List;)Ljava/util/List;
    .locals 2
...
.method private final liveDataProvider()Lv80/o;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private final liveDataProvider(ZI)Lv80/o;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZI)",
    ...
    .line 5
    new-instance v1, Lorg/xbet/feed/linelive/presentation/sports/k;

    invoke-direct {v1, p0, p1, p2}, Lorg/xbet/feed/linelive/presentation/sports/k;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;ZI)V
...
.method private static final liveDataProvider$lambda-10(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;ZILjava/util/Set;)Lv80/r;
    .locals 6
    ...
    invoke-virtual/range {v0 .. v5}, Lorg/xbet/domain/betting/feed/linelive/interactors/LineLiveSportsInteractor;->getLiveSports(ZLorg/xbet/domain/betting/feed/linelive/models/LineLiveScreenType;ILjava/util/Set;Z)Lv80/o;
...
.method private static final liveDataProvider$lambda-10$lambda-9(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/util/List;)Ljava/util/List;
    .locals 2
...
.method private final loadData(Z)V
    ...
    invoke-direct/range {p0 .. p0}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->liveDataProvider()Lv80/o;
    ...
    :cond_0
    invoke-direct/range {p0 .. p0}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->lineDataProvider()Lv80/o;
    ...
    .line 4
    invoke-static {v2, v3, v4, v5, v6}, Lv80/o;->A0(JJLjava/util/concurrent/TimeUnit;)Lv80/o;

    move-result-object v2

    .line 5
    new-instance v3, Lorg/xbet/feed/linelive/presentation/sports/j;

    invoke-direct {v3, v0, v1}, Lorg/xbet/feed/linelive/presentation/sports/j;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lv80/o;)V
    ...
    .line 10
    new-instance v2, Lorg/xbet/feed/linelive/presentation/sports/q;

    invoke-direct {v2, v0}, Lorg/xbet/feed/linelive/presentation/sports/q;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;)V

    new-instance v3, Lorg/xbet/feed/linelive/presentation/sports/s;

    move/from16 v4, p1

    invoke-direct {v3, v0, v4}, Lorg/xbet/feed/linelive/presentation/sports/s;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Z)V
    ...
    .line 11
    invoke-direct {v0, v1}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->setDataLoadingDisposable(Lx80/c;)V
...
.method private static final loadData$lambda-2(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lv80/o;Ljava/lang/Long;)Lv80/r;
    .locals 0

    invoke-direct {p0, p1}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->onDataProvider(Lv80/o;)Lv80/o;
...
.method public static synthetic m(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;ZLjava/lang/Throwable;)V
    .locals 0
...
.method public static synthetic n(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;)V
    .locals 0
...
.method public static synthetic o(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;ILr90/m;)Lv80/r;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->lineDataProvider$lambda-7(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Lorg/xbet/domain/betting/feed/linelive/models/TimeFilter;ILr90/m;)Lv80/r;
...
.method private final onConnectionStateChanged(Z)V
    ...
    .line 1
    invoke-direct {p0}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->getDataLoadingDisposable()Lx80/c;
...
.method private final onDataLoadError(Ljava/lang/Throwable;Z)V
    ...
    invoke-direct {p0, p2}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->onEmptyCacheDo(Lz90/a;)V
    ...
    invoke-direct {p0, p1}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->onEmptyCacheDo(Lz90/a;)V
...
.method private final onDataProvider(Lv80/o;)Lv80/o;
    ...
    .line 1
    new-instance v0, Lorg/xbet/feed/linelive/presentation/sports/p;

    invoke-direct {v0, p0}, Lorg/xbet/feed/linelive/presentation/sports/p;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;)V
    ...
    .line 3
    new-instance v1, Lorg/xbet/feed/linelive/presentation/sports/m;

    invoke-direct {v1, p0}, Lorg/xbet/feed/linelive/presentation/sports/m;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;)V
...
.method public static synthetic p(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;Ljava/util/List;)V
    .locals 0
...
.method private final startLoadData()V
    ...
    invoke-virtual {v0}, Lorg/xbet/domain/betting/feed/linelive/interactors/LineLiveSportsInteractor;->getCachedData()Lv80/o;

    move-result-object v0

    new-instance v1, Lorg/xbet/feed/linelive/presentation/sports/t;

    invoke-direct {v1, p0}, Lorg/xbet/feed/linelive/presentation/sports/t;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;)V
    ...
    .line 5
    invoke-direct {p0, v0}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->onDataProvider(Lv80/o;)Lv80/o;
    ...
    new-instance v2, Lorg/xbet/feed/linelive/presentation/sports/o;

    invoke-direct {v2, p0}, Lorg/xbet/feed/linelive/presentation/sports/o;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;)V
...
.method public attachView(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedView;)V
    ...
    iget-object v0, p0, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->selectionViewState:Lr90/m;
    ...
    iget-object v1, p0, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->selectionViewState:Lr90/m;
    ...
    invoke-virtual {p1}, Lorg/xbet/domain/betting/feed/linelive/interactors/FeedsFilterInteractor;->getMultiselectClickNotifier()Lv80/o;
    ...
    invoke-virtual {p1, v0}, Lv80/o;->p0(Ly80/l;)Lv80/o;
    ...
    invoke-virtual {p0, p1, v0}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->observeWhileAttached(Lv80/o;Lz90/l;)V
    ...
    invoke-virtual {p1}, Lorg/xbet/domain/betting/feed/linelive/interactors/MultiselectIntaractor;->getMultiselectActivity()Lv80/o;
    ...
    invoke-virtual {p1}, Lorg/xbet/domain/betting/feed/linelive/interactors/MultiselectIntaractor;->getSelectedIds()Lv80/o;
    ...
    invoke-virtual {p0, p1, v2}, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->observeWhileAttached(Lv80/o;Lz90/l;)V
...
.method public onDestroy()V
    ...
    iput-object v0, p0, Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;->selectionViewState:Lr90/m;
...
.method public final onSelectionButtonClicked()V
    ...
    .line 4
    new-instance v1, Lorg/xbet/feed/linelive/presentation/sports/r;

    invoke-direct {v1, p0}, Lorg/xbet/feed/linelive/presentation/sports/r;-><init>(Lorg/xbet/feed/linelive/presentation/sports/SportsFeedPresenter;)V

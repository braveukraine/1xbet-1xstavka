...
.method public parse(Lorg/intellij/markdown/parser/sequentialparsers/TokensCache;Ljava/util/List;)Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$ParsingResult;
    ...
    invoke-virtual {v2, p1}, Lorg/intellij/markdown/parser/sequentialparsers/TokensCache$Iterator;->rawLookup(I)Lorg/intellij/markdown/IElementType;
    ...
    invoke-virtual {p2, v3}, Lorg/intellij/markdown/parser/sequentialparsers/impl/InlineLinkParser$Companion;->parseInlineLink(Lorg/intellij/markdown/parser/sequentialparsers/TokensCache$Iterator;)Lorg/intellij/markdown/parser/sequentialparsers/LocalParsingResult;
    ...
    invoke-virtual {p2, v3}, Lorg/intellij/markdown/parser/sequentialparsers/impl/ReferenceLinkParser$Companion;->parseReferenceLink(Lorg/intellij/markdown/parser/sequentialparsers/TokensCache$Iterator;)Lorg/intellij/markdown/parser/sequentialparsers/LocalParsingResult;
    ...
    invoke-virtual {p2}, Lorg/intellij/markdown/parser/sequentialparsers/LocalParsingResult;->getIteratorPosition()Lorg/intellij/markdown/parser/sequentialparsers/TokensCache$Iterator;

    move-result-object v5

    invoke-virtual {v5}, Lorg/intellij/markdown/parser/sequentialparsers/TokensCache$Iterator;->getIndex()I

    move-result v5

    add-int/2addr v5, p1

    invoke-direct {v4, v2, v5}, Lda0/f;-><init>(II)V

    sget-object p1, Lorg/intellij/markdown/MarkdownElementTypes;->IMAGE:Lorg/intellij/markdown/IElementType;

    invoke-direct {v3, v4, p1}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;-><init>(Lda0/f;Lorg/intellij/markdown/IElementType;)V
    ...
    .line 9
    invoke-virtual {p1, p2}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$ParsingResultBuilder;->withOtherParsingResult(Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$ParsingResult;)Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$ParsingResultBuilder;

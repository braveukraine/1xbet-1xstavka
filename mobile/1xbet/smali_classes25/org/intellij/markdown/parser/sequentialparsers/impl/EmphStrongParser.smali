...
.method public parse(Lorg/intellij/markdown/parser/sequentialparsers/TokensCache;Ljava/util/List;)Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$ParsingResult;
    ...
    new-instance v11, Lda0/f;

    add-int/2addr v9, v2

    invoke-direct {v11, v8, v9}, Lda0/f;-><init>(II)V

    invoke-direct {v10, v11, v7}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;-><init>(Lda0/f;Lorg/intellij/markdown/IElementType;)V

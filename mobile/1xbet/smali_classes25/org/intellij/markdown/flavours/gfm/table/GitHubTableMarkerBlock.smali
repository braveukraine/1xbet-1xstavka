...
.method public constructor <init>(Lorg/intellij/markdown/parser/LookaheadText$Position;Lorg/intellij/markdown/parser/constraints/MarkdownConstraints;Lorg/intellij/markdown/parser/ProductionHolder;I)V
    ...
    invoke-direct {v0, p4, v1}, Lda0/f;-><init>(II)V

    .line 3
    sget-object p4, Lorg/intellij/markdown/flavours/gfm/GFMElementTypes;->HEADER:Lorg/intellij/markdown/IElementType;

    .line 4
    invoke-direct {p2, v0, p4}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;-><init>(Lda0/f;Lorg/intellij/markdown/IElementType;)V
...
.method private final fillCells(Lorg/intellij/markdown/parser/LookaheadText$Position;)Ljava/util/List;
    ...
    invoke-direct {v9, v1, v10}, Lda0/f;-><init>(II)V

    sget-object v10, Lorg/intellij/markdown/flavours/gfm/GFMTokenTypes;->CELL:Lorg/intellij/markdown/IElementType;

    invoke-direct {v8, v9, v10}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;-><init>(Lda0/f;Lorg/intellij/markdown/IElementType;)V
    ...
    new-instance v8, Lda0/f;

    add-int/lit8 v9, v1, 0x1

    invoke-direct {v8, v1, v9}, Lda0/f;-><init>(II)V

    sget-object v9, Lorg/intellij/markdown/flavours/gfm/GFMTokenTypes;->TABLE_SEPARATOR:Lorg/intellij/markdown/IElementType;

    invoke-direct {v6, v8, v9}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;-><init>(Lda0/f;Lorg/intellij/markdown/IElementType;)V
    ...
    invoke-direct {v3, v1, p1}, Lda0/f;-><init>(II)V

    sget-object p1, Lorg/intellij/markdown/flavours/gfm/GFMTokenTypes;->TABLE_SEPARATOR:Lorg/intellij/markdown/IElementType;

    invoke-direct {v2, v3, p1}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;-><init>(Lda0/f;Lorg/intellij/markdown/IElementType;)V
...
.method protected doProcessToken(Lorg/intellij/markdown/parser/LookaheadText$Position;Lorg/intellij/markdown/parser/constraints/MarkdownConstraints;)Lorg/intellij/markdown/parser/markerblocks/MarkerBlock$ProcessingResult;
    ...
    invoke-virtual {v1}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;->getRange()Lda0/f;

    move-result-object v1

    invoke-virtual {v1}, Lda0/d;->c()I
    ...
    invoke-direct {v2, v1, v3}, Lda0/f;-><init>(II)V

    .line 12
    sget-object v1, Lorg/intellij/markdown/flavours/gfm/GFMElementTypes;->ROW:Lorg/intellij/markdown/IElementType;

    .line 13
    invoke-direct {v0, v2, v1}, Lorg/intellij/markdown/parser/sequentialparsers/SequentialParser$Node;-><init>(Lda0/f;Lorg/intellij/markdown/IElementType;)V

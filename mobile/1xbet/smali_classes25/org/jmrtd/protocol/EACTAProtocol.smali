...
.method public declared-synchronized doTA(Lorg/jmrtd/cert/CVCPrincipal;Ljava/util/List;Ljava/security/PrivateKey;Ljava/lang/String;Lorg/jmrtd/protocol/EACCAResult;[B)Lorg/jmrtd/protocol/EACTAResult;
    ...
    invoke-static {v4, v5}, Lra0/e;->i(I[B)[B
    ...
    .line 28
    new-instance v6, Lra0/d;

    invoke-direct {v6, v5}, Lra0/d;-><init>(Ljava/io/OutputStream;)V

    const/16 v7, 0x5f37

    .line 29
    invoke-virtual {v6, v7}, Lra0/d;->b(I)V

    .line 30
    invoke-virtual {v6, v3}, Lra0/d;->d([B)V

    .line 31
    invoke-virtual {v6}, Lra0/d;->close()V
    ...
    invoke-static {v4, v0}, Lra0/e;->i(I[B)[B

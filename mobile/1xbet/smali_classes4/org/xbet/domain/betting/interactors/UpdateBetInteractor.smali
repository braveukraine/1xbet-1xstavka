...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "appSettingsManager",
        "<init>",
        "(Ln40/t;Lcom/xbet/onexuser/domain/user/c;Lzi/b;Lorg/xbet/domain/betting/repositories/CoefViewPrefsRepository;Lorg/xbet/domain/betting/repositories/UpdateBetEventsRepository;Lorg/xbet/domain/betting/interactors/CouponInteractor;)V",
        "betting_release"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Ln40/t;Lcom/xbet/onexuser/domain/user/c;Lzi/b;Lorg/xbet/domain/betting/repositories/CoefViewPrefsRepository;Lorg/xbet/domain/betting/repositories/UpdateBetEventsRepository;Lorg/xbet/domain/betting/interactors/CouponInteractor;)V
    .locals 0
    .param p1    # Ln40/t;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->balanceInteractor:Ln40/t;
    ...
    .line 4
    iput-object p3, p0, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->appSettingsManager:Lzi/b;
...
.method public static synthetic a(JLjava/lang/Long;)Lr90/m;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent$lambda-2(JLjava/lang/Long;)Lr90/m;
...
.method public static synthetic c(Ljava/lang/Throwable;)Lv80/z;
    ...
    invoke-static {p0}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent$lambda-5(Ljava/lang/Throwable;)Lv80/z;
...
.method public static synthetic d(Lc40/b;)Ljava/lang/Long;
    .locals 0

    invoke-static {p0}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent$lambda-0(Lc40/b;)Ljava/lang/Long;
...
.method public static synthetic e(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;Lorg/xbet/domain/betting/models/UpdateCouponParams;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->getPromoCodes$lambda-3(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;Lorg/xbet/domain/betting/models/UpdateCouponParams;)Lv80/z;
...
.method public static synthetic f(Lc40/b;Lo40/a;)Lr90/m;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->getUserAndBalanceId$lambda-9(Lc40/b;Lo40/a;)Lr90/m;
...
.method public static synthetic g(Ljava/lang/Throwable;)Lv80/z;
    .locals 0

    invoke-static {p0}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent$lambda-1(Ljava/lang/Throwable;)Lv80/z;
...
.method private static final getPromoCodes$lambda-3(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;Lorg/xbet/domain/betting/models/UpdateCouponParams;)Lv80/z;
    .locals 26
    ...
    invoke-interface {v1, v0}, Lorg/xbet/domain/betting/repositories/UpdateBetEventsRepository;->updateCoupon(Lorg/xbet/domain/betting/models/UpdateCouponParams;)Lv80/v;
...
.method private final getUserAndBalanceId()Lv80/v;
    .locals 3
    ...
    .line 2
    iget-object v1, p0, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->balanceInteractor:Ln40/t;
...
.method private static final getUserAndBalanceId$lambda-10(Lr90/m;)Lr90/m;
    .locals 3
...
.method private static final getUserAndBalanceId$lambda-9(Lc40/b;Lo40/a;)Lr90/m;
    .locals 0
...
.method public static synthetic i(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;La80/a;IJLjava/lang/String;Ljava/util/List;Ljava/lang/String;Lr90/m;)Lorg/xbet/domain/betting/models/UpdateCouponParams;
    .locals 0

    invoke-static/range {p0 .. p8}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent$lambda-6(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;La80/a;IJLjava/lang/String;Ljava/util/List;Ljava/lang/String;Lr90/m;)Lorg/xbet/domain/betting/models/UpdateCouponParams;
...
.method public static synthetic j(Lr90/m;)Lr90/m;
    .locals 0

    invoke-static {p0}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->getUserAndBalanceId$lambda-10(Lr90/m;)Lr90/m;
...
.method private final updateBetEvent(Lv80/v;Ljava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;)Lv80/v;
    .locals 60
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 11
    invoke-virtual {v1, v0}, Lv80/v;->J(Ly80/l;)Lv80/v;
    ...
    invoke-direct/range {v0 .. v8}, Lorg/xbet/domain/betting/interactors/j0;-><init>(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;La80/a;IJLjava/lang/String;Ljava/util/List;Ljava/lang/String;)V
...
.method public static synthetic updateBetEvent$default(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;JLjava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Lv80/v;
    .locals 12
    ...
    .line 3
    sget-object v0, La80/a;->UNKNOWN:La80/a;
    ...
    .line 4
    invoke-virtual/range {v2 .. v11}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent(JLjava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;)Lv80/v;
...
.method public static synthetic updateBetEvent$default(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;Ljava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Lv80/v;
    .locals 7
    ...
    .line 2
    invoke-virtual/range {p2 .. p9}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent(Ljava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;)Lv80/v;
...
.method static synthetic updateBetEvent$default(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;Lv80/v;Ljava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Lv80/v;
    .locals 11
    ...
    .line 6
    invoke-direct/range {v2 .. v10}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent(Lv80/v;Ljava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;)Lv80/v;
...
.method private static final updateBetEvent$lambda-0(Lc40/b;)Ljava/lang/Long;
    .locals 2

    invoke-virtual {p0}, Lc40/b;->e()J
...
.method private static final updateBetEvent$lambda-1(Ljava/lang/Throwable;)Lv80/z;
    .locals 2
...
.method private static final updateBetEvent$lambda-2(JLjava/lang/Long;)Lr90/m;
    .locals 0
...
.method private static final updateBetEvent$lambda-5(Ljava/lang/Throwable;)Lv80/z;
    .locals 2
...
.method private static final updateBetEvent$lambda-6(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;La80/a;IJLjava/lang/String;Ljava/util/List;Ljava/lang/String;Lr90/m;)Lorg/xbet/domain/betting/models/UpdateCouponParams;
    .locals 27
    ...
    .line 2
    iget-object v1, v0, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->appSettingsManager:Lzi/b;
...
.method private static final updateBetEvent$lambda-8(Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;Lorg/xbet/domain/betting/models/UpdateCouponResult;)V
    ...
    .line 7
    invoke-virtual {v0}, Ly70/b;->h()Z

    move-result v3

    if-nez v3, :cond_5

    invoke-virtual {v0}, Ly70/b;->s()Z
...
# virtual methods
.method public final getPromoCodes(Z)Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
    ...
    invoke-interface {p1}, Lorg/xbet/domain/betting/repositories/UpdateBetEventsRepository;->getMakeBetParams()Lv80/v;
    ...
    invoke-interface {p1}, Lorg/xbet/domain/betting/repositories/UpdateBetEventsRepository;->getCouponParams()Lv80/v;
...
.method public final updateBetEvent(JLjava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;)Lv80/v;
    .locals 10
    ...
    .line 7
    invoke-direct/range {v0 .. v8}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->updateBetEvent(Lv80/v;Ljava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;)Lv80/v;
...
.method public final updateBetEvent(Ljava/util/List;JLa80/a;ILjava/lang/String;Ljava/lang/String;)Lv80/v;
    .locals 9
    ...
    .line 1
    invoke-direct {p0}, Lorg/xbet/domain/betting/interactors/UpdateBetInteractor;->getUserAndBalanceId()Lv80/v;

...
.method private final applyFilters(Lv80/v;Ljava/lang/String;)Lv80/v;
    .locals 1
...
.method private static final applyFilters$lambda-1(Ljava/lang/String;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v2, p0, v3, v4, v5}, Lkotlin/text/n;->R(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZILjava/lang/Object;)Z
...
.method private final filterNotAllowedSports(Lv80/v;)Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static synthetic getAllSportsWithFilter$default(Lorg/xbet/domain/betting/interactors/SportsFilterInteractor;Ljava/lang/String;ZILjava/lang/Object;)Lv80/v;
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lorg/xbet/domain/betting/interactors/SportsFilterInteractor;->getAllSportsWithFilter(Ljava/lang/String;Z)Lv80/v;
...
.method public final getAllSportsWithFilter(Ljava/lang/String;Z)Lv80/v;
    .locals 1
    ...
    invoke-interface {v0, p2}, Lorg/xbet/domain/betting/repositories/SportsFilterRepository;->getAllSportsWithFilter(Z)Lv80/v;

    move-result-object p2

    .line 2
    invoke-direct {p0, p2, p1}, Lorg/xbet/domain/betting/interactors/SportsFilterInteractor;->applyFilters(Lv80/v;Ljava/lang/String;)Lv80/v;

    move-result-object p1

    .line 3
    invoke-direct {p0, p1}, Lorg/xbet/domain/betting/interactors/SportsFilterInteractor;->filterNotAllowedSports(Lv80/v;)Lv80/v;
...
.method public final getCheckedItemsCount()Lv80/o;
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/repositories/SportsFilterRepository;->getCheckedItemsCount()Lv80/o;
...
.method public final getDefaultSports()Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/repositories/SportsFilterRepository;->getDefaultSports()Lv80/v;

    move-result-object v0

    .line 2
    invoke-direct {p0, v0}, Lorg/xbet/domain/betting/interactors/SportsFilterInteractor;->filterNotAllowedSports(Lv80/v;)Lv80/v;
...
.method public final getFilteredSports()Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0, v1}, Lorg/xbet/domain/betting/repositories/SportsFilterRepository;->getSavedLocalSports(Z)Lv80/v;
...
.method public final saveSport(Lorg/xbet/domain/betting/feed/linelive/models/Sport;)Lv80/v;
    .locals 3

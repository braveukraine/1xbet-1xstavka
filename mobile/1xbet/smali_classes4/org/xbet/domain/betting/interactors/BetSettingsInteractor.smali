...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "balanceInteractor",
        "<init>",
        "(Lorg/xbet/domain/betting/repositories/BetSettingsRepository;Lorg/xbet/domain/betting/interactors/ICommonConfigManager;Lorg/xbet/domain/betting/interactors/BetsConfigInteractor;Lm40/o;Lcom/xbet/onexuser/domain/user/c;Ln40/t;)V",
        "betting_release"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(Lorg/xbet/domain/betting/repositories/BetSettingsRepository;Lorg/xbet/domain/betting/interactors/ICommonConfigManager;Lorg/xbet/domain/betting/interactors/BetsConfigInteractor;Lm40/o;Lcom/xbet/onexuser/domain/user/c;Ln40/t;)V
    .locals 0
    ...
    .line 5
    iput-object p4, p0, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->currencyInteractor:Lm40/o;
    ...
    .line 7
    iput-object p6, p0, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->balanceInteractor:Ln40/t;

    return-void
.end method

.method public static synthetic a(Lm40/g;)Ljava/lang/Double;
    .locals 0

    invoke-static {p0}, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->getMinSumBet$lambda-2(Lm40/g;)Ljava/lang/Double;
...
.method public static synthetic b(DLorg/xbet/domain/betting/interactors/BetSettingsInteractor;Ljava/lang/Double;)Lr90/x;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->updateQuickBetValue$lambda-1(DLorg/xbet/domain/betting/interactors/BetSettingsInteractor;Ljava/lang/Double;)Lr90/x;
...
.method public static synthetic c(Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;JLm40/g;)Ljava/util/List;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->getQuickBetValues$lambda-0(Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;JLm40/g;)Ljava/util/List;
...
.method public static synthetic d(Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;Lo40/a;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->getCurrencyForLastBalance$lambda-3(Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;Lo40/a;)Lv80/z;
...
.method private final getCurrencyForLastBalance()Lv80/v;
    .locals 2
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->balanceInteractor:Ln40/t;
...
.method private static final getCurrencyForLastBalance$lambda-3(Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;Lo40/a;)Lv80/z;
    .locals 2

    iget-object p0, p0, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->currencyInteractor:Lm40/o;
...
.method private final getMinSumBet()Lv80/v;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0}, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->getCurrencyForLastBalance()Lv80/v;
...
.method private static final getMinSumBet$lambda-2(Lm40/g;)Ljava/lang/Double;
    .locals 2
...
.method private static final getQuickBetValues$lambda-0(Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;JLm40/g;)Ljava/util/List;
    .locals 2
    ...
    .line 2
    invoke-virtual {p3}, Lm40/g;->l()Ljava/lang/String;

    move-result-object p1

    const/4 p2, 0x3

    new-array p2, p2, [Lr90/m;
...
.method private static final updateQuickBetValue$lambda-1(DLorg/xbet/domain/betting/interactors/BetSettingsInteractor;Ljava/lang/Double;)Lr90/x;
    .locals 3
...
# virtual methods
.method public final attachToChangeQuickBetState()Lv80/o;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final getCommonConfig()Lkg/b;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/interactors/ICommonConfigManager;->getCommonConfig()Lkg/b;
...
.method public final getCurrencyById(J)Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    iget-object v0, p0, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->currencyInteractor:Lm40/o;
...
.method public final getQuickBetValue()Lv80/v;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0}, Lorg/xbet/domain/betting/interactors/BetSettingsInteractor;->getMinSumBet()Lv80/v;
...
.method public final getQuickBetValues(JJ)Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JJ)",
...
.method public final lastBalance()Lv80/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final updateQuickBetValue(D)Lv80/b;
    .locals 2
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
    ...
    invoke-static {p1}, Lv80/b;->u(Lv80/z;)Lv80/b;

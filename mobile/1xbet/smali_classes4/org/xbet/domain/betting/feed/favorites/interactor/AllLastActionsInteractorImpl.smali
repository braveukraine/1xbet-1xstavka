...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lm40/n;Lm40/j;Lm40/e;Lorg/xbet/domain/betting/repositories/LastActionRepository;)V",
        "betting_release"
    }
    k = 0x1
    mv = {
...
# instance fields
.field private final casinoLastActionsInteractor:Lm40/e;
...
.field private final sportLastActionsInteractor:Lm40/n;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Lm40/n;Lm40/j;Lm40/e;Lorg/xbet/domain/betting/repositories/LastActionRepository;)V
    .locals 0
    .param p1    # Lm40/n;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 2
    iput-object p1, p0, Lorg/xbet/domain/betting/feed/favorites/interactor/AllLastActionsInteractorImpl;->sportLastActionsInteractor:Lm40/n;

    .line 3
    iput-object p2, p0, Lorg/xbet/domain/betting/feed/favorites/interactor/AllLastActionsInteractorImpl;->oneXGameLastActionsInteractor:Lm40/j;

    .line 4
    iput-object p3, p0, Lorg/xbet/domain/betting/feed/favorites/interactor/AllLastActionsInteractorImpl;->casinoLastActionsInteractor:Lm40/e;
...
# virtual methods
.method public deleteAllLastActions()Lv80/b;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
    ...
    invoke-interface {v0}, Lorg/xbet/domain/betting/repositories/LastActionRepository;->deleteAll()Lv80/b;
...
.method public deleteLastAction(J)Lv80/b;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public getAllLastActions()Lv80/v;
    .locals 4
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/domain/betting/feed/favorites/interactor/AllLastActionsInteractorImpl;->sportLastActionsInteractor:Lm40/n;
    ...
    .line 2
    iget-object v1, p0, Lorg/xbet/domain/betting/feed/favorites/interactor/AllLastActionsInteractorImpl;->oneXGameLastActionsInteractor:Lm40/j;

    invoke-interface {v1}, Lm40/j;->getOneXGameLastActions()Lv80/v;

    move-result-object v1

    .line 3
    iget-object v2, p0, Lorg/xbet/domain/betting/feed/favorites/interactor/AllLastActionsInteractorImpl;->casinoLastActionsInteractor:Lm40/e;

    invoke-interface {v2}, Lm40/e;->getCasinoLastActions()Lv80/v;

    move-result-object v2

    sget-object v3, Lxd0/a;->a:Lxd0/a;

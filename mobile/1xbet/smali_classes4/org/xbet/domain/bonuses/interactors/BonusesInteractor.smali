...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lorg/xbet/domain/bonuses/repositories/BonusesRepository;Ln20/d;Lzi/b;Ln20/f;Lcom/xbet/onexuser/domain/managers/k0;)V",
        "office"
    }
    k = 0x1
    mv = {
...
.field private final balanceRepository:Ln20/d;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.field private final screenBalanceRepository:Ln20/f;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Lorg/xbet/domain/bonuses/repositories/BonusesRepository;Ln20/d;Lzi/b;Ln20/f;Lcom/xbet/onexuser/domain/managers/k0;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;->balanceRepository:Ln20/d;

    .line 4
    iput-object p3, p0, Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;->appSettingsManager:Lzi/b;

    .line 5
    iput-object p4, p0, Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;->screenBalanceRepository:Ln20/f;
...
.method public static final synthetic access$getAppSettingsManager$p(Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;)Lzi/b;
    .locals 0

    iget-object p0, p0, Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;->appSettingsManager:Lzi/b;

    return-object p0
.end method

.method public static final synthetic access$getBalanceRepository$p(Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;)Ln20/d;
    .locals 0

    iget-object p0, p0, Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;->balanceRepository:Ln20/d;
...
.method private static final refuseBonus$lambda-0(Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;)V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;->screenBalanceRepository:Ln20/f;

    sget-object v1, Lo40/b;->HISTORY:Lo40/b;

    invoke-virtual {v0, v1}, Ln20/f;->a(Lo40/b;)Z
    ...
    .line 2
    iget-object p0, p0, Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;->screenBalanceRepository:Ln20/f;

    invoke-virtual {p0, v1}, Ln20/f;->b(Lo40/b;)V
...
# virtual methods
.method public final bonuses()Lv80/v;
    .locals 2
...
.method public final refuseBonus(I)Lv80/b;
    .locals 3
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
    ...
    iget-object v1, p0, Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;->appSettingsManager:Lzi/b;

    invoke-interface {v1}, Lzi/b;->getAndroidId()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lorg/xbet/domain/bonuses/interactors/BonusesInteractor;->appSettingsManager:Lzi/b;

    invoke-interface {v2}, Lzi/b;->getAndroidId()Ljava/lang/String;

    move-result-object v2

    invoke-interface {v0, p1, v1, v2}, Lorg/xbet/domain/bonuses/repositories/BonusesRepository;->refuseBonus(ILjava/lang/String;Ljava/lang/String;)Lv80/b;
    ...
    invoke-virtual {p1, v0}, Lv80/b;->d(Lv80/d;)Lv80/b;

...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/xbet/domain/authenticator/interactors/AuthenticatorInteractor;->disableAuthenticator()Lv80/b;
.end annotation
...
.method public static synthetic a(Lorg/xbet/domain/authenticator/interactors/AuthenticatorInteractor;Ljava/lang/String;Lorg/xbet/domain/authenticator/models/registration/UnregisterResult;)Lv80/d;
    .locals 0

    invoke-static {p0, p1, p2}, Lorg/xbet/domain/authenticator/interactors/AuthenticatorInteractor$disableAuthenticator$1;->invoke$lambda-0(Lorg/xbet/domain/authenticator/interactors/AuthenticatorInteractor;Ljava/lang/String;Lorg/xbet/domain/authenticator/models/registration/UnregisterResult;)Lv80/d;
...
.method private static final invoke$lambda-0(Lorg/xbet/domain/authenticator/interactors/AuthenticatorInteractor;Ljava/lang/String;Lorg/xbet/domain/authenticator/models/registration/UnregisterResult;)Lv80/d;
    .locals 3
    ...
    .line 4
    invoke-interface {v0, p1, v1, p2}, Lorg/xbet/domain/authenticator/repositories/AuthenticatorRepository;->unregisterVerify(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lv80/b;
    ...
    invoke-virtual {p1, v0, v1, p2}, Lv80/b;->j(JLjava/util/concurrent/TimeUnit;)Lv80/b;

    move-result-object p1

    .line 6
    invoke-static {p0}, Lorg/xbet/domain/authenticator/interactors/AuthenticatorInteractor;->access$getProfileInteractor$p(Lorg/xbet/domain/authenticator/interactors/AuthenticatorInteractor;)Lc50/g;

    move-result-object p0

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Lc50/g;->q(Z)Lv80/v;

    move-result-object p0

    invoke-virtual {p1, p0}, Lv80/b;->f(Lv80/z;)Lv80/v;

    move-result-object p0

    invoke-virtual {p0}, Lv80/v;->E()Lv80/b;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lorg/xbet/domain/authenticator/interactors/AuthenticatorInteractor$disableAuthenticator$1;->invoke(Ljava/lang/String;)Lv80/b;
...
.method public final invoke(Ljava/lang/String;)Lv80/b;
    ...
    invoke-interface {v0, p1}, Lorg/xbet/domain/authenticator/repositories/AuthenticatorRepository;->unregister(Ljava/lang/String;)Lv80/v;
    ...
    invoke-virtual {v0, v2}, Lv80/v;->y(Ly80/l;)Lv80/b;

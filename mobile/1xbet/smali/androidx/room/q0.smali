...
.field protected volatile mDatabase:Lu0/g;
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
.end field
...
.field private mOpenHelper:Lu0/h;
...
.method public static synthetic a(Landroidx/room/q0;Lu0/g;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/room/q0;->lambda$beginTransaction$0(Lu0/g;)Ljava/lang/Object;
...
.method public static synthetic b(Landroidx/room/q0;Lu0/g;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/room/q0;->lambda$endTransaction$1(Lu0/g;)Ljava/lang/Object;
...
.method private internalBeginTransaction()V
    ...
    .line 2
    iget-object v0, p0, Landroidx/room/q0;->mOpenHelper:Lu0/h;
    ...
    invoke-virtual {v1, v0}, Landroidx/room/w;->q(Lu0/g;)V

    .line 4
    invoke-interface {v0}, Lu0/g;->i1()Z
...
.method private synthetic lambda$beginTransaction$0(Lu0/g;)Ljava/lang/Object;
    .locals 0
...
.method private synthetic lambda$endTransaction$1(Lu0/g;)Ljava/lang/Object;
    .locals 0
...
.method private unwrapOpenHelper(Ljava/lang/Class;Lu0/h;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p2}, Landroidx/room/o;->getDelegate()Lu0/h;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Landroidx/room/q0;->unwrapOpenHelper(Ljava/lang/Class;Lu0/h;)Ljava/lang/Object;
...
.method public close()V
    ...
    .line 5
    iget-object v1, p0, Landroidx/room/q0;->mOpenHelper:Lu0/h;

    invoke-interface {v1}, Lu0/h;->close()V
    :try_end_0
...
.method public compileStatement(Ljava/lang/String;)Lu0/k;
    .locals 1
    ...
    invoke-interface {v0, p1}, Lu0/g;->D0(Ljava/lang/String;)Lu0/k;
...
.method protected abstract createOpenHelper(Landroidx/room/n;)Lu0/h;
.end method
...
.method public getOpenHelper()Lu0/h;
    .locals 1
...
.method public inTransaction()Z
    ...
    invoke-interface {v0}, Lu0/g;->b1()Z
...
.method public init(Landroidx/room/n;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/room/q0;->createOpenHelper(Landroidx/room/n;)Lu0/h;

    move-result-object v0

    iput-object v0, p0, Landroidx/room/q0;->mOpenHelper:Lu0/h;
    ...
    iget v6, v1, Lr0/b;->startVersion:I
    ...
    new-array v6, v4, [Lr0/b;

    aput-object v1, v6, v2

    invoke-virtual {v5, v6}, Landroidx/room/q0$d;->b([Lr0/b;)V
    ...
    invoke-direct {p0, v0, v1}, Landroidx/room/q0;->unwrapOpenHelper(Ljava/lang/Class;Lu0/h;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v2}, Lu0/h;->setWriteAheadLoggingEnabled(Z)V
...
.method protected internalInitInvalidationTracker(Lu0/g;)V
    .locals 1

    iget-object v0, p0, Landroidx/room/q0;->mInvalidationTracker:Landroidx/room/w;

    invoke-virtual {v0, p1}, Landroidx/room/w;->e(Lu0/g;)V
...
.method public isOpen()Z
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Landroidx/room/q0;->mDatabase:Lu0/g;
...
.method public query(Ljava/lang/String;[Ljava/lang/Object;)Landroid/database/Cursor;
    ...
    invoke-direct {v1, p1, p2}, Lu0/a;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {v0, v1}, Lu0/g;->Z0(Lu0/j;)Landroid/database/Cursor;
...
.method public query(Lu0/j;)Landroid/database/Cursor;
    .locals 1

    const/4 v0, 0x0

    .line 2
    invoke-virtual {p0, p1, v0}, Landroidx/room/q0;->query(Lu0/j;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
...
.method public query(Lu0/j;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    .locals 1
    ...
    .line 6
    :cond_0
    iget-object p2, p0, Landroidx/room/q0;->mOpenHelper:Lu0/h;

    invoke-interface {p2}, Lu0/h;->getWritableDatabase()Lu0/g;

    move-result-object p2

    invoke-interface {p2, p1}, Lu0/g;->Z0(Lu0/j;)Landroid/database/Cursor;
...
.method public runInTransaction(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    .line 10
    :try_start_1
    invoke-static {p1}, Ls0/e;->a(Ljava/lang/Exception;)V
    :try_end_1

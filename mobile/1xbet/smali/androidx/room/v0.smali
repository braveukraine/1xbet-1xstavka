...
# direct methods
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;ILu0/h;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    iput-object p6, p0, Landroidx/room/v0;->f:Lu0/h;
...
.method private a(Ljava/io/File;Z)V
    ...
    .line 13
    invoke-static {v0, v2}, Ls0/d;->a(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/channels/FileChannel;)V
    ...
    :cond_3
    :goto_1
    invoke-direct {p0, v1, p2}, Landroidx/room/v0;->d(Ljava/io/File;Z)V
...
.method private b(Ljava/io/File;)Lu0/h;
    .locals 4

    .line 1
    :try_start_0
    invoke-static {p1}, Ls0/c;->c(Ljava/io/File;)I
    ...
    invoke-static {v2}, Lu0/h$b;->a(Landroid/content/Context;)Lu0/h$b$a;
    ...
    invoke-virtual {v2, p1}, Lu0/h$b$a;->c(Ljava/lang/String;)Lu0/h$b$a;

    move-result-object p1

    new-instance v2, Landroidx/room/v0$a;
    ...
    invoke-direct {v2, p0, v0}, Landroidx/room/v0$a;-><init>(Landroidx/room/v0;I)V

    invoke-virtual {p1, v2}, Lu0/h$b$a;->b(Lu0/h$a;)Lu0/h$b$a;

    move-result-object p1

    .line 6
    invoke-virtual {p1}, Lu0/h$b$a;->a()Lu0/h$b;

    move-result-object p1

    .line 7
    invoke-virtual {v1, p1}, Lv0/c;->a(Lu0/h$b;)Lu0/h;
...
.method private d(Ljava/io/File;Z)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/room/v0;->g:Landroidx/room/n;

    if-eqz v0, :cond_2

    iget-object v0, v0, Landroidx/room/n;->f:Landroidx/room/q0$e;
    ...
    .line 2
    :cond_0
    invoke-direct {p0, p1}, Landroidx/room/v0;->b(Ljava/io/File;)Lu0/h;
    ...
    .line 3
    :try_start_0
    invoke-interface {p1}, Lu0/h;->getWritableDatabase()Lu0/g;
    ...
    .line 4
    :cond_1
    invoke-interface {p1}, Lu0/h;->getReadableDatabase()Lu0/g;
    ...
    invoke-virtual {v0, p2}, Landroidx/room/q0$e;->a(Lu0/g;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 6
    invoke-interface {p1}, Lu0/h;->close()V
...
.method private f(Z)V
    ...
    .line 3
    iget-object v3, p0, Landroidx/room/v0;->g:Landroidx/room/n;

    if-eqz v3, :cond_1

    iget-boolean v3, v3, Landroidx/room/n;->m:Z
    ...
    iget-object v5, p0, Landroidx/room/v0;->a:Landroid/content/Context;

    invoke-virtual {v5}, Landroid/content/Context;->getFilesDir()Ljava/io/File;

    move-result-object v5

    invoke-direct {v4, v1, v5, v3}, Ls0/a;-><init>(Ljava/lang/String;Ljava/io/File;Z)V

    .line 5
    :try_start_0
    invoke-virtual {v4}, Ls0/a;->b()V
    ...
    .line 7
    :try_start_1
    invoke-direct {p0, v2, p1}, Landroidx/room/v0;->a(Ljava/io/File;Z)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 8
    invoke-virtual {v4}, Ls0/a;->c()V
    ...
    :cond_3
    :try_start_3
    invoke-static {v2}, Ls0/c;->c(Ljava/io/File;)I
    ...
    .line 13
    :try_start_4
    iget v6, p0, Landroidx/room/v0;->e:I
    :try_end_4
    ...
    :cond_4
    :try_start_5
    iget-object v7, p0, Landroidx/room/v0;->g:Landroidx/room/n;
...
.method public declared-synchronized close()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Landroidx/room/v0;->f:Lu0/h;
...
.method e(Landroidx/room/n;)V
    .locals 0

    iput-object p1, p0, Landroidx/room/v0;->g:Landroidx/room/n;
...
.method public declared-synchronized getReadableDatabase()Lu0/g;
    .locals 1
    ...
    .line 2
    invoke-direct {p0, v0}, Landroidx/room/v0;->f(Z)V
    ...
    invoke-interface {v0}, Lu0/h;->getReadableDatabase()Lu0/g;
...
.method public declared-synchronized getWritableDatabase()Lu0/g;
    .locals 1

...
.method public static declared-synchronized h()V
    ...
    iput-object v2, v1, Landroidx/appcompat/widget/g;->a:Landroidx/appcompat/widget/y;

    .line 4
    sget-object v1, Landroidx/appcompat/widget/g;->c:Landroidx/appcompat/widget/g;

    iget-object v1, v1, Landroidx/appcompat/widget/g;->a:Landroidx/appcompat/widget/y;

    new-instance v2, Landroidx/appcompat/widget/g$a;

    invoke-direct {v2}, Landroidx/appcompat/widget/g$a;-><init>()V

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/y;->u(Landroidx/appcompat/widget/y$f;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/f0;[I)V
    ...
    invoke-static {p0, p1, p2}, Landroidx/appcompat/widget/y;->w(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/f0;[I)V
...
.method public declared-synchronized c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/appcompat/widget/g;->a:Landroidx/appcompat/widget/y;

    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/y;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized d(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroidx/appcompat/widget/y;->k(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/y;->m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public declared-synchronized g(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/y;->s(Landroid/content/Context;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

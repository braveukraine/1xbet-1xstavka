...
.method public onInterceptTouchEvent(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/n;->z:Landroidx/core/view/e;
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/n;->r()V

    .line 7
    iget-object p1, p0, Landroidx/recyclerview/widget/n$b;->a:Landroidx/recyclerview/widget/n;

    iget-object v2, p1, Landroidx/recyclerview/widget/n;->c:Landroidx/recyclerview/widget/RecyclerView$c0;

    if-nez v2, :cond_4

    .line 8
    invoke-virtual {p1, p2}, Landroidx/recyclerview/widget/n;->j(Landroid/view/MotionEvent;)Landroidx/recyclerview/widget/n$g;
    ...
    .line 11
    iget-object v3, p1, Landroidx/recyclerview/widget/n$g;->e:Landroidx/recyclerview/widget/RecyclerView$c0;

    invoke-virtual {v2, v3, v0}, Landroidx/recyclerview/widget/n;->i(Landroidx/recyclerview/widget/RecyclerView$c0;Z)V
    ...
    iget-object v4, p1, Landroidx/recyclerview/widget/n$g;->e:Landroidx/recyclerview/widget/RecyclerView$c0;

    invoke-virtual {v3, v2, v4}, Landroidx/recyclerview/widget/n$e;->clearView(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$c0;)V
    ...
    invoke-virtual {v2, v3, p1}, Landroidx/recyclerview/widget/n;->w(Landroidx/recyclerview/widget/RecyclerView$c0;I)V
    ...
    invoke-virtual {p1, p2, v2, v1}, Landroidx/recyclerview/widget/n;->C(Landroid/view/MotionEvent;II)V
    ...
    invoke-virtual {v3, p1, p2, v2}, Landroidx/recyclerview/widget/n;->f(ILandroid/view/MotionEvent;I)V
    ...
    .line 20
    invoke-virtual {p1, v2, v1}, Landroidx/recyclerview/widget/n;->w(Landroidx/recyclerview/widget/RecyclerView$c0;I)V
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/n;->c:Landroidx/recyclerview/widget/RecyclerView$c0;
...
.method public onTouchEvent(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v2, p1, p2, v1}, Landroidx/recyclerview/widget/n;->f(ILandroid/view/MotionEvent;I)V

    .line 8
    :cond_2
    iget-object v2, p0, Landroidx/recyclerview/widget/n$b;->a:Landroidx/recyclerview/widget/n;

    iget-object v3, v2, Landroidx/recyclerview/widget/n;->c:Landroidx/recyclerview/widget/RecyclerView$c0;
    ...
    invoke-virtual {v0, p2, v1, p1}, Landroidx/recyclerview/widget/n;->C(Landroid/view/MotionEvent;II)V
    ...
    invoke-virtual {v2, p2, p1, v1}, Landroidx/recyclerview/widget/n;->C(Landroid/view/MotionEvent;II)V

    .line 17
    iget-object p1, p0, Landroidx/recyclerview/widget/n$b;->a:Landroidx/recyclerview/widget/n;

    invoke-virtual {p1, v3}, Landroidx/recyclerview/widget/n;->q(Landroidx/recyclerview/widget/RecyclerView$c0;)V
    ...
    invoke-virtual {p1, p2, v4}, Landroidx/recyclerview/widget/n;->w(Landroidx/recyclerview/widget/RecyclerView$c0;I)V

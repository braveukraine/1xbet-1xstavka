...
.field private final b:Lcom/google/android/exoplayer2/transformer/MuxerWrapper;

.field final synthetic c:Lcom/google/android/exoplayer2/transformer/Transformer;
...
.method private Y(Ljava/lang/Exception;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/transformer/Transformer$TransformerAnalyticsListener;->c:Lcom/google/android/exoplayer2/transformer/Transformer;

    const/4 v1, 0x0

    invoke-static {v0, v1}, Lcom/google/android/exoplayer2/transformer/Transformer;->b(Lcom/google/android/exoplayer2/transformer/Transformer;Z)V
    :try_end_0
    ...
    .line 2
    iget-object p1, p0, Lcom/google/android/exoplayer2/transformer/Transformer$TransformerAnalyticsListener;->c:Lcom/google/android/exoplayer2/transformer/Transformer;

    invoke-static {p1}, Lcom/google/android/exoplayer2/transformer/Transformer;->c(Lcom/google/android/exoplayer2/transformer/Transformer;)Lcom/google/android/exoplayer2/transformer/Transformer$Listener;

    move-result-object p1

    iget-object v0, p0, Lcom/google/android/exoplayer2/transformer/Transformer$TransformerAnalyticsListener;->a:Lcom/google/android/exoplayer2/MediaItem;

    invoke-interface {p1, v0}, Lcom/google/android/exoplayer2/transformer/Transformer$Listener;->b(Lcom/google/android/exoplayer2/MediaItem;)V
    ...
    invoke-static {v0}, Lcom/google/android/exoplayer2/transformer/Transformer;->c(Lcom/google/android/exoplayer2/transformer/Transformer;)Lcom/google/android/exoplayer2/transformer/Transformer$Listener;

    move-result-object v0

    iget-object v1, p0, Lcom/google/android/exoplayer2/transformer/Transformer$TransformerAnalyticsListener;->a:Lcom/google/android/exoplayer2/MediaItem;

    invoke-interface {v0, v1, p1}, Lcom/google/android/exoplayer2/transformer/Transformer$Listener;->a(Lcom/google/android/exoplayer2/MediaItem;Ljava/lang/Exception;)V
...
.method public B(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;I)V
    ...
    .line 1
    iget-object p2, p0, Lcom/google/android/exoplayer2/transformer/Transformer$TransformerAnalyticsListener;->c:Lcom/google/android/exoplayer2/transformer/Transformer;

    invoke-static {p2}, Lcom/google/android/exoplayer2/transformer/Transformer;->d(Lcom/google/android/exoplayer2/transformer/Transformer;)I
    ...
    invoke-virtual {p1, v0, p2}, Lcom/google/android/exoplayer2/Timeline;->n(ILcom/google/android/exoplayer2/Timeline$Window;)Lcom/google/android/exoplayer2/Timeline$Window;

    .line 4
    iget-boolean p1, p2, Lcom/google/android/exoplayer2/Timeline$Window;->l:Z

    if-nez p1, :cond_3

    .line 5
    iget-wide p1, p2, Lcom/google/android/exoplayer2/Timeline$Window;->n:J
    ...
    :goto_1
    invoke-static {v0, p1}, Lcom/google/android/exoplayer2/transformer/Transformer;->e(Lcom/google/android/exoplayer2/transformer/Transformer;I)I

    .line 7
    iget-object p1, p0, Lcom/google/android/exoplayer2/transformer/Transformer$TransformerAnalyticsListener;->c:Lcom/google/android/exoplayer2/transformer/Transformer;

    invoke-static {p1}, Lcom/google/android/exoplayer2/transformer/Transformer;->a(Lcom/google/android/exoplayer2/transformer/Transformer;)Lcom/google/android/exoplayer2/SimpleExoPlayer;
    ...
    invoke-virtual {p1}, Lcom/google/android/exoplayer2/BasePlayer;->V()V
...
.method public H(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/ExoPlaybackException;)V
    ...
    invoke-direct {p0, p2}, Lcom/google/android/exoplayer2/transformer/Transformer$TransformerAnalyticsListener;->Y(Ljava/lang/Exception;)V

    return-void
.end method

.method public synthetic I(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;IJJ)V
    .locals 0

    invoke-static/range {p0 .. p6}, Lcom/google/android/exoplayer2/analytics/e1;->l(Lcom/google/android/exoplayer2/analytics/AnalyticsListener;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;IJJ)V
...
.method public synthetic X(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/video/VideoSize;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/google/android/exoplayer2/analytics/e1;->o0(Lcom/google/android/exoplayer2/analytics/AnalyticsListener;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/video/VideoSize;)V
...
.method public synthetic d(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Ljava/lang/Exception;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/google/android/exoplayer2/analytics/e1;->w(Lcom/google/android/exoplayer2/analytics/AnalyticsListener;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Ljava/lang/Exception;)V
...
.method public d0(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/source/TrackGroupArray;Lcom/google/android/exoplayer2/trackselection/TrackSelectionArray;)V
    ...
    .line 1
    iget-object p1, p0, Lcom/google/android/exoplayer2/transformer/Transformer$TransformerAnalyticsListener;->b:Lcom/google/android/exoplayer2/transformer/MuxerWrapper;

    invoke-virtual {p1}, Lcom/google/android/exoplayer2/transformer/MuxerWrapper;->d()I
    ...
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/transformer/Transformer$TransformerAnalyticsListener;->Y(Ljava/lang/Exception;)V
...
.method public synthetic g0(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/source/MediaLoadData;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/google/android/exoplayer2/analytics/e1;->q(Lcom/google/android/exoplayer2/analytics/AnalyticsListener;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/source/MediaLoadData;)V
...
.method public synthetic j(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/source/LoadEventInfo;Lcom/google/android/exoplayer2/source/MediaLoadData;Ljava/io/IOException;Z)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lcom/google/android/exoplayer2/analytics/e1;->E(Lcom/google/android/exoplayer2/analytics/AnalyticsListener;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/source/LoadEventInfo;Lcom/google/android/exoplayer2/source/MediaLoadData;Ljava/io/IOException;Z)V

    return-void
.end method

.method public synthetic j0(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/Player$PositionInfo;Lcom/google/android/exoplayer2/Player$PositionInfo;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/google/android/exoplayer2/analytics/e1;->S(Lcom/google/android/exoplayer2/analytics/AnalyticsListener;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Lcom/google/android/exoplayer2/Player$PositionInfo;Lcom/google/android/exoplayer2/Player$PositionInfo;I)V
...
.method public synthetic u(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;IJ)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/google/android/exoplayer2/analytics/e1;->y(Lcom/google/android/exoplayer2/analytics/AnalyticsListener;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;IJ)V

...
.field private selectedCountry:Ld50/a;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.field private selectedNationality:Lm30/n;
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Lc50/g;Lorg/xbet/domain/identification/interactors/CupisDocumentInteractor;Le50/q0;Lg50/c;Lzi/b;Lcom/xbet/onexuser/domain/managers/i;Lorg/xbet/ui_common/router/navigation/IdentificationScreenProvider;Lorg/xbet/ui_common/router/BaseOneXRouter;Lorg/xbet/identification/common/FileProcessingUtils;Ljg/a;Lorg/xbet/ui_common/utils/ErrorHandler;)V
    ...
    .param p6    # Lcom/xbet/onexuser/domain/managers/i;
        ...
        .end annotation
    .end param
    .param p7    # Lorg/xbet/ui_common/router/navigation/IdentificationScreenProvider;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p8    # Lorg/xbet/ui_common/router/BaseOneXRouter;
        ...
        .end annotation
    .end param
    .param p9    # Lorg/xbet/identification/common/FileProcessingUtils;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p10    # Ljg/a;
    ...
    .line 2
    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->profileInteractor:Lc50/g;
    ...
    .line 4
    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->profileRepository:Le50/q0;

    move-object/from16 v1, p4

    .line 5
    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->geoInteractorProvider:Lg50/c;

    move-object/from16 v1, p5

    .line 6
    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->appSettingsManager:Lzi/b;
    ...
    .line 9
    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->router:Lorg/xbet/ui_common/router/BaseOneXRouter;

    move-object/from16 v1, p9

    .line 10
    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->fileProcessingUtils:Lorg/xbet/identification/common/FileProcessingUtils;
    ...
    .line 13
    invoke-virtual/range {p10 .. p10}, Ljg/a;->b()Lkg/b;

    move-result-object v1

    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->common:Lkg/b;
    ...
    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedCountry:Ld50/a;
    ...
    invoke-direct/range {v14 .. v25}, Ld50/a;-><init>(JLjava/lang/String;ZLd50/c;ZZLjava/lang/String;ZILkotlin/jvm/internal/h;)V

    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedRegion:Ld50/a;
    ...
    iput-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedCity:Ld50/a;
...
.method private static final exit$lambda-13(Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;Ljava/lang/Boolean;)V
    ...
    iget-object p0, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->fileProcessingUtils:Lorg/xbet/identification/common/FileProcessingUtils;
...
.method private static final exit$lambda-14(Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;Ljava/lang/Boolean;)V
    ...
    iget-object p1, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->router:Lorg/xbet/ui_common/router/BaseOneXRouter;
...
.method private final getNationalityList()Lv80/v;
    ...
    iget-object v1, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->appSettingsManager:Lzi/b;

    invoke-interface {v1}, Lzi/b;->getLang()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/xbet/onexuser/domain/managers/i;->f(Ljava/lang/String;)Lv80/v;
...
.method private final getUserData(Z)V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->profileInteractor:Lc50/g;
...
.method private static final getUserData$lambda-1(Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;ZLcom/xbet/onexuser/domain/entity/j;)V
    ...
    .line 2
    invoke-virtual/range {p2 .. p2}, Lcom/xbet/onexuser/domain/entity/j;->Y()Lm30/v;

    move-result-object v1

    invoke-direct {v0, v1}, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->isUpridStatus(Lm30/v;)Z
    ...
    iget-object v5, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->common:Lkg/b;

    invoke-virtual {v5}, Lkg/b;->g0()I

    move-result v5

    iget-object v6, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->appSettingsManager:Lzi/b;

    invoke-interface {v6}, Lzi/b;->getRefId()I
    ...
    invoke-direct/range {v6 .. v17}, Ld50/a;-><init>(JLjava/lang/String;ZLd50/c;ZZLjava/lang/String;ZILkotlin/jvm/internal/h;)V

    iput-object v2, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedCountry:Ld50/a;
    ...
    invoke-direct/range {v3 .. v14}, Ld50/a;-><init>(JLjava/lang/String;ZLd50/c;ZZLjava/lang/String;ZILkotlin/jvm/internal/h;)V

    iput-object v2, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedRegion:Ld50/a;
    ...
    invoke-interface {v0, v1}, Lorg/xbet/identification/views/VerificationDocsView;->showPlaceholder(Lm30/v;)V
...
.method private static final onDocumentTypeClick$lambda-18(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v2, v1, v4, v3, v4}, Lorg/xbet/identification/fragments/EditProfileWithDocsMelbetGhFragment$Type;-><init>(Lo30/a;Ljava/lang/String;ILkotlin/jvm/internal/h;)V
...
.method public final editProfileInfo(Lorg/xbet/identification/model/VerificationFields;)V
    ...
    .line 1
    iget-object v1, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->profileRepository:Le50/q0;
    ...
    .line 8
    iget-object v7, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedRegion:Ld50/a;
    ...
    .line 10
    iget-object v9, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedCity:Ld50/a;

    invoke-virtual {v9}, Ld50/a;->d()J
    ...
    .line 14
    iget-object v10, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedDocumentType:Lo30/a;

    const/4 v11, 0x0

    if-eqz v10, :cond_0

    invoke-virtual {v10}, Lo30/a;->a()I
    ...
    .line 21
    iget-object v14, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedNationality:Lm30/n;

    if-eqz v14, :cond_1

    invoke-virtual {v14}, Lm30/n;->a()I
    ...
    .line 22
    invoke-virtual/range {v1 .. v22}, Le50/q0;->e0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;I)Lv80/v;
    ...
    invoke-virtual {v1, v2, v3, v4}, Lv80/v;->j(JLjava/util/concurrent/TimeUnit;)Lv80/v;
...
.method public final getCitiesList()V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedRegion:Ld50/a;
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->geoInteractorProvider:Lg50/c;

    iget-object v1, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedRegion:Ld50/a;
    ...
    iget-object v1, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedCity:Ld50/a;
...
.method public final getCountriesList()V
    ...
    invoke-interface {v0, v2, v1}, Lg50/c;->getCountryItemsForChoiceWithTitle(ILd50/c;)Lv80/v;
...
.method public final getRegionsList()V
    ...
    iget-object v2, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedRegion:Ld50/a;
    ...
    invoke-interface {v0, v1, v3}, Lg50/c;->getRegionsListWithTitle(II)Lv80/v;
...
.method public final onCountryChoose(Ld50/a;)V
    .locals 26
    .param p1    # Ld50/a;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object v13, v0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedRegion:Ld50/a;
...
.method public final onDocumentResultSuccess()V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->router:Lorg/xbet/ui_common/router/BaseOneXRouter;
...
.method public final onDocumentTypeClick()V
    ...
    .line 1
    iget-object v0, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->profileRepository:Le50/q0;
    ...
    iget-object v1, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedCountry:Ld50/a;
...
.method public final onNationalitiesLoaded(Lm30/n;)V
    .locals 0
    .param p1    # Lm30/n;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedNationality:Lm30/n;
...
.method public final onNationalityClick()V
    ...
    .line 1
    invoke-direct {p0}, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->getNationalityList()Lv80/v;
...
.method public final onSaveDataAndQuitClick(Lorg/xbet/identification/model/VerificationFields;)V
    ...
    .line 23
    invoke-static/range {v25 .. v30}, Lorg/xbet/ui_common/utils/rx/RxExtension2Kt;->applySchedulers$default(Lv80/v;Lv80/u;Lv80/u;Lv80/u;ILjava/lang/Object;)Lv80/v;
...
.method public final setSelectedCity(Ld50/a;)V
    ...
    iput-object p1, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedCity:Ld50/a;

    return-void
.end method

.method public final setSelectedDocType(Lo30/a;)V
    .locals 0
    .param p1    # Lo30/a;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedDocumentType:Lo30/a;
...
.method public final setSelectedRegion(Ld50/a;)V
    ...
    .line 1
    iput-object p1, p0, Lorg/xbet/identification/presenters/EditProfileWithDocsMelbetGhPresenter;->selectedRegion:Ld50/a;

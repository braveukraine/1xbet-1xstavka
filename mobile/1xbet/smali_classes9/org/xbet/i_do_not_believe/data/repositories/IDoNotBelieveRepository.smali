...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "appSettingsManager",
        "<init>",
        "(Lorg/xbet/i_do_not_believe/data/api/IDoNotBelieveApiService;Lorg/xbet/i_do_not_believe/data/mappers/IDoNotBelieveMapper;Lzi/b;)V",
...
# direct methods
.method public constructor <init>(Lorg/xbet/i_do_not_believe/data/api/IDoNotBelieveApiService;Lorg/xbet/i_do_not_believe/data/mappers/IDoNotBelieveMapper;Lzi/b;)V
    .locals 0
    ...
    .line 4
    iput-object p3, p0, Lorg/xbet/i_do_not_believe/data/repositories/IDoNotBelieveRepository;->appSettingsManager:Lzi/b;
...
.method public final choiceAndResume(Ljava/lang/String;I)Lv80/v;
    ...
    .line 2
    iget-object v1, p0, Lorg/xbet/i_do_not_believe/data/repositories/IDoNotBelieveRepository;->appSettingsManager:Lzi/b;
    ...
    .line 4
    iget-object v2, p0, Lorg/xbet/i_do_not_believe/data/repositories/IDoNotBelieveRepository;->appSettingsManager:Lzi/b;
    ...
    .line 6
    invoke-interface {v0, p1, v3}, Lorg/xbet/i_do_not_believe/data/api/IDoNotBelieveApiService;->makeAction(Ljava/lang/String;Lorg/xbet/i_do_not_believe/data/models/requests/IDoNotBelieveActionRequest;)Lv80/v;

    move-result-object p1

    sget-object p2, Lxf0/b;->a:Lxf0/b;
    ...
    invoke-direct {v0, p2}, Lxf0/a;-><init>(Lorg/xbet/i_do_not_believe/data/mappers/IDoNotBelieveMapper;)V
...
.method public final play(Ljava/lang/String;FJLorg/xbet/core/data/GameBonus;)Lv80/v;
    .locals 13
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 4
    iget-object v2, v0, Lorg/xbet/i_do_not_believe/data/repositories/IDoNotBelieveRepository;->appSettingsManager:Lzi/b;
    ...
    .line 7
    invoke-interface {v1, p1, v2}, Lorg/xbet/i_do_not_believe/data/api/IDoNotBelieveApiService;->makeBetGame(Ljava/lang/String;Lorg/xbet/i_do_not_believe/data/models/requests/IDoNotBelieveBetRequest;)Lv80/v;

    move-result-object v1

    sget-object v2, Lxf0/b;->a:Lxf0/b;
    ...
    invoke-direct {v3, v2}, Lxf0/a;-><init>(Lorg/xbet/i_do_not_believe/data/mappers/IDoNotBelieveMapper;)V
...
.method public final returnLastGame(Ljava/lang/String;)Lv80/v;
    ...
    iget-object v3, p0, Lorg/xbet/i_do_not_believe/data/repositories/IDoNotBelieveRepository;->appSettingsManager:Lzi/b;
    ...
    .line 3
    invoke-interface {v0, p1, v1}, Lorg/xbet/i_do_not_believe/data/api/IDoNotBelieveApiService;->getNoFinishGame(Ljava/lang/String;Lorg/xbet/core/data/BaseRequest;)Lv80/v;
    ...
    invoke-direct {v1, v0}, Lxf0/a;-><init>(Lorg/xbet/i_do_not_believe/data/mappers/IDoNotBelieveMapper;)V

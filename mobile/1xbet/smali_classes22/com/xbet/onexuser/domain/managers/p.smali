...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lcom/xbet/onexuser/domain/managers/k0;Lc50/g;Le50/j1;Le50/q0;Lm40/d;)V",
        "onexuser"
    }
    k = 0x1
    mv = {
...
.field private final c:Le50/j1;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final d:Le50/q0;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final e:Lm40/d;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Lcom/xbet/onexuser/domain/managers/k0;Lc50/g;Le50/j1;Le50/q0;Lm40/d;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lcom/xbet/onexuser/domain/managers/p;->b:Lc50/g;

    .line 4
    iput-object p3, p0, Lcom/xbet/onexuser/domain/managers/p;->c:Le50/j1;

    .line 5
    iput-object p4, p0, Lcom/xbet/onexuser/domain/managers/p;->d:Le50/q0;

    .line 6
    iput-object p5, p0, Lcom/xbet/onexuser/domain/managers/p;->e:Lm40/d;

    return-void
.end method

.method public static synthetic a(ILcom/xbet/onexuser/domain/entity/j;)Lr90/m;
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/onexuser/domain/managers/p;->m(ILcom/xbet/onexuser/domain/entity/j;)Lr90/m;
...
.method public static synthetic b(Lr30/g$c;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0}, Lcom/xbet/onexuser/domain/managers/p;->g(Lr30/g$c;)Ljava/lang/Boolean;
...
.method public static synthetic c(Lcom/xbet/onexuser/domain/managers/p;Lr30/g$c;)Lv80/z;
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/onexuser/domain/managers/p;->o(Lcom/xbet/onexuser/domain/managers/p;Lr30/g$c;)Lv80/z;
...
.method public static synthetic d(Lcom/xbet/onexuser/domain/entity/j;Lr30/g$c;)Lr90/m;
    .locals 0

    invoke-static {p0, p1}, Lcom/xbet/onexuser/domain/managers/p;->q(Lcom/xbet/onexuser/domain/entity/j;Lr30/g$c;)Lr90/m;
...
.method public static synthetic e(Lr90/m;)Lr30/f;
    .locals 0

    invoke-static {p0}, Lcom/xbet/onexuser/domain/managers/p;->r(Lr90/m;)Lr30/f;
...
.method private static final g(Lr30/g$c;)Ljava/lang/Boolean;
    .locals 7

    .line 1
    invoke-virtual {p0}, Lr30/g$c;->a()Ljava/util/Map;
    ...
    sget-object v6, Lr30/i;->LEVEL_PASSWORD:Lr30/i;
...
.method private static final m(ILcom/xbet/onexuser/domain/entity/j;)Lr90/m;
    .locals 0
...
.method private static final o(Lcom/xbet/onexuser/domain/managers/p;Lr30/g$c;)Lv80/z;
    .locals 0

    invoke-virtual {p1}, Lr30/g$c;->d()I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/xbet/onexuser/domain/managers/p;->l(I)Lv80/v;
...
.method private static final q(Lcom/xbet/onexuser/domain/entity/j;Lr30/g$c;)Lr90/m;
    .locals 0
...
.method private static final r(Lr90/m;)Lr30/f;
    .locals 13
    ...
    check-cast p0, Lr30/g$c;

    .line 2
    sget-object v1, Lc40/d;->UNKNOWN:Lc40/d;
    ...
    sget-object v5, Lc40/a;->PHONE_AND_MAIL:Lc40/a;
    ...
    invoke-virtual {v0}, Lcom/xbet/onexuser/domain/entity/j;->c()Lc40/a;
    ...
    .line 8
    invoke-virtual {p0}, Lr30/g$c;->c()I

    move-result v3

    .line 9
    invoke-virtual {p0}, Lr30/g$c;->b()I

    move-result v4

    .line 10
    invoke-virtual {p0}, Lr30/g$c;->d()I
    ...
    .line 15
    invoke-virtual {p0}, Lr30/g$c;->f()Z

    move-result v11

    .line 16
    invoke-virtual {p0}, Lr30/g$c;->e()Ljava/lang/String;
    ...
    .line 17
    invoke-direct/range {v2 .. v12}, Lr30/f;-><init>(IIILjava/util/Map;Lc40/d;Ljava/lang/String;ZZZLjava/lang/String;)V
...
.method public final f()Lv80/v;
    ...
    iget-object v2, p0, Lcom/xbet/onexuser/domain/managers/p;->c:Le50/j1;
...
.method public final h()Z
    ...
    iget-object v0, p0, Lcom/xbet/onexuser/domain/managers/p;->e:Lm40/d;
...
.method public final j()Lv80/v;
    ...
    iget-object v0, p0, Lcom/xbet/onexuser/domain/managers/p;->b:Lc50/g;
...
.method public final p()Lv80/v;
    ...
    iget-object v3, p0, Lcom/xbet/onexuser/domain/managers/p;->c:Le50/j1;
...
.method public final s()Lv80/b;
    .locals 2
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    .line 1
    iget-object v0, p0, Lcom/xbet/onexuser/domain/managers/p;->d:Le50/q0;
    ...
    invoke-static {v1}, Lcj/b;->b(Z)I

    move-result v1

    invoke-virtual {v0, v1}, Le50/q0;->d0(I)Lv80/v;
